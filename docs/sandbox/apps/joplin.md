...
=== "Global Override Options"
    ...
    ??? variable dict/omit "`joplin_role_traefik_api_endpoint`"
    ...
    ??? variable dict/omit "`joplin_role_web_http_serverstransport`"
    ...
    ??? variable dict/omit "`joplin_role_web_serverstransport`"
