...
=== "Web"
    ...
    ??? variable string "`profilarr_role_web_url`"
        ...
        ```yaml
        # Type: string
        profilarr_role_web_url: "{{ lookup('role_web', role='profilarr', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`profilarr_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        profilarr_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`profilarr_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        profilarr_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker"
    ...
    ??? variable list "`profilarr_role_docker_volumes_default`"
        ...
        profilarr_role_docker_volumes_default:
          - "{{ lookup('role_var', '_paths_location', role='profilarr') }}:/config"
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`profilarr_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        profilarr_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`profilarr_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        profilarr_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`profilarr_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        profilarr_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`profilarr_role_docker_force_kill`"
    ...
    ??? variable string "`profilarr_role_docker_stop_signal`"

        ```yaml
        # Type: string
        profilarr_role_docker_stop_signal:
        ```
    ...
    ??? variable list "`profilarr_role_docker_entrypoint`"
    ...
    ??? variable dict "`profilarr_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`profilarr_role_docker_networks_alias_custom`"

        ```yaml
        # Type: list
        profilarr_role_docker_networks_alias_custom:
        ```
    ...
    ??? variable list "`profilarr_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        profilarr_role_paths_folders_list_custom:
        ```

    ??? variable string "`profilarr_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        profilarr_role_paths_group:
        ```

    ??? variable string "`profilarr_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        profilarr_role_paths_owner:
        ```

    ??? variable string "`profilarr_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        profilarr_role_paths_permissions:
        ```

    ??? variable bool "`profilarr_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        profilarr_role_paths_recursive:
        ```

    ??? variable list "`profilarr_role_themepark_addons`"
    ...
    ??? variable string "`profilarr_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        profilarr_role_web_api_http_port:
        ```

    ??? variable string "`profilarr_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        profilarr_role_web_api_http_scheme:
        ```

    ??? variable dict "`profilarr_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        profilarr_role_web_api_http_serverstransport:
        ```

    ??? variable string "`profilarr_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        profilarr_role_web_api_port:
        ```

    ??? variable string "`profilarr_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        profilarr_role_web_api_scheme:
        ```

    ??? variable dict "`profilarr_role_web_api_serverstransport`"

        ```yaml
        # Type: dict/omit
        profilarr_role_web_api_serverstransport:
        ```
