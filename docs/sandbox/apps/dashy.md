...
[:fontawesome-solid-book-open:**Manual**](https://dashy.to/docs){ .md-button .md-button--stretch }
...
=== "Web"
    ...
    ??? variable string "`dashy_role_web_url`"
        ...
        ```yaml
        # Type: string
        dashy_role_web_url: "{{ lookup('role_web', role='dashy', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`dashy_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        dashy_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`dashy_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        dashy_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`dashy_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        dashy_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`dashy_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        dashy_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`dashy_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        dashy_role_docker_dev_dri_disabled: false
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`dashy_role_docker_networks_alias_custom`"

        ```yaml
        # Type: list
        dashy_role_docker_networks_alias_custom:
        ```
    ...
    ??? variable list "`dashy_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        dashy_role_paths_folders_list_custom:
        ```

    ??? variable string "`dashy_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        dashy_role_paths_group:
        ```

    ??? variable string "`dashy_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        dashy_role_paths_owner:
        ```

    ??? variable string "`dashy_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        dashy_role_paths_permissions:
        ```

    ??? variable bool "`dashy_role_paths_recursive`"

        ```yaml
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        dashy_role_paths_recursive:
        ```
    ...
    ??? variable string "`dashy_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        dashy_role_web_api_http_port:
        ```

    ??? variable string "`dashy_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        dashy_role_web_api_http_scheme:
        ```

    ??? variable dict "`dashy_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        dashy_role_web_api_http_serverstransport:
        ```

    ??? variable string "`dashy_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        dashy_role_web_api_port:
        ```

    ??? variable string "`dashy_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        dashy_role_web_api_scheme:
        ```

    ??? variable dict "`dashy_role_web_api_serverstransport`"

        ```yaml
        # Type: dict/omit
        dashy_role_web_api_serverstransport:
        ```
