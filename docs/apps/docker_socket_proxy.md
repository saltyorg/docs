...
=== "Docker+"
    ...
    ??? variable bool "`docker_socket_proxy_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        docker_socket_proxy_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`docker_socket_proxy_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        docker_socket_proxy_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`docker_socket_proxy_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        docker_socket_proxy_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`docker_socket_proxy_role_docker_force_kill`"
    ...
    ??? variable list "`docker_socket_proxy_role_docker_entrypoint`"
    ...
    ??? variable dict "`docker_socket_proxy_role_docker_sysctls`"
