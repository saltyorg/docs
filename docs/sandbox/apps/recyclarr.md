...
=== "Docker+"
    ...
    ??? variable bool "`recyclarr_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        recyclarr_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`recyclarr_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        recyclarr_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`recyclarr_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        recyclarr_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable string "`recyclarr_role_docker_stop_signal`"

        ```yaml
        # Type: string
        recyclarr_role_docker_stop_signal:
        ```
