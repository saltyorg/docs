...
Visit <https://foundry.iYOUR_DOMAIN_NAMEi>.
...
1.  !!! example "Example override"
    ...
    !!! warning "Avoid overriding variables ending in `_default`"
        ...
        Instead, use the corresponding `_custom` variable (like `foundry_docker_envs_custom`) to add your changes. Custom values are merged with defaults, ensuring you receive updates.

=== "Basics"

    ??? variable string "`foundry_name`"
...
=== "Web"
    ...
    ??? variable string "`foundry_role_web_url`"

        ```yaml
        # Type: string
        foundry_role_web_url: "{{ lookup('role_web', role='foundry', scheme='https') }}"
        ```

=== "DNS"

    ??? variable string "`foundry_role_dns_record`"
    ...
    ??? variable string "`foundry_role_dns_zone`"
    ...
    ??? variable bool "`foundry_role_dns_proxy`"
...
=== "Traefik"
    ...
    ??? variable string "`foundry_role_traefik_sso_middleware`"
    ...
    ??? variable string "`foundry_role_traefik_middleware_default`"
    ...
    ??? variable string "`foundry_role_traefik_middleware_custom`"
    ...
    ??? variable string "`foundry_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        foundry_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`foundry_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        foundry_role_traefik_middleware_custom_api: ""
        ```
    ...
    ??? variable bool "`foundry_role_traefik_enabled`"
    ...
    ??? variable bool "`foundry_role_traefik_api_enabled`"
    ...
    ??? variable string "`foundry_role_traefik_api_endpoint`"
...
=== "Docker"
    ...
    ??? variable string "`foundry_role_docker_image`"
    ...
    ??? variable dict "`foundry_role_docker_envs_custom`"
    ...
    ??? variable list "`foundry_role_docker_volumes_custom`"
    ...
    ??? variable list "`foundry_role_docker_ports_custom`"
    ...
    ??? variable list "`foundry_role_docker_networks_default`"
    ...
    ??? variable list "`foundry_role_docker_networks_custom`"
...
=== "Docker+"
    ...
    ??? variable bool "`foundry_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        foundry_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`foundry_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        foundry_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`foundry_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        foundry_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`foundry_role_docker_force_kill`"
    ...
    ??? variable list "`foundry_role_docker_entrypoint`"
    ...
    ??? variable dict "`foundry_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable string "`foundry_role_depends_on`"
    ...
    ??? variable string "`foundry_role_depends_on_delay`"
    ...
    ??? variable string "`foundry_role_depends_on_healthchecks`"
    ...
    ??? variable bool "`foundry_role_diun_enabled`"
    ...
    ??? variable bool "`foundry_role_dns_enabled`"
    ...
    ??? variable bool "`foundry_role_docker_controller`"
    ...
    ??? variable list "`foundry_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        foundry_role_paths_folders_list_custom:
        ```

    ??? variable string "`foundry_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        foundry_role_paths_group:
        ```

    ??? variable string "`foundry_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        foundry_role_paths_owner:
        ```

    ??? variable string "`foundry_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        foundry_role_paths_permissions:
        ```

    ??? variable bool "`foundry_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        foundry_role_paths_recursive:
        ```

    ??? variable list "`foundry_role_themepark_addons`"
    ...
    ??? variable bool "`foundry_role_traefik_error_pages_enabled`"
    ...
    ??? variable bool "`foundry_role_traefik_gzip_enabled`"
    ...
    ??? variable bool "`foundry_role_traefik_middleware_http_api_insecure`"
        ...
        ```yaml
        # Type: bool (true/false)
        foundry_role_traefik_middleware_http_api_insecure:
        ```

    ??? variable bool "`foundry_role_traefik_middleware_http_insecure`"
    ...
    ??? variable bool "`foundry_role_traefik_tailscale_enabled`"
    ...
    ??? variable bool "`foundry_role_traefik_wildcard_enabled`"
    ...
    ??? variable string "`foundry_role_web_api_http_port`"
        ...
        ```yaml
        # Type: string (quoted number)
        foundry_role_web_api_http_port:
        ```

    ??? variable string "`foundry_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        foundry_role_web_api_http_scheme:
        ```

    ??? variable dict "`foundry_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        foundry_role_web_api_http_serverstransport:
        ```

    ??? variable string "`foundry_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        foundry_role_web_api_port:
        ```

    ??? variable string "`foundry_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        foundry_role_web_api_scheme:
        ```

    ??? variable dict "`foundry_role_web_api_serverstransport`"
