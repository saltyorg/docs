...
=== "Docker+"
    ...
    ??? variable bool "`nabarr_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        nabarr_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`nabarr_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        nabarr_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`nabarr_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        nabarr_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable string "`nabarr_role_docker_stop_signal`"

        ```yaml
        # Type: string
        nabarr_role_docker_stop_signal:
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`nabarr_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        nabarr_role_paths_folders_list_custom:
        ```

    ??? variable string "`nabarr_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        nabarr_role_paths_group:
        ```

    ??? variable string "`nabarr_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        nabarr_role_paths_owner:
        ```

    ??? variable string "`nabarr_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        nabarr_role_paths_permissions:
        ```

    ??? variable bool "`nabarr_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        nabarr_role_paths_recursive:
        ```
