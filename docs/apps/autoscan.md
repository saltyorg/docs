...
=== "Web"
    ...
    ??? variable string "`autoscan_role_web_url`{ .sb-show-on-unchecked }`autoscan2_web_url`{ .sb-show-on-checked }"
        ...
        ```yaml { .sb-show-on-unchecked }
        # Type: string
        autoscan_role_web_url: "{{ lookup('role_web', role='autoscan', scheme='https') }}"
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        autoscan2_web_url: "{{ lookup('role_web', role='autoscan', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`autoscan_role_traefik_middleware_default_api`{ .sb-show-on-unchecked }`autoscan2_traefik_middleware_default_api`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string
        autoscan_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        autoscan2_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`autoscan_role_traefik_middleware_custom_api`{ .sb-show-on-unchecked }`autoscan2_traefik_middleware_custom_api`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string
        autoscan_role_traefik_middleware_custom_api: ""
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        autoscan2_traefik_middleware_custom_api: ""
        ```
...
=== "Docker"
    ...
    ??? variable list "`autoscan_role_docker_labels_default`{ .sb-show-on-unchecked }`autoscan2_docker_labels_default`{ .sb-show-on-checked }"
        ...
        autoscan_role_docker_labels_default:
          ...
          - '{ "traefik.http.routers.{{ traefik_router }}-triggers.tls.certresolver": "{{ traefik_router_certresolver }}" }'
...
=== "Docker+"
    ...
    ??? variable bool "`autoscan_role_docker_gpu_enabled`{ .sb-show-on-unchecked }`autoscan2_docker_gpu_enabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        autoscan_role_docker_gpu_enabled: false
        ```
        ...
        # This setting does not install or enable GPU support on the server.
        # Type: bool (true/false)
        autoscan2_docker_gpu_enabled: false
        ```

    ??? variable bool "`autoscan_role_docker_nvidia_disabled`{ .sb-show-on-unchecked }`autoscan2_docker_nvidia_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        autoscan_role_docker_nvidia_disabled: false
        ```
        ...
        # Automatic /dev/dri access may remain.
        # Type: bool (true/false)
        autoscan2_docker_nvidia_disabled: false
        ```

    ??? variable bool "`autoscan_role_docker_dev_dri_disabled`{ .sb-show-on-unchecked }`autoscan2_docker_dev_dri_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        autoscan_role_docker_dev_dri_disabled: false
        ```
        ...
        # NVIDIA-specific access may remain.
        # Type: bool (true/false)
        autoscan2_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable string "`autoscan_role_docker_stop_signal`{ .sb-show-on-unchecked }`autoscan2_docker_stop_signal`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string
        autoscan_role_docker_stop_signal:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        autoscan2_docker_stop_signal:
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`autoscan_role_docker_networks_alias_custom`{ .sb-show-on-unchecked }`autoscan2_docker_networks_alias_custom`{ .sb-show-on-checked }"
    ...
    ??? variable list "`autoscan_role_paths_folders_list_custom`{ .sb-show-on-unchecked }`autoscan2_paths_folders_list_custom`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Extra directories to create
        # Type: list
        autoscan_role_paths_folders_list_custom:
        ```

        ```yaml { .sb-show-on-checked }
        # Extra directories to create
        # Type: list
        autoscan2_paths_folders_list_custom:
        ```

    ??? variable string "`autoscan_role_paths_group`{ .sb-show-on-unchecked }`autoscan2_paths_group`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Group for directories created by the role
        # Type: string
        autoscan_role_paths_group:
        ```

        ```yaml { .sb-show-on-checked }
        # Group for directories created by the role
        # Type: string
        autoscan2_paths_group:
        ```

    ??? variable string "`autoscan_role_paths_owner`{ .sb-show-on-unchecked }`autoscan2_paths_owner`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Owner for directories created by the role
        # Type: string
        autoscan_role_paths_owner:
        ```

        ```yaml { .sb-show-on-checked }
        # Owner for directories created by the role
        # Type: string
        autoscan2_paths_owner:
        ```

    ??? variable string "`autoscan_role_paths_permissions`{ .sb-show-on-unchecked }`autoscan2_paths_permissions`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Permissions for directories created by the role
        # Type: string
        autoscan_role_paths_permissions:
        ```

        ```yaml { .sb-show-on-checked }
        # Permissions for directories created by the role
        # Type: string
        autoscan2_paths_permissions:
        ```

    ??? variable bool "`autoscan_role_paths_recursive`{ .sb-show-on-unchecked }`autoscan2_paths_recursive`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        autoscan_role_paths_recursive:
        ```

        ```yaml { .sb-show-on-checked }
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        autoscan2_paths_recursive:
        ```
    ...
    ??? variable string "`autoscan_role_web_api_http_port`{ .sb-show-on-unchecked }`autoscan2_web_api_http_port`{ .sb-show-on-checked }"
    ...
    ??? variable string "`autoscan_role_web_api_http_scheme`{ .sb-show-on-unchecked }`autoscan2_web_api_http_scheme`{ .sb-show-on-checked }"
    ...
    ??? variable dict "`autoscan_role_web_api_http_serverstransport`{ .sb-show-on-unchecked }`autoscan2_web_api_http_serverstransport`{ .sb-show-on-checked }"
    ...
    ??? variable string "`autoscan_role_web_api_port`{ .sb-show-on-unchecked }`autoscan2_web_api_port`{ .sb-show-on-checked }"
    ...
    ??? variable string "`autoscan_role_web_api_scheme`{ .sb-show-on-unchecked }`autoscan2_web_api_scheme`{ .sb-show-on-checked }"
    ...
    ??? variable dict "`autoscan_role_web_api_serverstransport`{ .sb-show-on-unchecked }`autoscan2_web_api_serverstransport`{ .sb-show-on-checked }"
