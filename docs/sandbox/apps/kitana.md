...
=== "Docker+"
    ...
    ??? variable string "`kitana_role_docker_stop_signal`"

        ```yaml
        # Type: string
        kitana_role_docker_stop_signal:
        ```
...
=== "Global Override Options"
    ...
    ??? variable string "`kitana_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        kitana_role_web_api_http_port:
        ```

    ??? variable string "`kitana_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        kitana_role_web_api_http_scheme:
        ```

    ??? variable dict "`kitana_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        kitana_role_web_api_http_serverstransport:
        ```

    ??? variable string "`kitana_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        kitana_role_web_api_port:
        ```

    ??? variable string "`kitana_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        kitana_role_web_api_scheme:
        ```

    ??? variable dict "`kitana_role_web_api_serverstransport`"
