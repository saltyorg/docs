...
=== "Traefik"
    ...
    ??? variable string "`dashdot_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        dashdot_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`dashdot_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        dashdot_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`dashdot_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        dashdot_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`dashdot_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        dashdot_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`dashdot_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        dashdot_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable string "`dashdot_role_docker_stop_signal`"

        ```yaml
        # Type: string
        dashdot_role_docker_stop_signal:
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`dashdot_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        dashdot_role_paths_folders_list_custom:
        ```

    ??? variable string "`dashdot_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        dashdot_role_paths_group:
        ```

    ??? variable string "`dashdot_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        dashdot_role_paths_owner:
        ```

    ??? variable string "`dashdot_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        dashdot_role_paths_permissions:
        ```

    ??? variable bool "`dashdot_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        dashdot_role_paths_recursive:
        ```
