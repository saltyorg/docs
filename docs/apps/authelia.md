...
=== "Settings"
    ...
    === "TOTP"
        ...
        ??? variable string "`authelia_role_totp_issuer`"
            ...
            ```yaml
            # Type: string
            authelia_role_totp_issuer: "{{ lookup('role_web', role='authelia') }}"
            ```
...
=== "Web"
    ...
    ??? variable string "`authelia_role_web_url`"
        ...
        ```yaml
        # Type: string
        authelia_role_web_url: "{{ lookup('role_web', role='authelia', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`authelia_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        authelia_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`authelia_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        authelia_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`authelia_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        authelia_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`authelia_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        authelia_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`authelia_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        authelia_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable string "`authelia_role_docker_stop_signal`"

        ```yaml
        # Type: string
        authelia_role_docker_stop_signal:
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`authelia_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        authelia_role_paths_folders_list_custom:
        ```

    ??? variable string "`authelia_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        authelia_role_paths_group:
        ```

    ??? variable string "`authelia_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        authelia_role_paths_owner:
        ```

    ??? variable string "`authelia_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        authelia_role_paths_permissions:
        ```

    ??? variable bool "`authelia_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        authelia_role_paths_recursive:
        ```
