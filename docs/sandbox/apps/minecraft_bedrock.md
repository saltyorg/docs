...
[:fontawesome-solid-book-open:**Manual**](https://github.com/itzg/docker-minecraft-bedrock-server){ .md-button .md-button--stretch }
...
=== "Docker+"
    ...
    ??? variable bool "`minecraft_bedrock_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        minecraft_bedrock_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`minecraft_bedrock_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        minecraft_bedrock_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`minecraft_bedrock_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        minecraft_bedrock_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`minecraft_bedrock_role_docker_force_kill`"
    ...
    ??? variable list "`minecraft_bedrock_role_docker_entrypoint`"
    ...
    ??? variable dict "`minecraft_bedrock_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`minecraft_bedrock_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        minecraft_bedrock_role_paths_folders_list_custom:
        ```

    ??? variable string "`minecraft_bedrock_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        minecraft_bedrock_role_paths_group:
        ```

    ??? variable string "`minecraft_bedrock_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        minecraft_bedrock_role_paths_owner:
        ```

    ??? variable string "`minecraft_bedrock_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        minecraft_bedrock_role_paths_permissions:
        ```

    ??? variable bool "`minecraft_bedrock_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        minecraft_bedrock_role_paths_recursive:
        ```
