...
=== "Web"
    ...
    ??? variable string "`plexshare_role_web_url`"
        ...
        ```yaml
        # Type: string
        plexshare_role_web_url: "{{ lookup('role_web', role='plexshare', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`plexshare_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        plexshare_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`plexshare_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        plexshare_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`plexshare_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        plexshare_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`plexshare_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        plexshare_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`plexshare_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        plexshare_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable string "`plexshare_role_docker_stop_signal`"

        ```yaml
        # Type: string
        plexshare_role_docker_stop_signal:
        ```
