...
=== "Web"
    ...
    ??? variable string "`archivebox_role_web_url`"
        ...
        ```yaml
        # Type: string
        archivebox_role_web_url: "{{ lookup('role_web', role='archivebox', scheme='https') }}"
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`archivebox_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        archivebox_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`archivebox_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        archivebox_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`archivebox_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        archivebox_role_docker_dev_dri_disabled: false
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`archivebox_role_docker_networks_alias_custom`"

        ```yaml
        # Type: list
        archivebox_role_docker_networks_alias_custom:
        ```
    ...
    ??? variable list "`archivebox_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        archivebox_role_paths_folders_list_custom:
        ```

    ??? variable string "`archivebox_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        archivebox_role_paths_group:
        ```

    ??? variable string "`archivebox_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        archivebox_role_paths_owner:
        ```

    ??? variable string "`archivebox_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        archivebox_role_paths_permissions:
        ```
    ...
    ??? variable string "`archivebox_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        archivebox_role_web_api_http_port:
        ```

    ??? variable string "`archivebox_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        archivebox_role_web_api_http_scheme:
        ```

    ??? variable dict "`archivebox_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        archivebox_role_web_api_http_serverstransport:
        ```

    ??? variable string "`archivebox_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        archivebox_role_web_api_port:
        ```

    ??? variable string "`archivebox_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        archivebox_role_web_api_scheme:
        ```

    ??? variable dict "`archivebox_role_web_api_serverstransport`"

        ```yaml
        # Type: dict/omit
        archivebox_role_web_api_serverstransport:
        ```
