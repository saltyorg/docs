...
=== "Web"
    ...
    ??? variable string "`invoiceninjav5_role_nginx_web_url`"
        ...
        ```yaml
        # Type: string
        invoiceninjav5_role_nginx_web_url: "{{ lookup('role_web', role='invoiceninjav5', endpoint='nginx_web', scheme='https') }}"
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`invoiceninjav5_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        invoiceninjav5_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`invoiceninjav5_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        invoiceninjav5_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`invoiceninjav5_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        invoiceninjav5_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`invoiceninjav5_role_docker_force_kill`"
    ...
    ??? variable list "`invoiceninjav5_role_docker_entrypoint`"
    ...
    ??? variable dict "`invoiceninjav5_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`invoiceninjav5_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        invoiceninjav5_role_paths_folders_list_custom:
        ```
    ...
    ??? variable string "`invoiceninjav5_role_paths_group`"
        ...
        # Type: string
        invoiceninjav5_role_paths_group:
        ```
    ...
    ??? variable string "`invoiceninjav5_role_paths_owner`"
        ...
        # Type: string
        invoiceninjav5_role_paths_owner:
        ```

    ??? variable string "`invoiceninjav5_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        invoiceninjav5_role_paths_permissions:
        ```
    ...
    ??? variable bool "`invoiceninjav5_role_paths_recursive`"
        ...
        # Type: bool (true/false)
        invoiceninjav5_role_paths_recursive:
        ```

    ??? variable list "`invoiceninjav5_role_themepark_addons`"
