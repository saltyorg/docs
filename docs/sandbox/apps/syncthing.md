...
=== "Web"
    ...
    ??? variable string "`syncthing_role_web_url`"
        ...
        ```yaml
        # Type: string
        syncthing_role_web_url: "{{ lookup('role_web', role='syncthing', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`syncthing_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        syncthing_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`syncthing_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        syncthing_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`syncthing_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        syncthing_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`syncthing_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        syncthing_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`syncthing_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        syncthing_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`syncthing_role_docker_force_kill`"
    ...
    ??? variable string "`syncthing_role_docker_stop_signal`"

        ```yaml
        # Type: string
        syncthing_role_docker_stop_signal:
        ```
    ...
    ??? variable list "`syncthing_role_docker_entrypoint`"
    ...
    ??? variable dict "`syncthing_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`syncthing_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        syncthing_role_paths_folders_list_custom:
        ```

    ??? variable string "`syncthing_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        syncthing_role_paths_group:
        ```

    ??? variable string "`syncthing_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        syncthing_role_paths_owner:
        ```

    ??? variable string "`syncthing_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        syncthing_role_paths_permissions:
        ```

    ??? variable bool "`syncthing_role_paths_recursive`"

        ```yaml
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        syncthing_role_paths_recursive:
        ```

    ??? variable list "`syncthing_role_themepark_addons`"
    ...
    ??? variable string "`syncthing_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        syncthing_role_web_api_http_port:
        ```

    ??? variable string "`syncthing_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        syncthing_role_web_api_http_scheme:
        ```

    ??? variable dict "`syncthing_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        syncthing_role_web_api_http_serverstransport:
        ```

    ??? variable string "`syncthing_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        syncthing_role_web_api_port:
        ```

    ??? variable string "`syncthing_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        syncthing_role_web_api_scheme:
        ```

    ??? variable dict "`syncthing_role_web_api_serverstransport`"
