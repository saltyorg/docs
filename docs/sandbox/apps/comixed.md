...
=== "Web"
    ...
    ??? variable string "`comixed_role_web_url`"
        ...
        ```yaml
        # Type: string
        comixed_role_web_url: "{{ lookup('role_web', role='comixed', scheme='https') }}"
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`comixed_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        comixed_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`comixed_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        comixed_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`comixed_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        comixed_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable string "`comixed_role_docker_stop_signal`"

        ```yaml
        # Type: string
        comixed_role_docker_stop_signal:
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`comixed_role_docker_networks_alias_custom`"

        ```yaml
        # Type: list
        comixed_role_docker_networks_alias_custom:
        ```
    ...
    ??? variable list "`comixed_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        comixed_role_paths_folders_list_custom:
        ```

    ??? variable string "`comixed_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        comixed_role_paths_group:
        ```

    ??? variable string "`comixed_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        comixed_role_paths_owner:
        ```

    ??? variable string "`comixed_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        comixed_role_paths_permissions:
        ```

    ??? variable bool "`comixed_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        comixed_role_paths_recursive:
        ```
    ...
    ??? variable string "`comixed_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        comixed_role_web_api_http_port:
        ```

    ??? variable string "`comixed_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        comixed_role_web_api_http_scheme:
        ```

    ??? variable dict "`comixed_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        comixed_role_web_api_http_serverstransport:
        ```

    ??? variable string "`comixed_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        comixed_role_web_api_port:
        ```

    ??? variable string "`comixed_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        comixed_role_web_api_scheme:
        ```

    ??? variable dict "`comixed_role_web_api_serverstransport`"

        ```yaml
        # Type: dict/omit
        comixed_role_web_api_serverstransport:
        ```
