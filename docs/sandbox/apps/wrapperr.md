...
=== "Docker+"
    ...
    ??? variable string "`wrapperr_role_docker_devices_default`"

        ```yaml
        # Type: string
        wrapperr_role_docker_devices_default:
        ```
...
=== "Global Override Options"
    ...
    ??? variable dict/omit "`wrapperr_role_traefik_api_endpoint`"
    ...
    ??? variable dict/omit "`wrapperr_role_web_http_serverstransport`"
    ...
    ??? variable dict/omit "`wrapperr_role_web_serverstransport`"
