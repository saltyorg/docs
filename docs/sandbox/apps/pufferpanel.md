...
=== "Web"
    ...
    ??? variable string "`pufferpanel_role_web_url`"
        ...
        ```yaml
        # Type: string
        pufferpanel_role_web_url: "{{ lookup('role_web', role='pufferpanel', scheme='https') }}"
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`pufferpanel_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        pufferpanel_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`pufferpanel_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        pufferpanel_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`pufferpanel_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        pufferpanel_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`pufferpanel_role_docker_force_kill`"
    ...
    ??? variable list "`pufferpanel_role_docker_entrypoint`"
    ...
    ??? variable dict "`pufferpanel_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`pufferpanel_role_docker_networks_alias_custom`"

        ```yaml
        # Type: list
        pufferpanel_role_docker_networks_alias_custom:
        ```
    ...
    ??? variable list "`pufferpanel_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        pufferpanel_role_paths_folders_list_custom:
        ```

    ??? variable string "`pufferpanel_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        pufferpanel_role_paths_group:
        ```

    ??? variable string "`pufferpanel_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        pufferpanel_role_paths_owner:
        ```

    ??? variable string "`pufferpanel_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        pufferpanel_role_paths_permissions:
        ```

    ??? variable bool "`pufferpanel_role_paths_recursive`"

        ```yaml
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        pufferpanel_role_paths_recursive:
        ```

    ??? variable list "`pufferpanel_role_themepark_addons`"
    ...
    ??? variable string "`pufferpanel_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        pufferpanel_role_web_api_http_port:
        ```

    ??? variable string "`pufferpanel_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        pufferpanel_role_web_api_http_scheme:
        ```

    ??? variable dict "`pufferpanel_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        pufferpanel_role_web_api_http_serverstransport:
        ```

    ??? variable string "`pufferpanel_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        pufferpanel_role_web_api_port:
        ```

    ??? variable string "`pufferpanel_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        pufferpanel_role_web_api_scheme:
        ```

    ??? variable dict "`pufferpanel_role_web_api_serverstransport`"

        ```yaml
        # Type: dict/omit
        pufferpanel_role_web_api_serverstransport:
        ```
