...
=== "Web"
    ...
    ??? variable string "`koel_role_web_url`"
        ...
        ```yaml
        # Type: string
        koel_role_web_url: "{{ lookup('role_web', role='koel', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`koel_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        koel_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`koel_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        koel_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`koel_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        koel_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`koel_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        koel_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`koel_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        koel_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`koel_role_docker_force_kill`"
    ...
    ??? variable list "`koel_role_docker_entrypoint`"
    ...
    ??? variable dict "`koel_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`koel_role_docker_networks_alias_custom`"

        ```yaml
        # Type: list
        koel_role_docker_networks_alias_custom:
        ```
    ...
    ??? variable list "`koel_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        koel_role_paths_folders_list_custom:
        ```

    ??? variable string "`koel_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        koel_role_paths_group:
        ```

    ??? variable string "`koel_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        koel_role_paths_owner:
        ```

    ??? variable string "`koel_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        koel_role_paths_permissions:
        ```

    ??? variable bool "`koel_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        koel_role_paths_recursive:
        ```

    ??? variable list "`koel_role_themepark_addons`"
