...
=== "Docker+"
    ...
    ??? variable bool "`unpackerr_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        unpackerr_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`unpackerr_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        unpackerr_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`unpackerr_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        unpackerr_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable string "`unpackerr_role_docker_stop_signal`"

        ```yaml
        # Type: string
        unpackerr_role_docker_stop_signal:
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`unpackerr_role_docker_networks_alias_custom`"

        ```yaml
        # Type: list
        unpackerr_role_docker_networks_alias_custom:
        ```
    ...
    ??? variable list "`unpackerr_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        unpackerr_role_paths_folders_list_custom:
        ```

    ??? variable string "`unpackerr_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        unpackerr_role_paths_group:
        ```

    ??? variable string "`unpackerr_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        unpackerr_role_paths_owner:
        ```

    ??? variable string "`unpackerr_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        unpackerr_role_paths_permissions:
        ```

    ??? variable bool "`unpackerr_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        unpackerr_role_paths_recursive:
        ```
