...
1. Give it the proper ownership and permissions. Replace `user` and `group` to match yours (see [here](https://www.cyberciti.biz/faq/unix-linux-id-command-examples-usage-syntax/#3)):
