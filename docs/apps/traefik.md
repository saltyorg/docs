...
=== "Docker"
    ...
    ??? variable dict "`traefik_role_docker_labels_dns_validation_resolver`"
...
=== "Docker+"
    ...
    ??? variable bool "`traefik_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        traefik_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`traefik_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        traefik_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`traefik_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        traefik_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable string "`traefik_role_docker_stop_signal`"
...
=== "Global Override Options"
    ...
    ??? variable list "`traefik_role_docker_networks_alias_custom`"
    ...
    ??? variable list "`traefik_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        traefik_role_paths_folders_list_custom:
        ```

    ??? variable string "`traefik_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        traefik_role_paths_group:
        ```

    ??? variable string "`traefik_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        traefik_role_paths_owner:
        ```

    ??? variable string "`traefik_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        traefik_role_paths_permissions:
        ```

    ??? variable bool "`traefik_role_paths_recursive`"

        ```yaml
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        traefik_role_paths_recursive:
        ```
