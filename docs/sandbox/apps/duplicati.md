...
=== "Web"
    ...
    ??? variable string "`duplicati_role_web_url`"
        ...
        ```yaml
        # Type: string
        duplicati_role_web_url: "{{ lookup('role_web', role='duplicati', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`duplicati_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        duplicati_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`duplicati_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        duplicati_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`duplicati_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        duplicati_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`duplicati_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        duplicati_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`duplicati_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        duplicati_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`duplicati_role_docker_force_kill`"
    ...
    ??? variable list "`duplicati_role_docker_entrypoint`"
    ...
    ??? variable dict "`duplicati_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`duplicati_role_docker_networks_alias_custom`"

        ```yaml
        # Type: list
        duplicati_role_docker_networks_alias_custom:
        ```
    ...
    ??? variable list "`duplicati_role_paths_folders_list_custom`"
    ...
    ??? variable string "`duplicati_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        duplicati_role_paths_group:
        ```

    ??? variable string "`duplicati_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        duplicati_role_paths_owner:
        ```

    ??? variable string "`duplicati_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        duplicati_role_paths_permissions:
        ```

    ??? variable bool "`duplicati_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        duplicati_role_paths_recursive:
        ```

    ??? variable list "`duplicati_role_themepark_addons`"
    ...
    ??? variable string "`duplicati_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        duplicati_role_web_api_http_port:
        ```

    ??? variable string "`duplicati_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        duplicati_role_web_api_http_scheme:
        ```

    ??? variable dict "`duplicati_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        duplicati_role_web_api_http_serverstransport:
        ```

    ??? variable string "`duplicati_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        duplicati_role_web_api_port:
        ```

    ??? variable string "`duplicati_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        duplicati_role_web_api_scheme:
        ```

    ??? variable dict "`duplicati_role_web_api_serverstransport`"

        ```yaml
        # Type: dict/omit
        duplicati_role_web_api_serverstransport:
        ```
