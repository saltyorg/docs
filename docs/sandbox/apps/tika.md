...
saltbox_automation:
  app_links:
    - name: Manual
      ...
      type: documentation
    - name: Releases
      url: https://hub.docker.com/r/tika/tika/tags
      type: docker
    - name: Community
      url:
      type: community
...
=== "Docker+"
    ...
    ??? variable bool "`tika_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        tika_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`tika_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        tika_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`tika_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        tika_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable string "`tika_role_docker_stop_signal`"

        ```yaml
        # Type: string
        tika_role_docker_stop_signal:
        ```
