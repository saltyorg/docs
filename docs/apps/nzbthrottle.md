...
=== "Docker+"
    ...
    ??? variable bool "`nzbthrottle_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        nzbthrottle_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`nzbthrottle_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        nzbthrottle_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`nzbthrottle_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        nzbthrottle_role_docker_dev_dri_disabled: false
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`nzbthrottle_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        nzbthrottle_role_paths_folders_list_custom:
        ```

    ??? variable string "`nzbthrottle_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        nzbthrottle_role_paths_group:
        ```

    ??? variable string "`nzbthrottle_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        nzbthrottle_role_paths_owner:
        ```

    ??? variable string "`nzbthrottle_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        nzbthrottle_role_paths_permissions:
        ```
