...
=== "Web"
    ...
    ??? variable string "`vnstat_role_web_url`"
        ...
        ```yaml
        # Type: string
        vnstat_role_web_url: "{{ lookup('role_web', role='vnstat', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`vnstat_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        vnstat_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`vnstat_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        vnstat_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`vnstat_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        vnstat_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`vnstat_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        vnstat_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`vnstat_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        vnstat_role_docker_dev_dri_disabled: false
        ```
