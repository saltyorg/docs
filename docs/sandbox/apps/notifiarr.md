...
=== "Web"
    ...
    ??? variable string "`notifiarr_role_web_url`"
        ...
        ```yaml
        # Type: string
        notifiarr_role_web_url: "{{ lookup('role_web', role='notifiarr', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`notifiarr_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        notifiarr_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`notifiarr_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        notifiarr_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`notifiarr_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        notifiarr_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`notifiarr_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        notifiarr_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`notifiarr_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        notifiarr_role_docker_dev_dri_disabled: false
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`notifiarr_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        notifiarr_role_paths_folders_list_custom:
        ```

    ??? variable string "`notifiarr_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        notifiarr_role_paths_group:
        ```

    ??? variable string "`notifiarr_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        notifiarr_role_paths_owner:
        ```

    ??? variable string "`notifiarr_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        notifiarr_role_paths_permissions:
        ```
    ...
    ??? variable bool "`notifiarr_role_paths_recursive`"
        ...
        # Type: bool (true/false)
        notifiarr_role_paths_recursive:
        ```
