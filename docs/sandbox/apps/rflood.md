...
=== "Docker+"
    ...
    ??? variable bool "`rflood_role_docker_gpu_enabled`{ .sb-show-on-unchecked }`rflood2_docker_gpu_enabled`{ .sb-show-on-checked }"
    ...
    ??? variable bool "`rflood_role_docker_nvidia_disabled`{ .sb-show-on-unchecked }`rflood2_docker_nvidia_disabled`{ .sb-show-on-checked }"
    ...
    ??? variable bool "`rflood_role_docker_dev_dri_disabled`{ .sb-show-on-unchecked }`rflood2_docker_dev_dri_disabled`{ .sb-show-on-checked }"
    ...
    ??? variable string "`rflood_role_docker_stop_signal`{ .sb-show-on-unchecked }`rflood2_docker_stop_signal`{ .sb-show-on-checked }"
...
=== "Global Override Options"
    ...
    ??? variable list "`rflood_role_paths_folders_list_custom`{ .sb-show-on-unchecked }`rflood2_paths_folders_list_custom`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Extra directories to create
        # Type: list
        rflood_role_paths_folders_list_custom:
        ```

        ```yaml { .sb-show-on-checked }
        # Extra directories to create
        # Type: list
        rflood2_paths_folders_list_custom:
        ```

    ??? variable string "`rflood_role_paths_group`{ .sb-show-on-unchecked }`rflood2_paths_group`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Group for directories created by the role
        # Type: string
        rflood_role_paths_group:
        ```
    ...
    ??? variable string "`rflood_role_paths_owner`{ .sb-show-on-unchecked }`rflood2_paths_owner`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Owner for directories created by the role
        # Type: string
        rflood_role_paths_owner:
        ```
    ...
    ??? variable string "`rflood_role_paths_permissions`{ .sb-show-on-unchecked }`rflood2_paths_permissions`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Permissions for directories created by the role
        # Type: string
        rflood_role_paths_permissions:
        ```

        ```yaml { .sb-show-on-checked }
        # Permissions for directories created by the role
        # Type: string
        rflood2_paths_permissions:
        ```

    ??? variable bool "`rflood_role_paths_recursive`{ .sb-show-on-unchecked }`rflood2_paths_recursive`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        rflood_role_paths_recursive:
        ```

        ```yaml { .sb-show-on-checked }
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        rflood2_paths_recursive:
        ```
    ...
    ??? variable string "`rflood_role_web_api_http_port`{ .sb-show-on-unchecked }`rflood2_web_api_http_port`{ .sb-show-on-checked }"
    ...
    ??? variable string "`rflood_role_web_api_http_scheme`{ .sb-show-on-unchecked }`rflood2_web_api_http_scheme`{ .sb-show-on-checked }"
    ...
    ??? variable dict "`rflood_role_web_api_http_serverstransport`{ .sb-show-on-unchecked }`rflood2_web_api_http_serverstransport`{ .sb-show-on-checked }"
    ...
    ??? variable string "`rflood_role_web_api_port`{ .sb-show-on-unchecked }`rflood2_web_api_port`{ .sb-show-on-checked }"
    ...
    ??? variable string "`rflood_role_web_api_scheme`{ .sb-show-on-unchecked }`rflood2_web_api_scheme`{ .sb-show-on-checked }"
    ...
    ??? variable dict "`rflood_role_web_api_serverstransport`{ .sb-show-on-unchecked }`rflood2_web_api_serverstransport`{ .sb-show-on-checked }"
