...
=== "Web"
    ...
    ??? variable string "`mylar3_role_web_url`"
        ...
        ```yaml
        # Type: string
        mylar3_role_web_url: "{{ lookup('role_web', role='mylar3', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`mylar3_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        mylar3_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`mylar3_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        mylar3_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`mylar3_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        mylar3_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`mylar3_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        mylar3_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`mylar3_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        mylar3_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`mylar3_role_docker_force_kill`"
    ...
    ??? variable list "`mylar3_role_docker_entrypoint`"
    ...
    ??? variable dict "`mylar3_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`mylar3_role_docker_networks_alias_custom`"

        ```yaml
        # Type: list
        mylar3_role_docker_networks_alias_custom:
        ```
    ...
    ??? variable list "`mylar3_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        mylar3_role_paths_folders_list_custom:
        ```

    ??? variable string "`mylar3_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        mylar3_role_paths_group:
        ```

    ??? variable string "`mylar3_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        mylar3_role_paths_owner:
        ```

    ??? variable string "`mylar3_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        mylar3_role_paths_permissions:
        ```

    ??? variable bool "`mylar3_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        mylar3_role_paths_recursive:
        ```

    ??? variable list "`mylar3_role_themepark_addons`"
    ...
    ??? variable string "`mylar3_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        mylar3_role_web_api_http_port:
        ```

    ??? variable string "`mylar3_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        mylar3_role_web_api_http_scheme:
        ```

    ??? variable dict "`mylar3_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        mylar3_role_web_api_http_serverstransport:
        ```

    ??? variable string "`mylar3_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        mylar3_role_web_api_port:
        ```

    ??? variable string "`mylar3_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        mylar3_role_web_api_scheme:
        ```

    ??? variable dict "`mylar3_role_web_api_serverstransport`"

        ```yaml
        # Type: dict/omit
        mylar3_role_web_api_serverstransport:
        ```
