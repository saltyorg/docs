...
=== "Docker+"
    ...
    ??? variable string "`jellyfin_role_docker_dev_dri`{ .sb-show-on-unchecked }`jellyfin2_docker_dev_dri`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string
        jellyfin_role_docker_dev_dri:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        jellyfin2_docker_dev_dri:
        ```
