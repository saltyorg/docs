...
=== "Web"
    ...
    ??? variable string "`ytdl_sub_role_web_url`"
        ...
        ```yaml
        # Type: string
        ytdl_sub_role_web_url: "{{ lookup('role_web', role='ytdl_sub', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`ytdl_sub_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        ytdl_sub_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`ytdl_sub_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        ytdl_sub_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker"
    ...
    ??? variable bool "`ytdl_sub_role_docker_gpu_enabled`"
...
=== "Docker+"
    ...
    ??? variable string "`ytdl_sub_role_docker_stop_signal`"

        ```yaml
        # Type: string
        ytdl_sub_role_docker_stop_signal:
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`ytdl_sub_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        ytdl_sub_role_paths_folders_list_custom:
        ```

    ??? variable string "`ytdl_sub_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        ytdl_sub_role_paths_group:
        ```

    ??? variable string "`ytdl_sub_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        ytdl_sub_role_paths_owner:
        ```

    ??? variable string "`ytdl_sub_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        ytdl_sub_role_paths_permissions:
        ```

    ??? variable bool "`ytdl_sub_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        ytdl_sub_role_paths_recursive:
        ```
    ...
    ??? variable string "`ytdl_sub_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        ytdl_sub_role_web_api_http_port:
        ```

    ??? variable string "`ytdl_sub_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        ytdl_sub_role_web_api_http_scheme:
        ```

    ??? variable dict "`ytdl_sub_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        ytdl_sub_role_web_api_http_serverstransport:
        ```

    ??? variable string "`ytdl_sub_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        ytdl_sub_role_web_api_port:
        ```

    ??? variable string "`ytdl_sub_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        ytdl_sub_role_web_api_scheme:
        ```

    ??? variable dict "`ytdl_sub_role_web_api_serverstransport`"
