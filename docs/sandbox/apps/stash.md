...
[:fontawesome-solid-book-open:**Manual**](https://docs.stashapp.cc){ .md-button .md-button--stretch }

[:fontawesome-brands-github:**Releases**](https://github.com/hotio/stash/pkgs/container/stash){ .md-button .md-button--stretch }

[:fontawesome-solid-comments:**Community**](https://docs.stashapp.cc/#support){ .md-button .md-button--stretch }
...
=== "Web"
    ...
    ??? variable string "`stash_role_web_url`"
        ...
        ```yaml
        # Type: string
        stash_role_web_url: "{{ lookup('role_web', role='stash', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`stash_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        stash_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`stash_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        stash_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker"
    ...
    ??? variable bool "`stash_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        stash_role_docker_gpu_enabled: true
        ```

    ??? variable bool "`stash_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        stash_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`stash_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        stash_role_docker_dev_dri_disabled: false
        ```
...
=== "Docker+"
    ...
    ??? variable string "`stash_role_docker_stop_signal`"

        ```yaml
        # Type: string
        stash_role_docker_stop_signal:
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`stash_role_docker_networks_alias_custom`"

        ```yaml
        # Type: list
        stash_role_docker_networks_alias_custom:
        ```
    ...
    ??? variable list "`stash_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        stash_role_paths_folders_list_custom:
        ```

    ??? variable string "`stash_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        stash_role_paths_group:
        ```

    ??? variable string "`stash_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        stash_role_paths_owner:
        ```

    ??? variable string "`stash_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        stash_role_paths_permissions:
        ```

    ??? variable bool "`stash_role_paths_recursive`"

        ```yaml
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        stash_role_paths_recursive:
        ```
    ...
    ??? variable dict "`stash_role_web_http_serverstransport`"
    ...
    ??? variable dict "`stash_role_web_serverstransport`"
