...
=== "Web"
    ...
    ??? variable string "`puddletag_role_web_url`"
        ...
        ```yaml
        # Type: string
        puddletag_role_web_url: "{{ lookup('role_web', role='puddletag', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`puddletag_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        puddletag_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`puddletag_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        puddletag_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`puddletag_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        puddletag_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`puddletag_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        puddletag_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`puddletag_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        puddletag_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`puddletag_role_docker_force_kill`"
    ...
    ??? variable list "`puddletag_role_docker_entrypoint`"
    ...
    ??? variable dict "`puddletag_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`puddletag_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        puddletag_role_paths_folders_list_custom:
        ```

    ??? variable string "`puddletag_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        puddletag_role_paths_group:
        ```

    ??? variable string "`puddletag_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        puddletag_role_paths_owner:
        ```

    ??? variable string "`puddletag_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        puddletag_role_paths_permissions:
        ```

    ??? variable bool "`puddletag_role_paths_recursive`"

        ```yaml
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        puddletag_role_paths_recursive:
        ```

    ??? variable list "`puddletag_role_themepark_addons`"
