...
=== "Docker+"
    ...
    ??? variable bool "`plex_auto_languages_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        plex_auto_languages_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`plex_auto_languages_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        plex_auto_languages_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`plex_auto_languages_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        plex_auto_languages_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`plex_auto_languages_role_docker_force_kill`"
    ...
    ??? variable list "`plex_auto_languages_role_docker_entrypoint`"
    ...
    ??? variable dict "`plex_auto_languages_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`plex_auto_languages_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        plex_auto_languages_role_paths_folders_list_custom:
        ```

    ??? variable string "`plex_auto_languages_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        plex_auto_languages_role_paths_group:
        ```

    ??? variable string "`plex_auto_languages_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        plex_auto_languages_role_paths_owner:
        ```

    ??? variable string "`plex_auto_languages_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        plex_auto_languages_role_paths_permissions:
        ```
