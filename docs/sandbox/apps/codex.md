...
[:fontawesome-solid-book-open:**Manual**](https://github.com/ajslater/codex#%EF%B8%8F-configuration){ .md-button .md-button--stretch }
...
=== "Web"
    ...
    ??? variable string "`codex_role_web_url`"
        ...
        ```yaml
        # Type: string
        codex_role_web_url: "{{ lookup('role_web', role='codex', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`codex_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        codex_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`codex_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        codex_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`codex_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        codex_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`codex_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        codex_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`codex_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        codex_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`codex_role_docker_force_kill`"
    ...
    ??? variable string "`codex_role_docker_stop_signal`"

        ```yaml
        # Type: string
        codex_role_docker_stop_signal:
        ```
    ...
    ??? variable list "`codex_role_docker_entrypoint`"
    ...
    ??? variable dict "`codex_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`codex_role_docker_networks_alias_custom`"

        ```yaml
        # Type: list
        codex_role_docker_networks_alias_custom:
        ```
    ...
    ??? variable list "`codex_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        codex_role_paths_folders_list_custom:
        ```

    ??? variable string "`codex_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        codex_role_paths_group:
        ```

    ??? variable string "`codex_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        codex_role_paths_owner:
        ```

    ??? variable string "`codex_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        codex_role_paths_permissions:
        ```

    ??? variable bool "`codex_role_paths_recursive`"

        ```yaml
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        codex_role_paths_recursive:
        ```

    ??? variable list "`codex_role_themepark_addons`"
    ...
    ??? variable string "`codex_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        codex_role_web_api_http_port:
        ```

    ??? variable string "`codex_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        codex_role_web_api_http_scheme:
        ```

    ??? variable dict "`codex_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        codex_role_web_api_http_serverstransport:
        ```

    ??? variable string "`codex_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        codex_role_web_api_port:
        ```

    ??? variable string "`codex_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        codex_role_web_api_scheme:
        ```

    ??? variable dict "`codex_role_web_api_serverstransport`"

        ```yaml
        # Type: dict/omit
        codex_role_web_api_serverstransport:
        ```
