...
=== "Web"
    ...
    ??? variable string "`threadfin_role_web_url`"
        ...
        ```yaml
        # Type: string
        threadfin_role_web_url: "{{ lookup('role_web', role='threadfin', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`threadfin_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        threadfin_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`threadfin_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        threadfin_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`threadfin_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        threadfin_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`threadfin_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        threadfin_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`threadfin_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        threadfin_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`threadfin_role_docker_force_kill`"
    ...
    ??? variable list "`threadfin_role_docker_entrypoint`"
    ...
    ??? variable dict "`threadfin_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable string "`threadfin_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        threadfin_role_web_api_http_port:
        ```

    ??? variable string "`threadfin_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        threadfin_role_web_api_http_scheme:
        ```

    ??? variable dict "`threadfin_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        threadfin_role_web_api_http_serverstransport:
        ```

    ??? variable string "`threadfin_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        threadfin_role_web_api_port:
        ```

    ??? variable string "`threadfin_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        threadfin_role_web_api_scheme:
        ```

    ??? variable dict "`threadfin_role_web_api_serverstransport`"
