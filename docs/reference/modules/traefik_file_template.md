...
=== "Template Variables"
    ...
    ??? variable string "`traefik_file_template_name`"
    ...
    ??? variable string "`traefik_file_template_web_subdomain`"
    ...
    ??? variable string "`traefik_file_template_web_domain`"
    ...
    ??? variable string "`traefik_file_template_web_port`"
    ...
    ??? variable string "`traefik_file_template_web_ip`"
    ...
    ??? variable string "`traefik_file_template_web_scheme`"
    ...
    ??? variable string "`traefik_file_template_traefik_enabled`"
    ...
    ??? variable string "`traefik_file_template_traefik_sso_middleware`"
    ...
    ??? variable string "`traefik_file_template_traefik_middleware_default`"
    ...
    ??? variable string "`traefik_file_template_traefik_api_enabled`"
    ...
    ??? variable string "`traefik_file_template_traefik_api_endpoint`"
...
=== "Global Override Options"
    ...
    ??? variable bool "`traefik_file_template_role_autoheal_enabled`"
    ...
    ??? variable string "`traefik_file_template_role_depends_on`"
    ...
    ??? variable string "`traefik_file_template_role_depends_on_delay`"
    ...
    ??? variable string "`traefik_file_template_role_depends_on_healthchecks`"
    ...
    ??? variable bool "`traefik_file_template_role_diun_enabled`"
    ...
    ??? variable bool "`traefik_file_template_role_dns_enabled`"
    ...
    ??? variable bool "`traefik_file_template_role_docker_controller`"
    ...
    ??? variable bool "`traefik_file_template_role_traefik_autodetect_enabled`"
    ...
    ??? variable bool "`traefik_file_template_role_traefik_crowdsec_enabled`"
    ...
    ??? variable bool "`traefik_file_template_role_traefik_error_pages_enabled`"
    ...
    ??? variable bool "`traefik_file_template_role_traefik_gzip_enabled`"
    ...
    ??? variable bool "`traefik_file_template_role_traefik_middleware_http_api_insecure`"
    ...
    ??? variable bool "`traefik_file_template_role_traefik_middleware_http_insecure`"
    ...
    ??? variable bool "`traefik_file_template_role_traefik_robot_enabled`"
    ...
    ??? variable bool "`traefik_file_template_role_traefik_tailscale_enabled`"
    ...
    ??? variable bool "`traefik_file_template_role_traefik_wildcard_enabled`"
    ...
    ??? variable list "`traefik_file_template_role_web_fqdn_override`"
    ...
    ??? variable string "`traefik_file_template_role_web_host_override`"
    ...
    ??? variable string "`traefik_file_template_role_web_scheme`"
