...
=== "Docker+"
    ...
    ??? variable bool "`error_pages_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        error_pages_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`error_pages_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        error_pages_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`error_pages_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        error_pages_role_docker_dev_dri_disabled: false
        ```
