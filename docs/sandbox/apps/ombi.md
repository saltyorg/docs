...
=== "Docker+"
    ...
    ??? variable string "`ombi_role_docker_force_kill`{ .sb-show-on-unchecked }`ombi2_docker_force_kill`{ .sb-show-on-checked }"
    ...
    ??? variable string "`ombi_role_docker_entrypoint`{ .sb-show-on-unchecked }`ombi2_docker_entrypoint`{ .sb-show-on-checked }"
    ...
    ??? variable list "`ombi_role_docker_sysctls`{ .sb-show-on-unchecked }`ombi2_docker_sysctls`{ .sb-show-on-checked }"
...
=== "Global Override Options"
    ...
    ??? variable string "`ombi_role_themepark_addons`{ .sb-show-on-unchecked }`ombi2_themepark_addons`{ .sb-show-on-checked }"
