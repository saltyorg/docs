...
=== "Docker"
    ...
    ??? variable string "`influxdb_role_docker_user`"
        ...
        ```yaml
        # Type: string
        influxdb_role_docker_user: "{{ uid }}:{{ gid }}"
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`influxdb_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        influxdb_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`influxdb_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        influxdb_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`influxdb_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        influxdb_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable string "`influxdb_role_docker_stop_signal`"

        ```yaml
        # Type: string
        influxdb_role_docker_stop_signal:
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`influxdb_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        influxdb_role_paths_folders_list_custom:
        ```

    ??? variable string "`influxdb_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        influxdb_role_paths_group:
        ```

    ??? variable string "`influxdb_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        influxdb_role_paths_owner:
        ```

    ??? variable string "`influxdb_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        influxdb_role_paths_permissions:
        ```
