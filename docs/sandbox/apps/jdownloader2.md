...
=== "Web"
    ...
    ??? variable string "`jdownloader2_role_web_url`"
        ...
        ```yaml
        # Type: string
        jdownloader2_role_web_url: "{{ lookup('role_web', role='jdownloader2', scheme='https') }}"
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`jdownloader2_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        jdownloader2_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`jdownloader2_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        jdownloader2_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`jdownloader2_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        jdownloader2_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`jdownloader2_role_docker_force_kill`"
    ...
    ??? variable list "`jdownloader2_role_docker_entrypoint`"
    ...
    ??? variable dict "`jdownloader2_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`jdownloader2_role_docker_networks_alias_custom`"

        ```yaml
        # Type: list
        jdownloader2_role_docker_networks_alias_custom:
        ```
    ...
    ??? variable list "`jdownloader2_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        jdownloader2_role_paths_folders_list_custom:
        ```

    ??? variable string "`jdownloader2_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        jdownloader2_role_paths_group:
        ```

    ??? variable string "`jdownloader2_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        jdownloader2_role_paths_owner:
        ```

    ??? variable string "`jdownloader2_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        jdownloader2_role_paths_permissions:
        ```

    ??? variable bool "`jdownloader2_role_paths_recursive`"

        ```yaml
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        jdownloader2_role_paths_recursive:
        ```

    ??? variable list "`jdownloader2_role_themepark_addons`"
    ...
    ??? variable string "`jdownloader2_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        jdownloader2_role_web_api_http_port:
        ```

    ??? variable string "`jdownloader2_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        jdownloader2_role_web_api_http_scheme:
        ```

    ??? variable dict "`jdownloader2_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        jdownloader2_role_web_api_http_serverstransport:
        ```

    ??? variable string "`jdownloader2_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        jdownloader2_role_web_api_port:
        ```

    ??? variable string "`jdownloader2_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        jdownloader2_role_web_api_scheme:
        ```

    ??? variable dict "`jdownloader2_role_web_api_serverstransport`"

        ```yaml
        # Type: dict/omit
        jdownloader2_role_web_api_serverstransport:
        ```
