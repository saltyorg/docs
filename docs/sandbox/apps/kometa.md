...
=== "Docker+"
    ...
    ??? variable bool "`kometa_role_docker_gpu_enabled`{ .sb-show-on-unchecked }`kometa2_docker_gpu_enabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        kometa_role_docker_gpu_enabled: false
        ```
        ...
        # This setting does not install or enable GPU support on the server.
        # Type: bool (true/false)
        kometa2_docker_gpu_enabled: false
        ```

    ??? variable bool "`kometa_role_docker_nvidia_disabled`{ .sb-show-on-unchecked }`kometa2_docker_nvidia_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        kometa_role_docker_nvidia_disabled: false
        ```
        ...
        # Automatic /dev/dri access may remain.
        # Type: bool (true/false)
        kometa2_docker_nvidia_disabled: false
        ```

    ??? variable bool "`kometa_role_docker_dev_dri_disabled`{ .sb-show-on-unchecked }`kometa2_docker_dev_dri_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        kometa_role_docker_dev_dri_disabled: false
        ```
        ...
        # NVIDIA-specific access may remain.
        # Type: bool (true/false)
        kometa2_docker_dev_dri_disabled: false
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`kometa_role_paths_folders_list_custom`{ .sb-show-on-unchecked }`kometa2_paths_folders_list_custom`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Extra directories to create
        # Type: list
        kometa_role_paths_folders_list_custom:
        ```

        ```yaml { .sb-show-on-checked }
        # Extra directories to create
        # Type: list
        kometa2_paths_folders_list_custom:
        ```

    ??? variable string "`kometa_role_paths_group`{ .sb-show-on-unchecked }`kometa2_paths_group`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Group for directories created by the role
        # Type: string
        kometa_role_paths_group:
        ```
    ...
    ??? variable string "`kometa_role_paths_owner`{ .sb-show-on-unchecked }`kometa2_paths_owner`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Owner for directories created by the role
        # Type: string
        kometa_role_paths_owner:
        ```
    ...
    ??? variable string "`kometa_role_paths_permissions`{ .sb-show-on-unchecked }`kometa2_paths_permissions`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Permissions for directories created by the role
        # Type: string
        kometa_role_paths_permissions:
        ```

        ```yaml { .sb-show-on-checked }
        # Permissions for directories created by the role
        # Type: string
        kometa2_paths_permissions:
        ```
    ...
    ??? variable bool "`kometa_role_paths_recursive`{ .sb-show-on-unchecked }`kometa2_paths_recursive`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        kometa_role_paths_recursive:
        ```

        ```yaml { .sb-show-on-checked }
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        kometa2_paths_recursive:
        ```
