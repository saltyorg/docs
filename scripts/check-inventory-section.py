...
def generate_issue_body(saltbox_missing: List[str], sandbox_missing: List[str], total_missing: int,
    ...
    body += "<!-- This section is managed by saltbox/test.py - DO NOT EDIT MANUALLY -->\n"
    body += "!!! info\n"
    body += "    Variables can be overridden in `/srv/git/saltbox/inventories/host_vars/localhost.yml`.\n"
    body += "\n"
    body += "    === \"Example\"\n"
    body += "\n"
    body += "        ```yaml\n"
    body += "        appname_name: \"custom_value\"\n"
    body += "        ```\n"
