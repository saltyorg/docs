...
=== "Docker+"
    ...
    ??? variable string "`trackarr_role_docker_stop_signal`"

        ```yaml
        # Type: string
        trackarr_role_docker_stop_signal:
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`trackarr_role_docker_networks_alias_custom`"

        ```yaml
        # Type: list
        trackarr_role_docker_networks_alias_custom:
        ```
