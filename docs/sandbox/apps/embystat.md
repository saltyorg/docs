...
=== "Global Override Options"
    ...
    ??? variable dict/omit "`embystat_role_traefik_api_endpoint`"
    ...
    ??? variable dict/omit "`embystat_role_web_http_serverstransport`"
    ...
    ??? variable dict/omit "`embystat_role_web_serverstransport`"
