...
Visit <https://spotify.iYOUR_DOMAIN_NAMEi>.
...
=== "Web"
    ...
    ??? variable string "`your_spotify_role_web_url`"
        ...
        ```yaml
        # Type: string
        your_spotify_role_web_url: "{{ lookup('role_web', role='your_spotify', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`your_spotify_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        your_spotify_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`your_spotify_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        your_spotify_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`your_spotify_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        your_spotify_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`your_spotify_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        your_spotify_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`your_spotify_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        your_spotify_role_docker_dev_dri_disabled: false
        ```

    <h5>Resource Limits</h5>

    ??? variable int "`your_spotify_role_docker_blkio_weight`"

        ```yaml
        # Type: int
        your_spotify_role_docker_blkio_weight:
        ```

    ??? variable int "`your_spotify_role_docker_cpu_period`"

        ```yaml
        # Type: int
        your_spotify_role_docker_cpu_period:
        ```

    ??? variable int "`your_spotify_role_docker_cpu_quota`"

        ```yaml
        # Type: int
        your_spotify_role_docker_cpu_quota:
        ```

    ??? variable int "`your_spotify_role_docker_cpu_shares`"

        ```yaml
        # Type: int
        your_spotify_role_docker_cpu_shares:
        ```
    ...
    ??? variable string "`your_spotify_role_docker_cpuset_cpus`"

        ```yaml
        # Type: string
        your_spotify_role_docker_cpuset_cpus:
        ```

    ??? variable string "`your_spotify_role_docker_cpuset_mems`"

        ```yaml
        # Type: string
        your_spotify_role_docker_cpuset_mems:
        ```

    ??? variable string "`your_spotify_role_docker_kernel_memory`"

        ```yaml
        # Type: string
        your_spotify_role_docker_kernel_memory:
        ```

    ??? variable string "`your_spotify_role_docker_memory`"

        ```yaml
        # Type: string
        your_spotify_role_docker_memory:
        ```

    ??? variable string "`your_spotify_role_docker_memory_reservation`"

        ```yaml
        # Type: string
        your_spotify_role_docker_memory_reservation:
        ```

    ??? variable string "`your_spotify_role_docker_memory_swap`"

        ```yaml
        # Type: string
        your_spotify_role_docker_memory_swap:
        ```

    ??? variable int "`your_spotify_role_docker_memory_swappiness`"

        ```yaml
        # Type: int
        your_spotify_role_docker_memory_swappiness:
        ```

    ??? variable string "`your_spotify_role_docker_shm_size`"

        ```yaml
        # Type: string
        your_spotify_role_docker_shm_size:
        ```

    <h5>Security & Devices</h5>

    ??? variable list "`your_spotify_role_docker_cap_drop`"

        ```yaml
        # Type: list
        your_spotify_role_docker_cap_drop:
        ```

    ??? variable string "`your_spotify_role_docker_cgroupns_mode`"

        ```yaml
        # Type: string
        your_spotify_role_docker_cgroupns_mode:
        ```

    ??? variable list "`your_spotify_role_docker_device_cgroup_rules`"

        ```yaml
        # Type: list
        your_spotify_role_docker_device_cgroup_rules:
        ```

    ??? variable list "`your_spotify_role_docker_device_read_bps`"

        ```yaml
        # Type: list
        your_spotify_role_docker_device_read_bps:
        ```

    ??? variable list "`your_spotify_role_docker_device_read_iops`"

        ```yaml
        # Type: list
        your_spotify_role_docker_device_read_iops:
        ```

    ??? variable list "`your_spotify_role_docker_device_requests`"

        ```yaml
        # Type: list
        your_spotify_role_docker_device_requests:
        ```

    ??? variable list "`your_spotify_role_docker_device_write_bps`"

        ```yaml
        # Type: list
        your_spotify_role_docker_device_write_bps:
        ```

    ??? variable list "`your_spotify_role_docker_device_write_iops`"

        ```yaml
        # Type: list
        your_spotify_role_docker_device_write_iops:
        ```

    ??? variable list "`your_spotify_role_docker_devices`"

        ```yaml
        # Type: list
        your_spotify_role_docker_devices:
        ```

    ??? variable list "`your_spotify_role_docker_groups`"

        ```yaml
        # Type: list
        your_spotify_role_docker_groups:
        ```

    ??? variable bool "`your_spotify_role_docker_privileged`"

        ```yaml
        # Type: bool (true/false)
        your_spotify_role_docker_privileged:
        ```

    ??? variable list "`your_spotify_role_docker_security_opts`"

        ```yaml
        # Type: list
        your_spotify_role_docker_security_opts:
        ```

    ??? variable string "`your_spotify_role_docker_user`"

        ```yaml
        # Type: string
        your_spotify_role_docker_user:
        ```

    ??? variable string "`your_spotify_role_docker_userns_mode`"

        ```yaml
        # Type: string
        your_spotify_role_docker_userns_mode:
        ```

    <h5>Networking</h5>

    ??? variable list "`your_spotify_role_docker_dns_opts`"

        ```yaml
        # Type: list
        your_spotify_role_docker_dns_opts:
        ```

    ??? variable list "`your_spotify_role_docker_dns_search_domains`"

        ```yaml
        # Type: list
        your_spotify_role_docker_dns_search_domains:
        ```

    ??? variable list "`your_spotify_role_docker_dns_servers`"

        ```yaml
        # Type: list
        your_spotify_role_docker_dns_servers:
        ```

    ??? variable string "`your_spotify_role_docker_domainname`"

        ```yaml
        # Type: string
        your_spotify_role_docker_domainname:
        ```

    ??? variable list "`your_spotify_role_docker_exposed_ports`"

        ```yaml
        # Type: list
        your_spotify_role_docker_exposed_ports:
        ```

    ??? variable dict "`your_spotify_role_docker_hosts`"

        ```yaml
        # Type: dict
        your_spotify_role_docker_hosts:
        ```

    ??? variable bool "`your_spotify_role_docker_hosts_use_common`"

        ```yaml
        # Type: bool (true/false)
        your_spotify_role_docker_hosts_use_common:
        ```

    ??? variable string "`your_spotify_role_docker_ipc_mode`"

        ```yaml
        # Type: string
        your_spotify_role_docker_ipc_mode:
        ```

    ??? variable list "`your_spotify_role_docker_links`"

        ```yaml
        # Type: list
        your_spotify_role_docker_links:
        ```

    ??? variable string "`your_spotify_role_docker_network_mode`"

        ```yaml
        # Type: string
        your_spotify_role_docker_network_mode:
        ```

    ??? variable string "`your_spotify_role_docker_pid_mode`"

        ```yaml
        # Type: string
        your_spotify_role_docker_pid_mode:
        ```

    ??? variable list "`your_spotify_role_docker_ports`"

        ```yaml
        # Type: list
        your_spotify_role_docker_ports:
        ```

    ??? variable string "`your_spotify_role_docker_uts`"

        ```yaml
        # Type: string
        your_spotify_role_docker_uts:
        ```

    <h5>Storage</h5>

    ??? variable bool "`your_spotify_role_docker_keep_volumes`"

        ```yaml
        # Type: bool (true/false)
        your_spotify_role_docker_keep_volumes:
        ```

    ??? variable list "`your_spotify_role_docker_mounts`"

        ```yaml
        # Type: list
        your_spotify_role_docker_mounts:
        ```

    ??? variable dict "`your_spotify_role_docker_storage_opts`"

        ```yaml
        # Type: dict
        your_spotify_role_docker_storage_opts:
        ```

    ??? variable list "`your_spotify_role_docker_tmpfs`"

        ```yaml
        # Type: list
        your_spotify_role_docker_tmpfs:
        ```

    ??? variable string "`your_spotify_role_docker_volume_driver`"

        ```yaml
        # Type: string
        your_spotify_role_docker_volume_driver:
        ```

    ??? variable list "`your_spotify_role_docker_volumes`"

        ```yaml
        # Type: list
        your_spotify_role_docker_volumes:
        ```

    ??? variable list "`your_spotify_role_docker_volumes_from`"

        ```yaml
        # Type: list
        your_spotify_role_docker_volumes_from:
        ```

    ??? variable bool "`your_spotify_role_docker_volumes_global`"

        ```yaml
        # Type: bool (true/false)
        your_spotify_role_docker_volumes_global:
        ```

    ??? variable string "`your_spotify_role_docker_working_dir`"

        ```yaml
        # Type: string
        your_spotify_role_docker_working_dir:
        ```

    <h5>Monitoring & Lifecycle</h5>

    ??? variable bool "`your_spotify_role_docker_auto_remove`"

        ```yaml
        # Type: bool (true/false)
        your_spotify_role_docker_auto_remove:
        ```

    ??? variable bool "`your_spotify_role_docker_cleanup`"
    ...
    ??? variable dict "`your_spotify_role_docker_healthcheck`"

        ```yaml
        # Type: dict
        your_spotify_role_docker_healthcheck:
        ```
    ...
    ??? variable bool "`your_spotify_role_docker_init`"

        ```yaml
        # Type: bool (true/false)
        your_spotify_role_docker_init:
        ```

    ??? variable string "`your_spotify_role_docker_kill_signal`"

        ```yaml
        # Type: string
        your_spotify_role_docker_kill_signal:
        ```

    ??? variable string "`your_spotify_role_docker_log_driver`"

        ```yaml
        # Type: string
        your_spotify_role_docker_log_driver:
        ```

    ??? variable dict "`your_spotify_role_docker_log_options`"

        ```yaml
        # Type: dict
        your_spotify_role_docker_log_options:
        ```

    ??? variable bool "`your_spotify_role_docker_oom_killer`"

        ```yaml
        # Type: bool (true/false)
        your_spotify_role_docker_oom_killer:
        ```

    ??? variable int "`your_spotify_role_docker_oom_score_adj`"

        ```yaml
        # Type: int
        your_spotify_role_docker_oom_score_adj:
        ```

    ??? variable bool "`your_spotify_role_docker_output_logs`"

        ```yaml
        # Type: bool (true/false)
        your_spotify_role_docker_output_logs:
        ```

    ??? variable bool "`your_spotify_role_docker_paused`"

        ```yaml
        # Type: bool (true/false)
        your_spotify_role_docker_paused:
        ```

    ??? variable bool "`your_spotify_role_docker_recreate`"

        ```yaml
        # Type: bool (true/false)
        your_spotify_role_docker_recreate:
        ```

    ??? variable int "`your_spotify_role_docker_restart_retries`"
    ...
    ??? variable int "`your_spotify_role_docker_stop_timeout`"
        ...
        ```yaml
        # Type: int
        your_spotify_role_docker_stop_timeout:
        ```

    <h5>Other Options</h5>

    ??? variable list "`your_spotify_role_docker_capabilities`"

        ```yaml
        # Type: list
        your_spotify_role_docker_capabilities:
        ```

    ??? variable string "`your_spotify_role_docker_cgroup_parent`"

        ```yaml
        # Type: string
        your_spotify_role_docker_cgroup_parent:
        ```

    ??? variable list "`your_spotify_role_docker_commands`"

        ```yaml
        # Type: list
        your_spotify_role_docker_commands:
        ```

    ??? variable int "`your_spotify_role_docker_create_timeout`"
    ...
    ??? variable string "`your_spotify_role_docker_env_file`"

        ```yaml
        # Type: string
        your_spotify_role_docker_env_file:
        ```

    ??? variable dict "`your_spotify_role_docker_labels`"

        ```yaml
        # Type: dict
        your_spotify_role_docker_labels:
        ```

    ??? variable bool "`your_spotify_role_docker_labels_use_common`"
    ...
    ??? variable bool "`your_spotify_role_docker_read_only`"
        ...
        ```yaml
        # Type: bool (true/false)
        your_spotify_role_docker_read_only:
        ```

    ??? variable string "`your_spotify_role_docker_runtime`"
    ...
    ??? variable list "`your_spotify_role_docker_ulimits`"

        ```yaml
        # Type: list
        your_spotify_role_docker_ulimits:
        ```
...
=== "Global Override Options"
    ...
    ??? variable string "`your_spotify_role_themepark_app`"

        ```yaml
        # Type: string
        your_spotify_role_themepark_app:
        ```

    ??? variable string "`your_spotify_role_themepark_theme`"
    ...
    ??? variable string "`your_spotify_role_traefik_api_middleware_http`"

        ```yaml
        # Type: string
        your_spotify_role_traefik_api_middleware_http:
        ```
    ...
    ??? variable string "`your_spotify_role_traefik_middleware_http`"

        ```yaml
        # Type: string
        your_spotify_role_traefik_middleware_http:
        ```
    ...
    ??? variable string "`your_spotify_role_traefik_priority`"

        ```yaml
        # Type: string
        your_spotify_role_traefik_priority:
        ```
    ...
    ??? variable string "`your_spotify_role_web_http_port`"

        ```yaml
        # Type: string (quoted number)
        your_spotify_role_web_http_port:
        ```

    ??? variable string "`your_spotify_role_web_http_scheme`"
    ...
    ??? variable dict "`your_spotify_role_web_http_serverstransport`"
        ...
        ```yaml
        # Type: dict/omit
        your_spotify_role_web_http_serverstransport:
        ```
