...
=== "Web"
    ...
    ??? variable string "`it_tools_role_web_url`"
        ...
        ```yaml
        # Type: string
        it_tools_role_web_url: "{{ lookup('role_web', role='it_tools', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`it_tools_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        it_tools_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`it_tools_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        it_tools_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`it_tools_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        it_tools_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`it_tools_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        it_tools_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`it_tools_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        it_tools_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`it_tools_role_docker_force_kill`"
    ...
    ??? variable string "`it_tools_role_docker_stop_signal`"

        ```yaml
        # Type: string
        it_tools_role_docker_stop_signal:
        ```
    ...
    ??? variable list "`it_tools_role_docker_entrypoint`"
    ...
    ??? variable dict "`it_tools_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`it_tools_role_themepark_addons`"
    ...
    ??? variable string "`it_tools_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        it_tools_role_web_api_http_port:
        ```

    ??? variable string "`it_tools_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        it_tools_role_web_api_http_scheme:
        ```

    ??? variable dict "`it_tools_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        it_tools_role_web_api_http_serverstransport:
        ```

    ??? variable string "`it_tools_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        it_tools_role_web_api_port:
        ```

    ??? variable string "`it_tools_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        it_tools_role_web_api_scheme:
        ```

    ??? variable dict "`it_tools_role_web_api_serverstransport`"
    ...
    ??? variable dict "`it_tools_role_web_http_serverstransport`"
    ...
    ??? variable dict "`it_tools_role_web_serverstransport`"
