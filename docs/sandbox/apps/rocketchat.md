...
=== "Web"
    ...
    ??? variable string "`rocketchat_role_web_url`"
        ...
        ```yaml
        # Type: string
        rocketchat_role_web_url: "{{ lookup('role_web', role='rocketchat', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`rocketchat_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        rocketchat_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`rocketchat_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        rocketchat_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`rocketchat_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        rocketchat_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`rocketchat_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        rocketchat_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`rocketchat_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        rocketchat_role_docker_dev_dri_disabled: false
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`rocketchat_role_docker_networks_alias_custom`"

        ```yaml
        # Type: list
        rocketchat_role_docker_networks_alias_custom:
        ```
    ...
    ??? variable list "`rocketchat_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        rocketchat_role_paths_folders_list_custom:
        ```

    ??? variable string "`rocketchat_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        rocketchat_role_paths_group:
        ```

    ??? variable string "`rocketchat_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        rocketchat_role_paths_owner:
        ```

    ??? variable string "`rocketchat_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        rocketchat_role_paths_permissions:
        ```

    ??? variable bool "`rocketchat_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        rocketchat_role_paths_recursive:
        ```
