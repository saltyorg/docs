...
1.  **This role supports multiple instances via `tautulli_instances`.**
    ...
    !!! example "Example override"
        ...
        === "Role-scoped"
            ...
            :material-arrow-right-bottom-bold: Applies to all instances of tautulli
        ...
        === "Instance-scoped"
            ...
            :material-arrow-right-bottom-bold: Applies to the instance named tautulli2
...
=== "Web"
    ...
    ??? variable string "`tautulli_role_web_url`{ .sb-show-on-unchecked }`tautulli2_web_url`{ .sb-show-on-checked }"
        ...
        ```yaml { .sb-show-on-unchecked }
        # Type: string
        tautulli_role_web_url: "{{ lookup('role_web', role='tautulli', scheme='https') }}"
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        tautulli2_web_url: "{{ lookup('role_web', role='tautulli', scheme='https') }}"
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`tautulli_role_docker_gpu_enabled`{ .sb-show-on-unchecked }`tautulli2_docker_gpu_enabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        tautulli_role_docker_gpu_enabled: false
        ```
        ...
        # This setting does not install or enable GPU support on the server.
        # Type: bool (true/false)
        tautulli2_docker_gpu_enabled: false
        ```

    ??? variable bool "`tautulli_role_docker_nvidia_disabled`{ .sb-show-on-unchecked }`tautulli2_docker_nvidia_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        tautulli_role_docker_nvidia_disabled: false
        ```
        ...
        # Automatic /dev/dri access may remain.
        # Type: bool (true/false)
        tautulli2_docker_nvidia_disabled: false
        ```

    ??? variable bool "`tautulli_role_docker_dev_dri_disabled`{ .sb-show-on-unchecked }`tautulli2_docker_dev_dri_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        tautulli_role_docker_dev_dri_disabled: false
        ```
        ...
        # NVIDIA-specific access may remain.
        # Type: bool (true/false)
        tautulli2_docker_dev_dri_disabled: false
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`tautulli_role_paths_folders_list_custom`{ .sb-show-on-unchecked }`tautulli2_paths_folders_list_custom`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Extra directories to create
        # Type: list
        tautulli_role_paths_folders_list_custom:
        ```

        ```yaml { .sb-show-on-checked }
        # Extra directories to create
        # Type: list
        tautulli2_paths_folders_list_custom:
        ```

    ??? variable string "`tautulli_role_paths_group`{ .sb-show-on-unchecked }`tautulli2_paths_group`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Group for directories created by the role
        # Type: string
        tautulli_role_paths_group:
        ```

        ```yaml { .sb-show-on-checked }
        # Group for directories created by the role
        # Type: string
        tautulli2_paths_group:
        ```

    ??? variable string "`tautulli_role_paths_owner`{ .sb-show-on-unchecked }`tautulli2_paths_owner`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Owner for directories created by the role
        # Type: string
        tautulli_role_paths_owner:
        ```

        ```yaml { .sb-show-on-checked }
        # Owner for directories created by the role
        # Type: string
        tautulli2_paths_owner:
        ```

    ??? variable string "`tautulli_role_paths_permissions`{ .sb-show-on-unchecked }`tautulli2_paths_permissions`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Permissions for directories created by the role
        # Type: string
        tautulli_role_paths_permissions:
        ```

        ```yaml { .sb-show-on-checked }
        # Permissions for directories created by the role
        # Type: string
        tautulli2_paths_permissions:
        ```

    ??? variable bool "`tautulli_role_paths_recursive`{ .sb-show-on-unchecked }`tautulli2_paths_recursive`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        tautulli_role_paths_recursive:
        ```

        ```yaml { .sb-show-on-checked }
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        tautulli2_paths_recursive:
        ```
    ...
    ??? variable string "`tautulli_role_web_api_http_port`{ .sb-show-on-unchecked }`tautulli2_web_api_http_port`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string (quoted number)
        tautulli_role_web_api_http_port:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string (quoted number)
        tautulli2_web_api_http_port:
        ```

    ??? variable string "`tautulli_role_web_api_http_scheme`{ .sb-show-on-unchecked }`tautulli2_web_api_http_scheme`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string ("http"/"https")
        tautulli_role_web_api_http_scheme:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string ("http"/"https")
        tautulli2_web_api_http_scheme:
        ```

    ??? variable dict "`tautulli_role_web_api_http_serverstransport`{ .sb-show-on-unchecked }`tautulli2_web_api_http_serverstransport`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: dict/omit
        tautulli_role_web_api_http_serverstransport:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: dict/omit
        tautulli2_web_api_http_serverstransport:
        ```

    ??? variable string "`tautulli_role_web_api_port`{ .sb-show-on-unchecked }`tautulli2_web_api_port`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string (quoted number)
        tautulli_role_web_api_port:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string (quoted number)
        tautulli2_web_api_port:
        ```

    ??? variable string "`tautulli_role_web_api_scheme`{ .sb-show-on-unchecked }`tautulli2_web_api_scheme`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string ("http"/"https")
        tautulli_role_web_api_scheme:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string ("http"/"https")
        tautulli2_web_api_scheme:
        ```

    ??? variable dict "`tautulli_role_web_api_serverstransport`{ .sb-show-on-unchecked }`tautulli2_web_api_serverstransport`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: dict/omit
        tautulli_role_web_api_serverstransport:
        ```
