...
=== "Web"
    ...
    ??? variable string "`sshwifty_role_web_url`"
        ...
        ```yaml
        # Type: string
        sshwifty_role_web_url: "{{ lookup('role_web', role='sshwifty', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`sshwifty_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        sshwifty_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`sshwifty_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        sshwifty_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`sshwifty_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        sshwifty_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`sshwifty_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        sshwifty_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`sshwifty_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        sshwifty_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`sshwifty_role_docker_force_kill`"
    ...
    ??? variable string "`sshwifty_role_docker_stop_signal`"

        ```yaml
        # Type: string
        sshwifty_role_docker_stop_signal:
        ```
    ...
    ??? variable list "`sshwifty_role_docker_entrypoint`"
    ...
    ??? variable dict "`sshwifty_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`sshwifty_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        sshwifty_role_paths_folders_list_custom:
        ```

    ??? variable string "`sshwifty_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        sshwifty_role_paths_group:
        ```

    ??? variable string "`sshwifty_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        sshwifty_role_paths_owner:
        ```

    ??? variable string "`sshwifty_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        sshwifty_role_paths_permissions:
        ```

    ??? variable bool "`sshwifty_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        sshwifty_role_paths_recursive:
        ```

    ??? variable list "`sshwifty_role_themepark_addons`"
