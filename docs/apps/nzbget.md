...
=== "Docker+"
    ...
    ??? variable bool "`nzbget_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        nzbget_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`nzbget_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        nzbget_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`nzbget_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        nzbget_role_docker_dev_dri_disabled: false
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`nzbget_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        nzbget_role_paths_folders_list_custom:
        ```

    ??? variable string "`nzbget_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        nzbget_role_paths_group:
        ```

    ??? variable string "`nzbget_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        nzbget_role_paths_owner:
        ```

    ??? variable string "`nzbget_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        nzbget_role_paths_permissions:
        ```

    ??? variable bool "`nzbget_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        nzbget_role_paths_recursive:
        ```
