...
=== "Web"
    ...
    ??? variable string "`transmission_role_web_url`{ .sb-show-on-unchecked }`transmission2_web_url`{ .sb-show-on-checked }"
        ...
        ```yaml { .sb-show-on-unchecked }
        # Type: string
        transmission_role_web_url: "{{ lookup('role_web', role='transmission', scheme='https') }}"
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        transmission2_web_url: "{{ lookup('role_web', role='transmission', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`transmission_role_traefik_middleware_default_api`{ .sb-show-on-unchecked }`transmission2_traefik_middleware_default_api`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string
        transmission_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        transmission2_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`transmission_role_traefik_middleware_custom_api`{ .sb-show-on-unchecked }`transmission2_traefik_middleware_custom_api`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string
        transmission_role_traefik_middleware_custom_api: ""
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        transmission2_traefik_middleware_custom_api: ""
        ```
...
=== "Docker"
    ...
    ??? variable list "`transmission_role_docker_volumes_default`{ .sb-show-on-unchecked }`transmission2_docker_volumes_default`{ .sb-show-on-checked }"
        ...
        transmission_role_docker_volumes_default:
          - "{{ lookup('role_var', '_paths_location', role='transmission') }}:/config"
          - "{{ server_appdata_path }}/scripts:/scripts"
          - "{{ lookup('role_var', '_paths_downloads_location', role='transmission') }}/watched:/watch"
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`transmission_role_docker_gpu_enabled`{ .sb-show-on-unchecked }`transmission2_docker_gpu_enabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        transmission_role_docker_gpu_enabled: false
        ```
        ...
        # This setting does not install or enable GPU support on the server.
        # Type: bool (true/false)
        transmission2_docker_gpu_enabled: false
        ```

    ??? variable bool "`transmission_role_docker_nvidia_disabled`{ .sb-show-on-unchecked }`transmission2_docker_nvidia_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        transmission_role_docker_nvidia_disabled: false
        ```
        ...
        # Automatic /dev/dri access may remain.
        # Type: bool (true/false)
        transmission2_docker_nvidia_disabled: false
        ```

    ??? variable bool "`transmission_role_docker_dev_dri_disabled`{ .sb-show-on-unchecked }`transmission2_docker_dev_dri_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        transmission_role_docker_dev_dri_disabled: false
        ```
        ...
        # NVIDIA-specific access may remain.
        # Type: bool (true/false)
        transmission2_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`transmission_role_docker_force_kill`{ .sb-show-on-unchecked }`transmission2_docker_force_kill`{ .sb-show-on-checked }"
    ...
    ??? variable list "`transmission_role_docker_entrypoint`{ .sb-show-on-unchecked }`transmission2_docker_entrypoint`{ .sb-show-on-checked }"
    ...
    ??? variable dict "`transmission_role_docker_sysctls`{ .sb-show-on-unchecked }`transmission2_docker_sysctls`{ .sb-show-on-checked }"
...
=== "Global Override Options"
    ...
    ??? variable list "`transmission_role_docker_networks_alias_custom`{ .sb-show-on-unchecked }`transmission2_docker_networks_alias_custom`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: list
        transmission_role_docker_networks_alias_custom:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: list
        transmission2_docker_networks_alias_custom:
        ```
