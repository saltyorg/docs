...
=== "Settings"
    ...
    ??? variable list "`lidarr_role_allowed_hosts_public_custom`{ .sb-show-on-unchecked }`lidarr2_allowed_hosts_public_custom`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Adds public hosts accepted by Lidarr. This is required when using a raw
        ...
        # Type: list
        lidarr_role_allowed_hosts_public_custom: []
        ```
        ...
        # with "*.". Do not include schemes, paths, or ports.
        # Type: list
        lidarr2_allowed_hosts_public_custom: []
        ```

    ??? variable list "`lidarr_role_allowed_hosts_custom`{ .sb-show-on-unchecked }`lidarr2_allowed_hosts_custom`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Adds extra hosts accepted by Lidarr, such as additional Docker or host-DNS
        ...
        # Type: list
        lidarr_role_allowed_hosts_custom: []
        ```
        ...
        # beginning with "*.". Do not include schemes, paths, or ports.
        # Type: list
        lidarr2_allowed_hosts_custom: []
        ```

    ??? variable list "`lidarr_role_trusted_networks_custom`{ .sb-show-on-unchecked }`lidarr2_trusted_networks_custom`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Adds reverse-proxy peers that Lidarr trusts to supply forwarded headers.
        # Valid values are IPv4 or IPv6 addresses and CIDRs. Do not use hostnames or
        # client networks.
        # Type: list
        lidarr_role_trusted_networks_custom: []
        ```
        ...
        # client networks.
        # Type: list
        lidarr2_trusted_networks_custom: []
        ```
...
=== "Web"
    ...
    ??? variable string "`lidarr_role_web_url`{ .sb-show-on-unchecked }`lidarr2_web_url`{ .sb-show-on-checked }"
        ...
        ```yaml { .sb-show-on-unchecked }
        # Type: string
        lidarr_role_web_url: "{{ lookup('role_web', role='lidarr', scheme='https') }}"
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        lidarr2_web_url: "{{ lookup('role_web', role='lidarr', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`lidarr_role_traefik_middleware_default_api`{ .sb-show-on-unchecked }`lidarr2_traefik_middleware_default_api`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string
        lidarr_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        lidarr2_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`lidarr_role_traefik_middleware_custom_api`{ .sb-show-on-unchecked }`lidarr2_traefik_middleware_custom_api`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string
        lidarr_role_traefik_middleware_custom_api: ""
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        lidarr2_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`lidarr_role_docker_gpu_enabled`{ .sb-show-on-unchecked }`lidarr2_docker_gpu_enabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        lidarr_role_docker_gpu_enabled: false
        ```
        ...
        # This setting does not install or enable GPU support on the server.
        # Type: bool (true/false)
        lidarr2_docker_gpu_enabled: false
        ```

    ??? variable bool "`lidarr_role_docker_nvidia_disabled`{ .sb-show-on-unchecked }`lidarr2_docker_nvidia_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        lidarr_role_docker_nvidia_disabled: false
        ```
        ...
        # Automatic /dev/dri access may remain.
        # Type: bool (true/false)
        lidarr2_docker_nvidia_disabled: false
        ```

    ??? variable bool "`lidarr_role_docker_dev_dri_disabled`{ .sb-show-on-unchecked }`lidarr2_docker_dev_dri_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        lidarr_role_docker_dev_dri_disabled: false
        ```
        ...
        # NVIDIA-specific access may remain.
        # Type: bool (true/false)
        lidarr2_docker_dev_dri_disabled: false
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`lidarr_role_paths_folders_list_custom`{ .sb-show-on-unchecked }`lidarr2_paths_folders_list_custom`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Extra directories to create
        # Type: list
        lidarr_role_paths_folders_list_custom:
        ```

        ```yaml { .sb-show-on-checked }
        # Extra directories to create
        # Type: list
        lidarr2_paths_folders_list_custom:
        ```

    ??? variable string "`lidarr_role_paths_group`{ .sb-show-on-unchecked }`lidarr2_paths_group`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Group for directories created by the role
        # Type: string
        lidarr_role_paths_group:
        ```
    ...
    ??? variable string "`lidarr_role_paths_owner`{ .sb-show-on-unchecked }`lidarr2_paths_owner`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Owner for directories created by the role
        # Type: string
        lidarr_role_paths_owner:
        ```
    ...
    ??? variable string "`lidarr_role_paths_permissions`{ .sb-show-on-unchecked }`lidarr2_paths_permissions`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Permissions for directories created by the role
        # Type: string
        lidarr_role_paths_permissions:
        ```

        ```yaml { .sb-show-on-checked }
        # Permissions for directories created by the role
        # Type: string
        lidarr2_paths_permissions:
        ```

    ??? variable bool "`lidarr_role_paths_recursive`{ .sb-show-on-unchecked }`lidarr2_paths_recursive`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        lidarr_role_paths_recursive:
        ```

        ```yaml { .sb-show-on-checked }
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        lidarr2_paths_recursive:
        ```
