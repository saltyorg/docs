...
1.  **This role supports multiple instances via `telegraf_instances`.**
    ...
    !!! example sb-show-on-checked "Example override"
        ...
        Applies to the instance named `telegraf2`.
...
=== "Docker+"
    ...
    ??? variable string "`telegraf_role_docker_devices_default`{ .sb-show-on-unchecked }`telegraf2_docker_devices_default`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string
        telegraf_role_docker_devices_default:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        telegraf2_docker_devices_default:
        ```
