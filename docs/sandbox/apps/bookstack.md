...
=== "Web"
    ...
    ??? variable string "`bookstack_role_web_url`"
        ...
        ```yaml
        # Type: string
        bookstack_role_web_url: "{{ lookup('role_web', role='bookstack', scheme='https') }}"
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`bookstack_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        bookstack_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`bookstack_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        bookstack_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`bookstack_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        bookstack_role_docker_dev_dri_disabled: false
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`bookstack_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        bookstack_role_paths_folders_list_custom:
        ```

    ??? variable string "`bookstack_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        bookstack_role_paths_group:
        ```

    ??? variable string "`bookstack_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        bookstack_role_paths_owner:
        ```

    ??? variable string "`bookstack_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        bookstack_role_paths_permissions:
        ```

    ??? variable bool "`bookstack_role_paths_recursive`"

        ```yaml
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        bookstack_role_paths_recursive:
        ```
    ...
    ??? variable string "`bookstack_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        bookstack_role_web_api_http_port:
        ```

    ??? variable string "`bookstack_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        bookstack_role_web_api_http_scheme:
        ```

    ??? variable dict "`bookstack_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        bookstack_role_web_api_http_serverstransport:
        ```

    ??? variable string "`bookstack_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        bookstack_role_web_api_port:
        ```

    ??? variable string "`bookstack_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        bookstack_role_web_api_scheme:
        ```

    ??? variable dict "`bookstack_role_web_api_serverstransport`"
