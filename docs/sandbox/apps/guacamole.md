...
=== "Docker+"
    ...
    ??? variable string "`guacamole_role_docker_stop_signal`"

        ```yaml
        # Type: string
        guacamole_role_docker_stop_signal:
        ```
...
=== "Global Override Options"
    ...
    ??? variable string "`guacamole_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        guacamole_role_web_api_http_port:
        ```

    ??? variable string "`guacamole_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        guacamole_role_web_api_http_scheme:
        ```

    ??? variable dict "`guacamole_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        guacamole_role_web_api_http_serverstransport:
        ```

    ??? variable string "`guacamole_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        guacamole_role_web_api_port:
        ```

    ??? variable string "`guacamole_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        guacamole_role_web_api_scheme:
        ```

    ??? variable dict "`guacamole_role_web_api_serverstransport`"
