...
=== "Web"
    ...
    ??? variable string "`scrutiny_role_web_url`"
        ...
        ```yaml
        # Type: string
        scrutiny_role_web_url: "{{ lookup('role_web', role='scrutiny', scheme='https') }}"
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`scrutiny_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        scrutiny_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`scrutiny_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        scrutiny_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`scrutiny_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        scrutiny_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`scrutiny_role_docker_force_kill`"
    ...
    ??? variable list "`scrutiny_role_docker_entrypoint`"
    ...
    ??? variable dict "`scrutiny_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`scrutiny_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        scrutiny_role_paths_folders_list_custom:
        ```

    ??? variable string "`scrutiny_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        scrutiny_role_paths_group:
        ```

    ??? variable string "`scrutiny_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        scrutiny_role_paths_owner:
        ```

    ??? variable string "`scrutiny_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        scrutiny_role_paths_permissions:
        ```

    ??? variable bool "`scrutiny_role_paths_recursive`"

        ```yaml
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        scrutiny_role_paths_recursive:
        ```

    ??? variable list "`scrutiny_role_themepark_addons`"
    ...
    ??? variable string "`scrutiny_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        scrutiny_role_web_api_http_port:
        ```

    ??? variable string "`scrutiny_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        scrutiny_role_web_api_http_scheme:
        ```

    ??? variable dict "`scrutiny_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        scrutiny_role_web_api_http_serverstransport:
        ```

    ??? variable string "`scrutiny_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        scrutiny_role_web_api_port:
        ```

    ??? variable string "`scrutiny_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        scrutiny_role_web_api_scheme:
        ```

    ??? variable dict "`scrutiny_role_web_api_serverstransport`"
