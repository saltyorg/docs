...
=== "Web"
    ...
    ??? variable string "`unmanic_role_web_url`"
        ...
        ```yaml
        # Type: string
        unmanic_role_web_url: "{{ lookup('role_web', role='unmanic', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`unmanic_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        unmanic_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`unmanic_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        unmanic_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker"
    ...
    ??? variable bool "`unmanic_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        unmanic_role_docker_gpu_enabled: true
        ```

    ??? variable bool "`unmanic_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        unmanic_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`unmanic_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        unmanic_role_docker_dev_dri_disabled: false
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`unmanic_role_docker_force_kill`"
    ...
    ??? variable string "`unmanic_role_docker_stop_signal`"

        ```yaml
        # Type: string
        unmanic_role_docker_stop_signal:
        ```
    ...
    ??? variable list "`unmanic_role_docker_entrypoint`"
    ...
    ??? variable dict "`unmanic_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`unmanic_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        unmanic_role_paths_folders_list_custom:
        ```

    ??? variable string "`unmanic_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        unmanic_role_paths_group:
        ```

    ??? variable string "`unmanic_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        unmanic_role_paths_owner:
        ```

    ??? variable string "`unmanic_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        unmanic_role_paths_permissions:
        ```

    ??? variable bool "`unmanic_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        unmanic_role_paths_recursive:
        ```

    ??? variable list "`unmanic_role_themepark_addons`"
    ...
    ??? variable string "`unmanic_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        unmanic_role_web_api_http_port:
        ```

    ??? variable string "`unmanic_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        unmanic_role_web_api_http_scheme:
        ```

    ??? variable dict "`unmanic_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        unmanic_role_web_api_http_serverstransport:
        ```

    ??? variable string "`unmanic_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        unmanic_role_web_api_port:
        ```

    ??? variable string "`unmanic_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        unmanic_role_web_api_scheme:
        ```

    ??? variable dict "`unmanic_role_web_api_serverstransport`"
