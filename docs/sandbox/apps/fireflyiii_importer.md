...
=== "Web"
    ...
    ??? variable string "`fireflyiii_importer_role_web_url`"
        ...
        ```yaml
        # Type: string
        fireflyiii_importer_role_web_url: "{{ lookup('role_web', role='fireflyiii_importer', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`fireflyiii_importer_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        fireflyiii_importer_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`fireflyiii_importer_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        fireflyiii_importer_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`fireflyiii_importer_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        fireflyiii_importer_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`fireflyiii_importer_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        fireflyiii_importer_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`fireflyiii_importer_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        fireflyiii_importer_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`fireflyiii_importer_role_docker_force_kill`"
    ...
    ??? variable list "`fireflyiii_importer_role_docker_entrypoint`"
    ...
    ??? variable dict "`fireflyiii_importer_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`fireflyiii_importer_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        fireflyiii_importer_role_paths_folders_list_custom:
        ```

    ??? variable string "`fireflyiii_importer_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        fireflyiii_importer_role_paths_group:
        ```

    ??? variable string "`fireflyiii_importer_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        fireflyiii_importer_role_paths_owner:
        ```

    ??? variable string "`fireflyiii_importer_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        fireflyiii_importer_role_paths_permissions:
        ```
    ...
    ??? variable list "`fireflyiii_importer_role_themepark_addons`"
