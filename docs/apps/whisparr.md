...
=== "Settings"
    ...
    ??? variable list "`whisparr_role_allowed_hosts_public_custom`{ .sb-show-on-unchecked }`whisparr2_allowed_hosts_public_custom`{ .sb-show-on-checked }"
        ...
        # with "*.". Do not include schemes, paths, or ports.
        # Type: list
        whisparr2_allowed_hosts_public_custom: []
        ```

    ??? variable list "`whisparr_role_allowed_hosts_custom`{ .sb-show-on-unchecked }`whisparr2_allowed_hosts_custom`{ .sb-show-on-checked }"
        ...
        # beginning with "*.". Do not include schemes, paths, or ports.
        # Type: list
        whisparr2_allowed_hosts_custom: []
        ```

    ??? variable list "`whisparr_role_trusted_networks_custom`{ .sb-show-on-unchecked }`whisparr2_trusted_networks_custom`{ .sb-show-on-checked }"
        ...
        # client networks.
        # Type: list
        whisparr2_trusted_networks_custom: []
        ```
...
=== "Web"
    ...
    ??? variable string "`whisparr_role_web_url`{ .sb-show-on-unchecked }`whisparr2_web_url`{ .sb-show-on-checked }"
        ...
        ```yaml { .sb-show-on-checked }
        # Type: string
        whisparr2_web_url: "{{ lookup('role_web', role='whisparr', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`whisparr_role_traefik_middleware_default_api`{ .sb-show-on-unchecked }`whisparr2_traefik_middleware_default_api`{ .sb-show-on-checked }"
        ...
        ```yaml { .sb-show-on-checked }
        # Type: string
        whisparr2_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`whisparr_role_traefik_middleware_custom_api`{ .sb-show-on-unchecked }`whisparr2_traefik_middleware_custom_api`{ .sb-show-on-checked }"
        ...
        ```yaml { .sb-show-on-checked }
        # Type: string
        whisparr2_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`whisparr_role_docker_gpu_enabled`{ .sb-show-on-unchecked }`whisparr2_docker_gpu_enabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        whisparr_role_docker_gpu_enabled: false
        ```
        ...
        # This setting does not install or enable GPU support on the server.
        # Type: bool (true/false)
        whisparr2_docker_gpu_enabled: false
        ```

    ??? variable bool "`whisparr_role_docker_nvidia_disabled`{ .sb-show-on-unchecked }`whisparr2_docker_nvidia_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        whisparr_role_docker_nvidia_disabled: false
        ```
        ...
        # Automatic /dev/dri access may remain.
        # Type: bool (true/false)
        whisparr2_docker_nvidia_disabled: false
        ```

    ??? variable bool "`whisparr_role_docker_dev_dri_disabled`{ .sb-show-on-unchecked }`whisparr2_docker_dev_dri_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        whisparr_role_docker_dev_dri_disabled: false
        ```
        ...
        # NVIDIA-specific access may remain.
        # Type: bool (true/false)
        whisparr2_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable string "`whisparr_role_docker_stop_signal`{ .sb-show-on-unchecked }`whisparr2_docker_stop_signal`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string
        whisparr_role_docker_stop_signal:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        whisparr2_docker_stop_signal:
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`whisparr_role_paths_folders_list_custom`{ .sb-show-on-unchecked }`whisparr2_paths_folders_list_custom`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Extra directories to create
        # Type: list
        whisparr_role_paths_folders_list_custom:
        ```

        ```yaml { .sb-show-on-checked }
        # Extra directories to create
        # Type: list
        whisparr2_paths_folders_list_custom:
        ```

    ??? variable string "`whisparr_role_paths_group`{ .sb-show-on-unchecked }`whisparr2_paths_group`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Group for directories created by the role
        # Type: string
        whisparr_role_paths_group:
        ```

        ```yaml { .sb-show-on-checked }
        # Group for directories created by the role
        # Type: string
        whisparr2_paths_group:
        ```

    ??? variable string "`whisparr_role_paths_owner`{ .sb-show-on-unchecked }`whisparr2_paths_owner`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Owner for directories created by the role
        # Type: string
        whisparr_role_paths_owner:
        ```

        ```yaml { .sb-show-on-checked }
        # Owner for directories created by the role
        # Type: string
        whisparr2_paths_owner:
        ```

    ??? variable string "`whisparr_role_paths_permissions`{ .sb-show-on-unchecked }`whisparr2_paths_permissions`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Permissions for directories created by the role
        # Type: string
        whisparr_role_paths_permissions:
        ```

        ```yaml { .sb-show-on-checked }
        # Permissions for directories created by the role
        # Type: string
        whisparr2_paths_permissions:
        ```

    ??? variable bool "`whisparr_role_paths_recursive`{ .sb-show-on-unchecked }`whisparr2_paths_recursive`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        whisparr_role_paths_recursive:
        ```

        ```yaml { .sb-show-on-checked }
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        whisparr2_paths_recursive:
        ```
