...
[:fontawesome-solid-newspaper:**Releases**](https://github.com/imagegenius/docker-immich/pkgs/container/immich){ .md-button .md-button--stretch }
...
=== "Traefik"
    ...
    ??? variable string "`immich_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        immich_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`immich_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        immich_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker"
    ...
    ??? variable bool "`immich_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        immich_role_docker_gpu_enabled: true
        ```

    ??? variable bool "`immich_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        immich_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`immich_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        immich_role_docker_dev_dri_disabled: false
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`immich_role_paths_folders_list_custom`"
    ...
    ??? variable string "`immich_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        immich_role_paths_group:
        ```

    ??? variable string "`immich_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        immich_role_paths_owner:
        ```

    ??? variable string "`immich_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        immich_role_paths_permissions:
        ```

    ??? variable bool "`immich_role_paths_recursive`"

        ```yaml
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        immich_role_paths_recursive:
        ```
