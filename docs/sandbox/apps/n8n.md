...
=== "Traefik"
    ...
    ??? variable string "`n8n_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        n8n_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`n8n_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        n8n_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`n8n_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        n8n_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`n8n_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        n8n_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`n8n_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        n8n_role_docker_dev_dri_disabled: false
        ```
