...
1.  **This role supports multiple instances via `emby_instances`.**
    ...
    !!! example "Example override"
        ...
        === "Role-scoped"
            ...
            :material-arrow-right-bottom-bold: Applies to all instances of emby
        ...
        === "Instance-scoped"
            ...
            :material-arrow-right-bottom-bold: Applies to the instance named emby2
...
=== "Settings"
    ...
    ??? variable string "`emby_role_config_settings_wan_ddns`{ .sb-show-on-unchecked }`emby2_config_settings_wan_ddns`{ .sb-show-on-checked }"
        ...
        ```yaml { .sb-show-on-unchecked }
        # Type: string
        emby_role_config_settings_wan_ddns: "{{ lookup('role_web', role='emby') }}"
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        emby2_config_settings_wan_ddns: "{{ lookup('role_web', role='emby') }}"
        ```
...
=== "Web"
    ...
    ??? variable string "`emby_role_web_url`{ .sb-show-on-unchecked }`emby2_web_url`{ .sb-show-on-checked }"
        ...
        ```yaml { .sb-show-on-unchecked }
        # Type: string
        emby_role_web_url: "{{ lookup('role_web', role='emby', scheme='https') }}"
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        emby2_web_url: "{{ lookup('role_web', role='emby', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`emby_role_traefik_middleware_default_api`{ .sb-show-on-unchecked }`emby2_traefik_middleware_default_api`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string
        emby_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        emby2_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`emby_role_traefik_middleware_custom_api`{ .sb-show-on-unchecked }`emby2_traefik_middleware_custom_api`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string
        emby_role_traefik_middleware_custom_api: ""
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        emby2_traefik_middleware_custom_api: ""
        ```
...
=== "Docker"
    ...
    ??? variable bool "`emby_role_docker_gpu_enabled`{ .sb-show-on-unchecked }`emby2_docker_gpu_enabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        emby_role_docker_gpu_enabled: true
        ```
        ...
        # This setting does not install or enable GPU support on the server.
        # Type: bool (true/false)
        emby2_docker_gpu_enabled: true
        ```

    ??? variable bool "`emby_role_docker_nvidia_disabled`{ .sb-show-on-unchecked }`emby2_docker_nvidia_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        emby_role_docker_nvidia_disabled: false
        ```
        ...
        # Automatic /dev/dri access may remain.
        # Type: bool (true/false)
        emby2_docker_nvidia_disabled: false
        ```

    ??? variable bool "`emby_role_docker_dev_dri_disabled`{ .sb-show-on-unchecked }`emby2_docker_dev_dri_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        emby_role_docker_dev_dri_disabled: false
        ```
        ...
        # NVIDIA-specific access may remain.
        # Type: bool (true/false)
        emby2_docker_dev_dri_disabled: false
        ```
...
=== "Docker+"
    ...
    ??? variable string "`emby_role_docker_stop_signal`{ .sb-show-on-unchecked }`emby2_docker_stop_signal`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string
        emby_role_docker_stop_signal:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        emby2_docker_stop_signal:
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`emby_role_paths_folders_list_custom`{ .sb-show-on-unchecked }`emby2_paths_folders_list_custom`{ .sb-show-on-checked }"
        ...
        # Extra directories to create
        # Type: list
        emby2_paths_folders_list_custom:
        ```

    ??? variable string "`emby_role_paths_group`{ .sb-show-on-unchecked }`emby2_paths_group`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Group for directories created by the role
        # Type: string
        emby_role_paths_group:
        ```
    ...
    ??? variable string "`emby_role_paths_owner`{ .sb-show-on-unchecked }`emby2_paths_owner`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Owner for directories created by the role
        # Type: string
        emby_role_paths_owner:
        ```
    ...
    ??? variable string "`emby_role_paths_permissions`{ .sb-show-on-unchecked }`emby2_paths_permissions`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Permissions for directories created by the role
        # Type: string
        emby_role_paths_permissions:
        ```

        ```yaml { .sb-show-on-checked }
        # Permissions for directories created by the role
        # Type: string
        emby2_paths_permissions:
        ```

    ??? variable bool "`emby_role_paths_recursive`{ .sb-show-on-unchecked }`emby2_paths_recursive`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        emby_role_paths_recursive:
        ```

        ```yaml { .sb-show-on-checked }
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        emby2_paths_recursive:
        ```
    ...
    ??? variable string "`emby_role_web_api_http_port`{ .sb-show-on-unchecked }`emby2_web_api_http_port`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string (quoted number)
        emby_role_web_api_http_port:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string (quoted number)
        emby2_web_api_http_port:
        ```

    ??? variable string "`emby_role_web_api_http_scheme`{ .sb-show-on-unchecked }`emby2_web_api_http_scheme`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string ("http"/"https")
        emby_role_web_api_http_scheme:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string ("http"/"https")
        emby2_web_api_http_scheme:
        ```

    ??? variable dict "`emby_role_web_api_http_serverstransport`{ .sb-show-on-unchecked }`emby2_web_api_http_serverstransport`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: dict/omit
        emby_role_web_api_http_serverstransport:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: dict/omit
        emby2_web_api_http_serverstransport:
        ```

    ??? variable string "`emby_role_web_api_port`{ .sb-show-on-unchecked }`emby2_web_api_port`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string (quoted number)
        emby_role_web_api_port:
        ```
    ...
    ??? variable string "`emby_role_web_api_scheme`{ .sb-show-on-unchecked }`emby2_web_api_scheme`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string ("http"/"https")
        emby_role_web_api_scheme:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string ("http"/"https")
        emby2_web_api_scheme:
        ```

    ??? variable dict "`emby_role_web_api_serverstransport`{ .sb-show-on-unchecked }`emby2_web_api_serverstransport`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: dict/omit
        emby_role_web_api_serverstransport:
        ```
