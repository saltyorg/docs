...
=== "Docker+"
    ...
    ??? variable bool "`sabthrottle_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        sabthrottle_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`sabthrottle_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        sabthrottle_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`sabthrottle_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        sabthrottle_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`sabthrottle_role_docker_force_kill`"
    ...
    ??? variable string "`sabthrottle_role_docker_stop_signal`"

        ```yaml
        # Type: string
        sabthrottle_role_docker_stop_signal:
        ```
    ...
    ??? variable list "`sabthrottle_role_docker_entrypoint`"
    ...
    ??? variable dict "`sabthrottle_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`sabthrottle_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        sabthrottle_role_paths_folders_list_custom:
        ```

    ??? variable string "`sabthrottle_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        sabthrottle_role_paths_group:
        ```

    ??? variable string "`sabthrottle_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        sabthrottle_role_paths_owner:
        ```

    ??? variable string "`sabthrottle_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        sabthrottle_role_paths_permissions:
        ```

    ??? variable bool "`sabthrottle_role_paths_recursive`"

        ```yaml
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        sabthrottle_role_paths_recursive:
        ```
