...
=== "Global Override Options"
    ...
    ??? variable dict/omit "`glances_web_role_traefik_api_endpoint`"
    ...
    ??? variable dict/omit "`glances_web_role_web_http_serverstransport`"
    ...
    ??? variable dict/omit "`glances_web_role_web_serverstransport`"
