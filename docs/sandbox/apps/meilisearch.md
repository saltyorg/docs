...
=== "Docker+"
    ...
    ??? variable bool "`meilisearch_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        meilisearch_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`meilisearch_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        meilisearch_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`meilisearch_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        meilisearch_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`meilisearch_role_docker_force_kill`"
    ...
    ??? variable string "`meilisearch_role_docker_stop_signal`"

        ```yaml
        # Type: string
        meilisearch_role_docker_stop_signal:
        ```
    ...
    ??? variable list "`meilisearch_role_docker_entrypoint`"
    ...
    ??? variable dict "`meilisearch_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`meilisearch_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        meilisearch_role_paths_folders_list_custom:
        ```

    ??? variable string "`meilisearch_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        meilisearch_role_paths_group:
        ```

    ??? variable string "`meilisearch_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        meilisearch_role_paths_owner:
        ```

    ??? variable string "`meilisearch_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        meilisearch_role_paths_permissions:
        ```

    ??? variable bool "`meilisearch_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        meilisearch_role_paths_recursive:
        ```
