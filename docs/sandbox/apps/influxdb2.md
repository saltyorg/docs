...
[:fontawesome-solid-book-open:**Manual**](https://docs.influxdata.com/influxdb/latest){ .md-button .md-button--stretch }
...
1.  **This role supports multiple instances via `influxdb2_instances`.**
    ...
    !!! example "Example override"
        ...
        === "Role-scoped"
            ...
            :material-arrow-right-bottom-bold: Applies to all instances of influxdb2
        ...
        === "Instance-scoped"
            ...
            :material-arrow-right-bottom-bold: Applies to the instance named influxdb22
...
=== "Web"
    ...
    ??? variable string "`influxdb2_role_web_url`{ .sb-show-on-unchecked }`influxdb22_web_url`{ .sb-show-on-checked }"
        ...
        ```yaml { .sb-show-on-unchecked }
        # Type: string
        influxdb2_role_web_url: "{{ lookup('role_web', role='influxdb2', scheme='https') }}"
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        influxdb22_web_url: "{{ lookup('role_web', role='influxdb2', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`influxdb2_role_traefik_middleware_default_api`{ .sb-show-on-unchecked }`influxdb22_traefik_middleware_default_api`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string
        influxdb2_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        influxdb22_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`influxdb2_role_traefik_middleware_custom_api`{ .sb-show-on-unchecked }`influxdb22_traefik_middleware_custom_api`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string
        influxdb2_role_traefik_middleware_custom_api: ""
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        influxdb22_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`influxdb2_role_docker_gpu_enabled`{ .sb-show-on-unchecked }`influxdb22_docker_gpu_enabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        influxdb2_role_docker_gpu_enabled: false
        ```
        ...
        # This setting does not install or enable GPU support on the server.
        # Type: bool (true/false)
        influxdb22_docker_gpu_enabled: false
        ```

    ??? variable bool "`influxdb2_role_docker_nvidia_disabled`{ .sb-show-on-unchecked }`influxdb22_docker_nvidia_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        influxdb2_role_docker_nvidia_disabled: false
        ```
        ...
        # Automatic /dev/dri access may remain.
        # Type: bool (true/false)
        influxdb22_docker_nvidia_disabled: false
        ```

    ??? variable bool "`influxdb2_role_docker_dev_dri_disabled`{ .sb-show-on-unchecked }`influxdb22_docker_dev_dri_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        influxdb2_role_docker_dev_dri_disabled: false
        ```
        ...
        # NVIDIA-specific access may remain.
        # Type: bool (true/false)
        influxdb22_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable string "`influxdb2_role_docker_stop_signal`{ .sb-show-on-unchecked }`influxdb22_docker_stop_signal`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string
        influxdb2_role_docker_stop_signal:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        influxdb22_docker_stop_signal:
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`influxdb2_role_docker_networks_alias_custom`{ .sb-show-on-unchecked }`influxdb22_docker_networks_alias_custom`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: list
        influxdb2_role_docker_networks_alias_custom:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: list
        influxdb22_docker_networks_alias_custom:
        ```
