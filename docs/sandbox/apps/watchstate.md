...
=== "Web"
    ...
    ??? variable string "`watchstate_role_web_url`{ .sb-show-on-unchecked }`watchstate2_web_url`{ .sb-show-on-checked }"
        ...
        ```yaml { .sb-show-on-unchecked }
        # Type: string
        watchstate_role_web_url: "{{ lookup('role_web', role='watchstate', scheme='https') }}"
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        watchstate2_web_url: "{{ lookup('role_web', role='watchstate', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`watchstate_role_traefik_middleware_default_api`{ .sb-show-on-unchecked }`watchstate2_traefik_middleware_default_api`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string
        watchstate_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        watchstate2_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`watchstate_role_traefik_middleware_custom_api`{ .sb-show-on-unchecked }`watchstate2_traefik_middleware_custom_api`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string
        watchstate_role_traefik_middleware_custom_api: ""
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        watchstate2_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`watchstate_role_docker_gpu_enabled`{ .sb-show-on-unchecked }`watchstate2_docker_gpu_enabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        watchstate_role_docker_gpu_enabled: false
        ```
        ...
        # This setting does not install or enable GPU support on the server.
        # Type: bool (true/false)
        watchstate2_docker_gpu_enabled: false
        ```

    ??? variable bool "`watchstate_role_docker_nvidia_disabled`{ .sb-show-on-unchecked }`watchstate2_docker_nvidia_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        watchstate_role_docker_nvidia_disabled: false
        ```
        ...
        # Automatic /dev/dri access may remain.
        # Type: bool (true/false)
        watchstate2_docker_nvidia_disabled: false
        ```

    ??? variable bool "`watchstate_role_docker_dev_dri_disabled`{ .sb-show-on-unchecked }`watchstate2_docker_dev_dri_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        watchstate_role_docker_dev_dri_disabled: false
        ```
        ...
        # NVIDIA-specific access may remain.
        # Type: bool (true/false)
        watchstate2_docker_dev_dri_disabled: false
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`watchstate_role_paths_folders_list_custom`{ .sb-show-on-unchecked }`watchstate2_paths_folders_list_custom`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Extra directories to create
        # Type: list
        watchstate_role_paths_folders_list_custom:
        ```

        ```yaml { .sb-show-on-checked }
        # Extra directories to create
        # Type: list
        watchstate2_paths_folders_list_custom:
        ```

    ??? variable string "`watchstate_role_paths_group`{ .sb-show-on-unchecked }`watchstate2_paths_group`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Group for directories created by the role
        # Type: string
        watchstate_role_paths_group:
        ```

        ```yaml { .sb-show-on-checked }
        # Group for directories created by the role
        # Type: string
        watchstate2_paths_group:
        ```

    ??? variable string "`watchstate_role_paths_owner`{ .sb-show-on-unchecked }`watchstate2_paths_owner`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Owner for directories created by the role
        # Type: string
        watchstate_role_paths_owner:
        ```

        ```yaml { .sb-show-on-checked }
        # Owner for directories created by the role
        # Type: string
        watchstate2_paths_owner:
        ```

    ??? variable string "`watchstate_role_paths_permissions`{ .sb-show-on-unchecked }`watchstate2_paths_permissions`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Permissions for directories created by the role
        # Type: string
        watchstate_role_paths_permissions:
        ```

        ```yaml { .sb-show-on-checked }
        # Permissions for directories created by the role
        # Type: string
        watchstate2_paths_permissions:
        ```
