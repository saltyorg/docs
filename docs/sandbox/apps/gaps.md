...
saltbox_automation:
  app_links:
    - name: Manual
      url: https://github.com/JasonHHouse/gaps#-usage-
      type: documentation
    - name: Releases
      url: https://hub.docker.com/r/housewrecker/gaps/tags
      type: docker
    - name: Community
      url:
      type: community
...
[:fontawesome-solid-book-open:**Manual**](https://github.com/JasonHHouse/gaps#-usage-){ .md-button .md-button--stretch }
...
=== "Docker+"
    ...
    ??? variable string "`gaps_role_docker_stop_signal`"

        ```yaml
        # Type: string
        gaps_role_docker_stop_signal:
        ```
    ...
    ??? variable string "`gaps_role_docker_dev_dri`"

        ```yaml
        # Type: string
        gaps_role_docker_dev_dri:
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`gaps_role_docker_networks_alias_custom`"

        ```yaml
        # Type: list
        gaps_role_docker_networks_alias_custom:
        ```
    ...
    ??? variable string "`gaps_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        gaps_role_web_api_http_port:
        ```

    ??? variable string "`gaps_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        gaps_role_web_api_http_scheme:
        ```

    ??? variable dict "`gaps_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        gaps_role_web_api_http_serverstransport:
        ```

    ??? variable string "`gaps_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        gaps_role_web_api_port:
        ```

    ??? variable string "`gaps_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        gaps_role_web_api_scheme:
        ```

    ??? variable dict "`gaps_role_web_api_serverstransport`"

        ```yaml
        # Type: dict/omit
        gaps_role_web_api_serverstransport:
        ```
    ...
    ??? variable dict "`gaps_role_web_http_serverstransport`"
    ...
    ??? variable dict "`gaps_role_web_serverstransport`"
