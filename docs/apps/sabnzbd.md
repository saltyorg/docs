...
=== "Web"
    ...
    ??? variable string "`sabnzbd_role_web_url`"
        ...
        ```yaml
        # Type: string
        sabnzbd_role_web_url: "{{ lookup('role_web', role='sabnzbd', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`sabnzbd_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        sabnzbd_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`sabnzbd_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        sabnzbd_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`sabnzbd_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        sabnzbd_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`sabnzbd_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        sabnzbd_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`sabnzbd_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        sabnzbd_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable string "`sabnzbd_role_docker_stop_signal`"

        ```yaml
        # Type: string
        sabnzbd_role_docker_stop_signal:
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`sabnzbd_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        sabnzbd_role_paths_folders_list_custom:
        ```

    ??? variable string "`sabnzbd_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        sabnzbd_role_paths_group:
        ```

    ??? variable string "`sabnzbd_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        sabnzbd_role_paths_owner:
        ```

    ??? variable string "`sabnzbd_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        sabnzbd_role_paths_permissions:
        ```

    ??? variable bool "`sabnzbd_role_paths_recursive`"

        ```yaml
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        sabnzbd_role_paths_recursive:
        ```
    ...
    ??? variable string "`sabnzbd_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        sabnzbd_role_web_api_http_port:
        ```

    ??? variable string "`sabnzbd_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        sabnzbd_role_web_api_http_scheme:
        ```

    ??? variable dict "`sabnzbd_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        sabnzbd_role_web_api_http_serverstransport:
        ```

    ??? variable string "`sabnzbd_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        sabnzbd_role_web_api_port:
        ```

    ??? variable string "`sabnzbd_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        sabnzbd_role_web_api_scheme:
        ```

    ??? variable dict "`sabnzbd_role_web_api_serverstransport`"
