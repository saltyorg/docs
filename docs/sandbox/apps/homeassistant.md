...
=== "Web"
    ...
    ??? variable string "`homeassistant_role_web_url`"
        ...
        ```yaml
        # Type: string
        homeassistant_role_web_url: "{{ lookup('role_web', role='homeassistant', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`homeassistant_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        homeassistant_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`homeassistant_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        homeassistant_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`homeassistant_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        homeassistant_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`homeassistant_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        homeassistant_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`homeassistant_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        homeassistant_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`homeassistant_role_docker_force_kill`"
    ...
    ??? variable string "`homeassistant_role_docker_stop_signal`"

        ```yaml
        # Type: string
        homeassistant_role_docker_stop_signal:
        ```
    ...
    ??? variable list "`homeassistant_role_docker_entrypoint`"
    ...
    ??? variable dict "`homeassistant_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`homeassistant_role_docker_networks_alias_custom`"

        ```yaml
        # Type: list
        homeassistant_role_docker_networks_alias_custom:
        ```
    ...
    ??? variable list "`homeassistant_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        homeassistant_role_paths_folders_list_custom:
        ```

    ??? variable string "`homeassistant_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        homeassistant_role_paths_group:
        ```

    ??? variable string "`homeassistant_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        homeassistant_role_paths_owner:
        ```

    ??? variable string "`homeassistant_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        homeassistant_role_paths_permissions:
        ```

    ??? variable bool "`homeassistant_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        homeassistant_role_paths_recursive:
        ```

    ??? variable list "`homeassistant_role_themepark_addons`"
