...
=== "Web"
    ...
    ??? variable string "`adminer_role_web_url`"
        ...
        ```yaml
        # Type: string
        adminer_role_web_url: "{{ lookup('role_web', role='adminer', scheme='https') }}"
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`adminer_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        adminer_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`adminer_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        adminer_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`adminer_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        adminer_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`adminer_role_docker_force_kill`"
    ...
    ??? variable string "`adminer_role_docker_stop_signal`"

        ```yaml
        # Type: string
        adminer_role_docker_stop_signal:
        ```
    ...
    ??? variable list "`adminer_role_docker_entrypoint`"
    ...
    ??? variable dict "`adminer_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`adminer_role_themepark_addons`"
    ...
    ??? variable string "`adminer_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        adminer_role_web_api_http_port:
        ```

    ??? variable string "`adminer_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        adminer_role_web_api_http_scheme:
        ```

    ??? variable dict "`adminer_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        adminer_role_web_api_http_serverstransport:
        ```

    ??? variable string "`adminer_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        adminer_role_web_api_port:
        ```

    ??? variable string "`adminer_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        adminer_role_web_api_scheme:
        ```

    ??? variable dict "`adminer_role_web_api_serverstransport`"
