...
=== "Global Override Options"
    ...
    ??? variable string "`bazarr_role_docker_image_repo`{ .sb-show-on-unchecked }`bazarr2_docker_image_repo`{ .sb-show-on-checked }"
        ...
        ```yaml { .sb-show-on-unchecked }
        # Type: string
        bazarr_role_docker_image_repo:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        bazarr2_docker_image_repo:
        ```
    ...
    ??? variable string "`bazarr_role_docker_image_tag`{ .sb-show-on-unchecked }`bazarr2_docker_image_tag`{ .sb-show-on-checked }"
        ...
        ```yaml { .sb-show-on-unchecked }
        # Type: string
        bazarr_role_docker_image_tag:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        bazarr2_docker_image_tag:
        ```
    ...
    ??? variable string "`bazarr_role_themepark_addons`{ .sb-show-on-unchecked }`bazarr2_themepark_addons`{ .sb-show-on-checked }"
    ...
    ??? variable string "`bazarr_role_themepark_app`{ .sb-show-on-unchecked }`bazarr2_themepark_app`{ .sb-show-on-checked }"
        ...
        ```yaml { .sb-show-on-unchecked }
        # Type: string
        bazarr_role_themepark_app:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        bazarr2_themepark_app:
        ```
    ...
    ??? variable bool "`bazarr_role_themepark_enabled`{ .sb-show-on-unchecked }`bazarr2_themepark_enabled`{ .sb-show-on-checked }"
        ...
        ```yaml { .sb-show-on-unchecked }
        # Type: bool (true/false)
        bazarr_role_themepark_enabled:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: bool (true/false)
        bazarr2_themepark_enabled:
        ```
    ...
    ??? variable dict "`bazarr_role_traefik_api_endpoint`{ .sb-show-on-unchecked }`bazarr2_traefik_api_endpoint`{ .sb-show-on-checked }"
        ...
        ```yaml { .sb-show-on-unchecked }
        # Type: dict/omit
        bazarr_role_traefik_api_endpoint:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: dict/omit
        bazarr2_traefik_api_endpoint:
        ```
    ...
    ??? variable string "`bazarr_role_traefik_certresolver`{ .sb-show-on-unchecked }`bazarr2_traefik_certresolver`{ .sb-show-on-checked }"
        ...
        ```yaml { .sb-show-on-unchecked }
        # Type: string
        bazarr_role_traefik_certresolver:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        bazarr2_traefik_certresolver:
        ```
    ...
    ??? variable string "`bazarr_role_web_subdomain`{ .sb-show-on-unchecked }`bazarr2_web_subdomain`{ .sb-show-on-checked }"
        ...
        ```yaml { .sb-show-on-unchecked }
        # Type: string
        bazarr_role_web_subdomain:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        bazarr2_web_subdomain:
        ```
