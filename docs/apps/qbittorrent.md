...
1.  Under `Options` -> `Connection`, the listening port is managed by Saltbox. To choose a specific port, set both `qbittorrent_role_port_peer_low_bound` and `qbittorrent_role_port_peer_high_bound` to that port in your [inventory](../saltbox/inventory/index.md), then run `sb install qbittorrent`.
...
=== "Settings"
    ...
    ??? variable string "`qbittorrent_role_webui_custom_headers_enabled`{ .sb-show-on-unchecked }`qbittorrent2_webui_custom_headers_enabled`{ .sb-show-on-checked }"
        ...
        ```yaml { .sb-show-on-checked }
        # Type: string
        qbittorrent2_webui_custom_headers_enabled: "{{ 'true'
                                                    if lookup('role_var', '_themepark_enabled', role='qbittorrent') and global_themepark_plugin_enabled
                                                    else 'false' }}"
        ```
...
=== "Host Install"
    ...
    ??? variable string "`qbittorrent_role_host_download_url`{ .sb-show-on-unchecked }`qbittorrent2_host_download_url`{ .sb-show-on-checked }"
        ...
        ```yaml { .sb-show-on-unchecked }
        # Type: string
        qbittorrent_role_host_download_url: "{{ lookup('role_var', '_host_download_endpoint', role='qbittorrent') }}{{ lookup('role_var', '_host_download_version', role='qbittorrent') }}/x86_64-qbittorrent-nox"
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        qbittorrent2_host_download_url: "{{ lookup('role_var', '_host_download_endpoint', role='qbittorrent') }}{{ lookup('role_var', '_host_download_version', role='qbittorrent') }}/x86_64-qbittorrent-nox"
        ```
    ...
    ??? variable string "`qbittorrent_role_host_version`{ .sb-show-on-unchecked }`qbittorrent2_host_version`{ .sb-show-on-checked }"
        ...
        ```yaml { .sb-show-on-unchecked }
        # Type: string
        qbittorrent_role_host_version: "{{ 'release-' + (qbittorrent_host_version_response.content | from_json).qbittorrent
                                           + '_v' + ((qbittorrent_host_version_response.content | from_json).libtorrent_2_0
                                                     if lookup('role_var', '_host_branch', role='qbittorrent') == 'libtorrent2'
                                                     else (qbittorrent_host_version_response.content | from_json).libtorrent_1_2) }}"
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        qbittorrent2_host_version: "{{ 'release-' + (qbittorrent_host_version_response.content | from_json).qbittorrent
                                       + '_v' + ((qbittorrent_host_version_response.content | from_json).libtorrent_2_0
                                                 if lookup('role_var', '_host_branch', role='qbittorrent') == 'libtorrent2'
                                                 else (qbittorrent_host_version_response.content | from_json).libtorrent_1_2) }}"
        ```
...
=== "Web"
    ...
    ??? variable string "`qbittorrent_role_web_url`{ .sb-show-on-unchecked }`qbittorrent2_web_url`{ .sb-show-on-checked }"
        ...
        ```yaml { .sb-show-on-checked }
        # Type: string
        qbittorrent2_web_url: "{{ lookup('role_web', role='qbittorrent', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`qbittorrent_role_traefik_middleware_default_api`{ .sb-show-on-unchecked }`qbittorrent2_traefik_middleware_default_api`{ .sb-show-on-checked }"
        ...
        ```yaml { .sb-show-on-checked }
        # Type: string
        qbittorrent2_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`qbittorrent_role_traefik_middleware_custom_api`{ .sb-show-on-unchecked }`qbittorrent2_traefik_middleware_custom_api`{ .sb-show-on-checked }"
        ...
        ```yaml { .sb-show-on-checked }
        # Type: string
        qbittorrent2_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`qbittorrent_role_docker_gpu_enabled`{ .sb-show-on-unchecked }`qbittorrent2_docker_gpu_enabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        qbittorrent_role_docker_gpu_enabled: false
        ```
        ...
        # This setting does not install or enable GPU support on the server.
        # Type: bool (true/false)
        qbittorrent2_docker_gpu_enabled: false
        ```

    ??? variable bool "`qbittorrent_role_docker_nvidia_disabled`{ .sb-show-on-unchecked }`qbittorrent2_docker_nvidia_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        qbittorrent_role_docker_nvidia_disabled: false
        ```
        ...
        # Automatic /dev/dri access may remain.
        # Type: bool (true/false)
        qbittorrent2_docker_nvidia_disabled: false
        ```

    ??? variable bool "`qbittorrent_role_docker_dev_dri_disabled`{ .sb-show-on-unchecked }`qbittorrent2_docker_dev_dri_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        qbittorrent_role_docker_dev_dri_disabled: false
        ```
        ...
        # NVIDIA-specific access may remain.
        # Type: bool (true/false)
        qbittorrent2_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`qbittorrent_role_docker_force_kill`{ .sb-show-on-unchecked }`qbittorrent2_docker_force_kill`{ .sb-show-on-checked }"
    ...
    ??? variable list "`qbittorrent_role_docker_entrypoint`{ .sb-show-on-unchecked }`qbittorrent2_docker_entrypoint`{ .sb-show-on-checked }"
    ...
    ??? variable dict "`qbittorrent_role_docker_sysctls`{ .sb-show-on-unchecked }`qbittorrent2_docker_sysctls`{ .sb-show-on-checked }"
...
=== "Global Override Options"
    ...
    ??? variable list "`qbittorrent_role_paths_folders_list_custom`{ .sb-show-on-unchecked }`qbittorrent2_paths_folders_list_custom`{ .sb-show-on-checked }"
        ...
        # Extra directories to create
        # Type: list
        qbittorrent2_paths_folders_list_custom:
        ```

    ??? variable string "`qbittorrent_role_paths_group`{ .sb-show-on-unchecked }`qbittorrent2_paths_group`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Group for directories created by the role
        # Type: string
        qbittorrent_role_paths_group:
        ```

        ```yaml { .sb-show-on-checked }
        # Group for directories created by the role
        # Type: string
        qbittorrent2_paths_group:
        ```

    ??? variable string "`qbittorrent_role_paths_owner`{ .sb-show-on-unchecked }`qbittorrent2_paths_owner`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Owner for directories created by the role
        # Type: string
        qbittorrent_role_paths_owner:
        ```

        ```yaml { .sb-show-on-checked }
        # Owner for directories created by the role
        # Type: string
        qbittorrent2_paths_owner:
        ```

    ??? variable string "`qbittorrent_role_paths_permissions`{ .sb-show-on-unchecked }`qbittorrent2_paths_permissions`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Permissions for directories created by the role
        # Type: string
        qbittorrent_role_paths_permissions:
        ```

        ```yaml { .sb-show-on-checked }
        # Permissions for directories created by the role
        # Type: string
        qbittorrent2_paths_permissions:
        ```

    ??? variable bool "`qbittorrent_role_paths_recursive`{ .sb-show-on-unchecked }`qbittorrent2_paths_recursive`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        qbittorrent_role_paths_recursive:
        ```

        ```yaml { .sb-show-on-checked }
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        qbittorrent2_paths_recursive:
        ```
    ...
    ??? variable string "`qbittorrent_role_web_api_http_port`{ .sb-show-on-unchecked }`qbittorrent2_web_api_http_port`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string (quoted number)
        qbittorrent_role_web_api_http_port:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string (quoted number)
        qbittorrent2_web_api_http_port:
        ```

    ??? variable string "`qbittorrent_role_web_api_http_scheme`{ .sb-show-on-unchecked }`qbittorrent2_web_api_http_scheme`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string ("http"/"https")
        qbittorrent_role_web_api_http_scheme:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string ("http"/"https")
        qbittorrent2_web_api_http_scheme:
        ```

    ??? variable dict "`qbittorrent_role_web_api_http_serverstransport`{ .sb-show-on-unchecked }`qbittorrent2_web_api_http_serverstransport`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: dict/omit
        qbittorrent_role_web_api_http_serverstransport:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: dict/omit
        qbittorrent2_web_api_http_serverstransport:
        ```

    ??? variable string "`qbittorrent_role_web_api_port`{ .sb-show-on-unchecked }`qbittorrent2_web_api_port`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string (quoted number)
        qbittorrent_role_web_api_port:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string (quoted number)
        qbittorrent2_web_api_port:
        ```

    ??? variable string "`qbittorrent_role_web_api_scheme`{ .sb-show-on-unchecked }`qbittorrent2_web_api_scheme`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string ("http"/"https")
        qbittorrent_role_web_api_scheme:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string ("http"/"https")
        qbittorrent2_web_api_scheme:
        ```

    ??? variable dict "`qbittorrent_role_web_api_serverstransport`{ .sb-show-on-unchecked }`qbittorrent2_web_api_serverstransport`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: dict/omit
        qbittorrent_role_web_api_serverstransport:
        ```
