...
=== "Web"
    ...
    ??? variable string "`fireflyiii_role_web_url`"
        ...
        ```yaml
        # Type: string
        fireflyiii_role_web_url: "{{ lookup('role_web', role='fireflyiii', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`fireflyiii_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        fireflyiii_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`fireflyiii_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        fireflyiii_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`fireflyiii_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        fireflyiii_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`fireflyiii_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        fireflyiii_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`fireflyiii_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        fireflyiii_role_docker_dev_dri_disabled: false
        ```

    <h5>Resource Limits</h5>

    ??? variable int "`fireflyiii_role_docker_blkio_weight`"

        ```yaml
        # Type: int
        fireflyiii_role_docker_blkio_weight:
        ```

    ??? variable int "`fireflyiii_role_docker_cpu_period`"

        ```yaml
        # Type: int
        fireflyiii_role_docker_cpu_period:
        ```

    ??? variable int "`fireflyiii_role_docker_cpu_quota`"

        ```yaml
        # Type: int
        fireflyiii_role_docker_cpu_quota:
        ```

    ??? variable int "`fireflyiii_role_docker_cpu_shares`"

        ```yaml
        # Type: int
        fireflyiii_role_docker_cpu_shares:
        ```

    ??? variable string "`fireflyiii_role_docker_cpus`"

        ```yaml
        # Type: string
        fireflyiii_role_docker_cpus:
        ```

    ??? variable string "`fireflyiii_role_docker_cpuset_cpus`"

        ```yaml
        # Type: string
        fireflyiii_role_docker_cpuset_cpus:
        ```

    ??? variable string "`fireflyiii_role_docker_cpuset_mems`"

        ```yaml
        # Type: string
        fireflyiii_role_docker_cpuset_mems:
        ```

    ??? variable string "`fireflyiii_role_docker_kernel_memory`"

        ```yaml
        # Type: string
        fireflyiii_role_docker_kernel_memory:
        ```

    ??? variable string "`fireflyiii_role_docker_memory`"

        ```yaml
        # Type: string
        fireflyiii_role_docker_memory:
        ```

    ??? variable string "`fireflyiii_role_docker_memory_reservation`"

        ```yaml
        # Type: string
        fireflyiii_role_docker_memory_reservation:
        ```

    ??? variable string "`fireflyiii_role_docker_memory_swap`"

        ```yaml
        # Type: string
        fireflyiii_role_docker_memory_swap:
        ```

    ??? variable int "`fireflyiii_role_docker_memory_swappiness`"

        ```yaml
        # Type: int
        fireflyiii_role_docker_memory_swappiness:
        ```

    ??? variable string "`fireflyiii_role_docker_shm_size`"

        ```yaml
        # Type: string
        fireflyiii_role_docker_shm_size:
        ```

    <h5>Security & Devices</h5>

    ??? variable list "`fireflyiii_role_docker_cap_drop`"

        ```yaml
        # Type: list
        fireflyiii_role_docker_cap_drop:
        ```

    ??? variable string "`fireflyiii_role_docker_cgroupns_mode`"

        ```yaml
        # Type: string
        fireflyiii_role_docker_cgroupns_mode:
        ```

    ??? variable list "`fireflyiii_role_docker_device_cgroup_rules`"

        ```yaml
        # Type: list
        fireflyiii_role_docker_device_cgroup_rules:
        ```

    ??? variable list "`fireflyiii_role_docker_device_read_bps`"

        ```yaml
        # Type: list
        fireflyiii_role_docker_device_read_bps:
        ```

    ??? variable list "`fireflyiii_role_docker_device_read_iops`"

        ```yaml
        # Type: list
        fireflyiii_role_docker_device_read_iops:
        ```

    ??? variable list "`fireflyiii_role_docker_device_requests`"

        ```yaml
        # Type: list
        fireflyiii_role_docker_device_requests:
        ```

    ??? variable list "`fireflyiii_role_docker_device_write_bps`"

        ```yaml
        # Type: list
        fireflyiii_role_docker_device_write_bps:
        ```

    ??? variable list "`fireflyiii_role_docker_device_write_iops`"

        ```yaml
        # Type: list
        fireflyiii_role_docker_device_write_iops:
        ```

    ??? variable list "`fireflyiii_role_docker_devices`"

        ```yaml
        # Type: list
        fireflyiii_role_docker_devices:
        ```

    ??? variable list "`fireflyiii_role_docker_groups`"

        ```yaml
        # Type: list
        fireflyiii_role_docker_groups:
        ```

    ??? variable bool "`fireflyiii_role_docker_privileged`"

        ```yaml
        # Type: bool (true/false)
        fireflyiii_role_docker_privileged:
        ```

    ??? variable list "`fireflyiii_role_docker_security_opts`"

        ```yaml
        # Type: list
        fireflyiii_role_docker_security_opts:
        ```

    ??? variable string "`fireflyiii_role_docker_user`"

        ```yaml
        # Type: string
        fireflyiii_role_docker_user:
        ```

    ??? variable string "`fireflyiii_role_docker_userns_mode`"

        ```yaml
        # Type: string
        fireflyiii_role_docker_userns_mode:
        ```

    <h5>Networking</h5>

    ??? variable list "`fireflyiii_role_docker_dns_opts`"

        ```yaml
        # Type: list
        fireflyiii_role_docker_dns_opts:
        ```

    ??? variable list "`fireflyiii_role_docker_dns_search_domains`"

        ```yaml
        # Type: list
        fireflyiii_role_docker_dns_search_domains:
        ```

    ??? variable list "`fireflyiii_role_docker_dns_servers`"

        ```yaml
        # Type: list
        fireflyiii_role_docker_dns_servers:
        ```

    ??? variable string "`fireflyiii_role_docker_domainname`"

        ```yaml
        # Type: string
        fireflyiii_role_docker_domainname:
        ```

    ??? variable list "`fireflyiii_role_docker_exposed_ports`"

        ```yaml
        # Type: list
        fireflyiii_role_docker_exposed_ports:
        ```

    ??? variable dict "`fireflyiii_role_docker_hosts`"

        ```yaml
        # Type: dict
        fireflyiii_role_docker_hosts:
        ```

    ??? variable bool "`fireflyiii_role_docker_hosts_use_common`"

        ```yaml
        # Type: bool (true/false)
        fireflyiii_role_docker_hosts_use_common:
        ```

    ??? variable string "`fireflyiii_role_docker_ipc_mode`"

        ```yaml
        # Type: string
        fireflyiii_role_docker_ipc_mode:
        ```

    ??? variable list "`fireflyiii_role_docker_links`"

        ```yaml
        # Type: list
        fireflyiii_role_docker_links:
        ```

    ??? variable string "`fireflyiii_role_docker_network_mode`"

        ```yaml
        # Type: string
        fireflyiii_role_docker_network_mode:
        ```

    ??? variable string "`fireflyiii_role_docker_pid_mode`"

        ```yaml
        # Type: string
        fireflyiii_role_docker_pid_mode:
        ```

    ??? variable list "`fireflyiii_role_docker_ports`"

        ```yaml
        # Type: list
        fireflyiii_role_docker_ports:
        ```

    ??? variable string "`fireflyiii_role_docker_uts`"

        ```yaml
        # Type: string
        fireflyiii_role_docker_uts:
        ```

    <h5>Storage</h5>

    ??? variable bool "`fireflyiii_role_docker_keep_volumes`"

        ```yaml
        # Type: bool (true/false)
        fireflyiii_role_docker_keep_volumes:
        ```

    ??? variable list "`fireflyiii_role_docker_mounts`"

        ```yaml
        # Type: list
        fireflyiii_role_docker_mounts:
        ```

    ??? variable dict "`fireflyiii_role_docker_storage_opts`"

        ```yaml
        # Type: dict
        fireflyiii_role_docker_storage_opts:
        ```

    ??? variable list "`fireflyiii_role_docker_tmpfs`"

        ```yaml
        # Type: list
        fireflyiii_role_docker_tmpfs:
        ```

    ??? variable string "`fireflyiii_role_docker_volume_driver`"

        ```yaml
        # Type: string
        fireflyiii_role_docker_volume_driver:
        ```

    ??? variable list "`fireflyiii_role_docker_volumes_from`"

        ```yaml
        # Type: list
        fireflyiii_role_docker_volumes_from:
        ```

    ??? variable bool "`fireflyiii_role_docker_volumes_global`"

        ```yaml
        # Type: bool (true/false)
        fireflyiii_role_docker_volumes_global:
        ```

    ??? variable string "`fireflyiii_role_docker_working_dir`"

        ```yaml
        # Type: string
        fireflyiii_role_docker_working_dir:
        ```

    <h5>Monitoring & Lifecycle</h5>

    ??? variable bool "`fireflyiii_role_docker_auto_remove`"

        ```yaml
        # Type: bool (true/false)
        fireflyiii_role_docker_auto_remove:
        ```

    ??? variable bool "`fireflyiii_role_docker_cleanup`"

        ```yaml
        # Type: bool (true/false)
        fireflyiii_role_docker_cleanup:
        ```

    ??? variable string "`fireflyiii_role_docker_force_kill`"

        ```yaml
        # Type: string
        fireflyiii_role_docker_force_kill:
        ```

    ??? variable dict "`fireflyiii_role_docker_healthcheck`"

        ```yaml
        # Type: dict
        fireflyiii_role_docker_healthcheck:
        ```

    ??? variable int "`fireflyiii_role_docker_healthy_wait_timeout`"

        ```yaml
        # Type: int
        fireflyiii_role_docker_healthy_wait_timeout:
        ```

    ??? variable bool "`fireflyiii_role_docker_init`"

        ```yaml
        # Type: bool (true/false)
        fireflyiii_role_docker_init:
        ```

    ??? variable string "`fireflyiii_role_docker_kill_signal`"

        ```yaml
        # Type: string
        fireflyiii_role_docker_kill_signal:
        ```

    ??? variable string "`fireflyiii_role_docker_log_driver`"

        ```yaml
        # Type: string
        fireflyiii_role_docker_log_driver:
        ```

    ??? variable dict "`fireflyiii_role_docker_log_options`"

        ```yaml
        # Type: dict
        fireflyiii_role_docker_log_options:
        ```

    ??? variable bool "`fireflyiii_role_docker_oom_killer`"

        ```yaml
        # Type: bool (true/false)
        fireflyiii_role_docker_oom_killer:
        ```

    ??? variable int "`fireflyiii_role_docker_oom_score_adj`"

        ```yaml
        # Type: int
        fireflyiii_role_docker_oom_score_adj:
        ```

    ??? variable bool "`fireflyiii_role_docker_output_logs`"

        ```yaml
        # Type: bool (true/false)
        fireflyiii_role_docker_output_logs:
        ```

    ??? variable bool "`fireflyiii_role_docker_paused`"

        ```yaml
        # Type: bool (true/false)
        fireflyiii_role_docker_paused:
        ```

    ??? variable bool "`fireflyiii_role_docker_recreate`"

        ```yaml
        # Type: bool (true/false)
        fireflyiii_role_docker_recreate:
        ```

    ??? variable int "`fireflyiii_role_docker_restart_retries`"

        ```yaml
        # Type: int
        fireflyiii_role_docker_restart_retries:
        ```

    ??? variable string "`fireflyiii_role_docker_stop_signal`"

        ```yaml
        # Type: string
        fireflyiii_role_docker_stop_signal:
        ```

    ??? variable int "`fireflyiii_role_docker_stop_timeout`"

        ```yaml
        # Type: int
        fireflyiii_role_docker_stop_timeout:
        ```

    <h5>Other Options</h5>

    ??? variable list "`fireflyiii_role_docker_capabilities`"

        ```yaml
        # Type: list
        fireflyiii_role_docker_capabilities:
        ```

    ??? variable string "`fireflyiii_role_docker_cgroup_parent`"

        ```yaml
        # Type: string
        fireflyiii_role_docker_cgroup_parent:
        ```

    ??? variable list "`fireflyiii_role_docker_commands`"

        ```yaml
        # Type: list
        fireflyiii_role_docker_commands:
        ```

    ??? variable int "`fireflyiii_role_docker_create_timeout`"

        ```yaml
        # Type: int
        fireflyiii_role_docker_create_timeout:
        ```

    ??? variable string "`fireflyiii_role_docker_entrypoint`"

        ```yaml
        # Type: string
        fireflyiii_role_docker_entrypoint:
        ```

    ??? variable string "`fireflyiii_role_docker_env_file`"

        ```yaml
        # Type: string
        fireflyiii_role_docker_env_file:
        ```

    ??? variable dict "`fireflyiii_role_docker_labels`"

        ```yaml
        # Type: dict
        fireflyiii_role_docker_labels:
        ```

    ??? variable bool "`fireflyiii_role_docker_labels_use_common`"
    ...
    ??? variable bool "`fireflyiii_role_docker_read_only`"
        ...
        ```yaml
        # Type: bool (true/false)
        fireflyiii_role_docker_read_only:
        ```

    ??? variable string "`fireflyiii_role_docker_runtime`"

        ```yaml
        # Type: string
        fireflyiii_role_docker_runtime:
        ```

    ??? variable list "`fireflyiii_role_docker_sysctls`"

        ```yaml
        # Type: list
        fireflyiii_role_docker_sysctls:
        ```

    ??? variable list "`fireflyiii_role_docker_ulimits`"

        ```yaml
        # Type: list
        fireflyiii_role_docker_ulimits:
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`fireflyiii_role_docker_networks_alias_custom`"

        ```yaml
        # Type: list
        fireflyiii_role_docker_networks_alias_custom:
        ```
    ...
    ??? variable string "`fireflyiii_role_themepark_addons`"

        ```yaml
        # Type: string
        fireflyiii_role_themepark_addons:
        ```

    ??? variable string "`fireflyiii_role_themepark_app`"

        ```yaml
        # Type: string
        fireflyiii_role_themepark_app:
        ```

    ??? variable string "`fireflyiii_role_themepark_theme`"

        ```yaml
        # Type: string
        fireflyiii_role_themepark_theme:
        ```

    ??? variable string "`fireflyiii_role_traefik_api_middleware_http`"

        ```yaml
        # Type: string
        fireflyiii_role_traefik_api_middleware_http:
        ```
    ...
    ??? variable string "`fireflyiii_role_traefik_middleware_http`"

        ```yaml
        # Type: string
        fireflyiii_role_traefik_middleware_http:
        ```
    ...
    ??? variable string "`fireflyiii_role_traefik_priority`"

        ```yaml
        # Type: string
        fireflyiii_role_traefik_priority:
        ```
    ...
    ??? variable string "`fireflyiii_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        fireflyiii_role_web_api_http_port:
        ```

    ??? variable string "`fireflyiii_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        fireflyiii_role_web_api_http_scheme:
        ```

    ??? variable dict "`fireflyiii_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        fireflyiii_role_web_api_http_serverstransport:
        ```

    ??? variable string "`fireflyiii_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        fireflyiii_role_web_api_port:
        ```

    ??? variable string "`fireflyiii_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        fireflyiii_role_web_api_scheme:
        ```

    ??? variable dict "`fireflyiii_role_web_api_serverstransport`"

        ```yaml
        # Type: dict/omit
        fireflyiii_role_web_api_serverstransport:
        ```
    ...
    ??? variable string "`fireflyiii_role_web_http_port`"

        ```yaml
        # Type: string (quoted number)
        fireflyiii_role_web_http_port:
        ```

    ??? variable string "`fireflyiii_role_web_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        fireflyiii_role_web_http_scheme:
        ```

    ??? variable dict "`fireflyiii_role_web_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        fireflyiii_role_web_http_serverstransport:
        ```
    ...
    ??? variable dict "`fireflyiii_role_web_serverstransport`"

        ```yaml
        # Type: dict/omit
        fireflyiii_role_web_serverstransport:
        ```
