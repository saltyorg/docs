...
=== "Web"
    ...
    ??? variable string "`apprise_role_web_url`"
        ...
        ```yaml
        # Type: string
        apprise_role_web_url: "{{ lookup('role_web', role='apprise', scheme='https') }}"
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`apprise_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        apprise_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`apprise_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        apprise_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`apprise_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        apprise_role_docker_dev_dri_disabled: false
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`apprise_role_docker_networks_alias_custom`"

        ```yaml
        # Type: list
        apprise_role_docker_networks_alias_custom:
        ```
    ...
    ??? variable list "`apprise_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        apprise_role_paths_folders_list_custom:
        ```

    ??? variable string "`apprise_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        apprise_role_paths_group:
        ```

    ??? variable string "`apprise_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        apprise_role_paths_owner:
        ```

    ??? variable string "`apprise_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        apprise_role_paths_permissions:
        ```

    ??? variable bool "`apprise_role_paths_recursive`"

        ```yaml
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        apprise_role_paths_recursive:
        ```
    ...
    ??? variable string "`apprise_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        apprise_role_web_api_http_port:
        ```

    ??? variable string "`apprise_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        apprise_role_web_api_http_scheme:
        ```

    ??? variable dict "`apprise_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        apprise_role_web_api_http_serverstransport:
        ```

    ??? variable string "`apprise_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        apprise_role_web_api_port:
        ```

    ??? variable string "`apprise_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        apprise_role_web_api_scheme:
        ```

    ??? variable dict "`apprise_role_web_api_serverstransport`"

        ```yaml
        # Type: dict/omit
        apprise_role_web_api_serverstransport:
        ```
