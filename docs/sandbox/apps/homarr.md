...
=== "Traefik"
    ...
    ??? variable string "`homarr_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        homarr_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`homarr_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        homarr_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`homarr_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        homarr_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`homarr_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        homarr_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`homarr_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        homarr_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`homarr_role_docker_force_kill`"
    ...
    ??? variable list "`homarr_role_docker_entrypoint`"
    ...
    ??? variable dict "`homarr_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`homarr_role_docker_networks_alias_custom`"

        ```yaml
        # Type: list
        homarr_role_docker_networks_alias_custom:
        ```
    ...
    ??? variable list "`homarr_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        homarr_role_paths_folders_list_custom:
        ```

    ??? variable string "`homarr_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        homarr_role_paths_group:
        ```

    ??? variable string "`homarr_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        homarr_role_paths_owner:
        ```

    ??? variable string "`homarr_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        homarr_role_paths_permissions:
        ```

    ??? variable bool "`homarr_role_paths_recursive`"

        ```yaml
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        homarr_role_paths_recursive:
        ```

    ??? variable list "`homarr_role_themepark_addons`"
