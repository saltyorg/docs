...
saltbox_automation:
  ...
  project_description:
    name: Doplarr
    summary: |-
      a Discord bot designed to simplify media requests for self-hosted media servers like Radarr, Sonarr, and Overseerr.
...
=== "Docker+"
    ...
    ??? variable bool "`doplarr_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        doplarr_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`doplarr_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        doplarr_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`doplarr_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        doplarr_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`doplarr_role_docker_force_kill`"
    ...
    ??? variable string "`doplarr_role_docker_stop_signal`"

        ```yaml
        # Type: string
        doplarr_role_docker_stop_signal:
        ```
    ...
    ??? variable list "`doplarr_role_docker_entrypoint`"
    ...
    ??? variable dict "`doplarr_role_docker_sysctls`"
