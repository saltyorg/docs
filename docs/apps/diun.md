...
=== "Docker+"
    ...
    ??? variable bool "`diun_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        diun_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`diun_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        diun_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`diun_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        diun_role_docker_dev_dri_disabled: false
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`diun_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        diun_role_paths_folders_list_custom:
        ```

    ??? variable string "`diun_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        diun_role_paths_group:
        ```

    ??? variable string "`diun_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        diun_role_paths_owner:
        ```

    ??? variable string "`diun_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        diun_role_paths_permissions:
        ```

    ??? variable bool "`diun_role_paths_recursive`"

        ```yaml
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        diun_role_paths_recursive:
        ```
