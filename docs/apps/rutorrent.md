...
_Note: public trackers are disabled by default in the standard install.  Refer to the FAQ for [instructions on re-enabling them](../faq/ruTorrent.md#enable-access-to-public-torrent-trackers)._
...
The setup for [Sonarr](sonarr.md), [Radarr](radarr.md), and [Lidarr](lidarr.md) are done on their respective wiki pages.
