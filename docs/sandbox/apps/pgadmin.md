...
=== "Web"
    ...
    ??? variable string "`pgadmin_role_web_url`"
        ...
        ```yaml
        # Type: string
        pgadmin_role_web_url: "{{ lookup('role_web', role='pgadmin', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`pgadmin_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        pgadmin_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`pgadmin_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        pgadmin_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`pgadmin_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        pgadmin_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`pgadmin_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        pgadmin_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`pgadmin_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        pgadmin_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`pgadmin_role_docker_force_kill`"
    ...
    ??? variable string "`pgadmin_role_docker_stop_signal`"

        ```yaml
        # Type: string
        pgadmin_role_docker_stop_signal:
        ```
    ...
    ??? variable list "`pgadmin_role_docker_entrypoint`"
    ...
    ??? variable dict "`pgadmin_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`pgadmin_role_themepark_addons`"
    ...
    ??? variable string "`pgadmin_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        pgadmin_role_web_api_http_port:
        ```

    ??? variable string "`pgadmin_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        pgadmin_role_web_api_http_scheme:
        ```

    ??? variable dict "`pgadmin_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        pgadmin_role_web_api_http_serverstransport:
        ```

    ??? variable string "`pgadmin_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        pgadmin_role_web_api_port:
        ```

    ??? variable string "`pgadmin_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        pgadmin_role_web_api_scheme:
        ```

    ??? variable dict "`pgadmin_role_web_api_serverstransport`"
