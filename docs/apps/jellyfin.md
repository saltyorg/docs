...
=== "Web"
    ...
    ??? variable string "`jellyfin_role_web_url`{ .sb-show-on-unchecked }`jellyfin2_web_url`{ .sb-show-on-checked }"
        ...
        ```yaml { .sb-show-on-unchecked }
        # Type: string
        jellyfin_role_web_url: "{{ lookup('role_web', role='jellyfin', scheme='https') }}"
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        jellyfin2_web_url: "{{ lookup('role_web', role='jellyfin', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`jellyfin_role_traefik_middleware_default_api`{ .sb-show-on-unchecked }`jellyfin2_traefik_middleware_default_api`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string
        jellyfin_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        jellyfin2_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`jellyfin_role_traefik_middleware_custom_api`{ .sb-show-on-unchecked }`jellyfin2_traefik_middleware_custom_api`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string
        jellyfin_role_traefik_middleware_custom_api: ""
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        jellyfin2_traefik_middleware_custom_api: ""
        ```
...
=== "Config"
    ...
    ??? variable list "`jellyfin_role_system_settings_list`{ .sb-show-on-unchecked }`jellyfin2_system_settings_list`{ .sb-show-on-checked }"
    ...
    ??? variable list "`jellyfin_role_network_settings_list`{ .sb-show-on-unchecked }`jellyfin2_network_settings_list`{ .sb-show-on-checked }"
...
=== "Docker"
    ...
    ??? variable bool "`jellyfin_role_docker_gpu_enabled`{ .sb-show-on-unchecked }`jellyfin2_docker_gpu_enabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        jellyfin_role_docker_gpu_enabled: true
        ```
        ...
        # This setting does not install or enable GPU support on the server.
        # Type: bool (true/false)
        jellyfin2_docker_gpu_enabled: true
        ```

    ??? variable bool "`jellyfin_role_docker_nvidia_disabled`{ .sb-show-on-unchecked }`jellyfin2_docker_nvidia_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        jellyfin_role_docker_nvidia_disabled: false
        ```
        ...
        # Automatic /dev/dri access may remain.
        # Type: bool (true/false)
        jellyfin2_docker_nvidia_disabled: false
        ```

    ??? variable bool "`jellyfin_role_docker_dev_dri_disabled`{ .sb-show-on-unchecked }`jellyfin2_docker_dev_dri_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        jellyfin_role_docker_dev_dri_disabled: false
        ```
        ...
        # NVIDIA-specific access may remain.
        # Type: bool (true/false)
        jellyfin2_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable list "`jellyfin_role_docker_volumes_default`{ .sb-show-on-unchecked }`jellyfin2_docker_volumes_default`{ .sb-show-on-checked }"
        ...
        jellyfin_role_docker_volumes_default:
          - "{{ lookup('role_var', '_paths_location', role='jellyfin') }}:/config:rw"
          - "{{ server_appdata_path }}/scripts:/scripts"
          - "/dev/shm:/dev/shm"
          - "{{ lookup('role_var', '_paths_transcodes_location', role='jellyfin') }}:/transcode"
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`jellyfin_role_docker_force_kill`{ .sb-show-on-unchecked }`jellyfin2_docker_force_kill`{ .sb-show-on-checked }"
    ...
    ??? variable string "`jellyfin_role_docker_stop_signal`{ .sb-show-on-unchecked }`jellyfin2_docker_stop_signal`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string
        jellyfin_role_docker_stop_signal:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        jellyfin2_docker_stop_signal:
        ```
    ...
    ??? variable list "`jellyfin_role_docker_entrypoint`{ .sb-show-on-unchecked }`jellyfin2_docker_entrypoint`{ .sb-show-on-checked }"
    ...
    ??? variable dict "`jellyfin_role_docker_sysctls`{ .sb-show-on-unchecked }`jellyfin2_docker_sysctls`{ .sb-show-on-checked }"
...
=== "Global Override Options"
    ...
    ??? variable list "`jellyfin_role_paths_folders_list_custom`{ .sb-show-on-unchecked }`jellyfin2_paths_folders_list_custom`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Extra directories to create
        # Type: list
        jellyfin_role_paths_folders_list_custom:
        ```

        ```yaml { .sb-show-on-checked }
        # Extra directories to create
        # Type: list
        jellyfin2_paths_folders_list_custom:
        ```

    ??? variable string "`jellyfin_role_paths_group`{ .sb-show-on-unchecked }`jellyfin2_paths_group`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Group for directories created by the role
        # Type: string
        jellyfin_role_paths_group:
        ```

        ```yaml { .sb-show-on-checked }
        # Group for directories created by the role
        # Type: string
        jellyfin2_paths_group:
        ```

    ??? variable string "`jellyfin_role_paths_owner`{ .sb-show-on-unchecked }`jellyfin2_paths_owner`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Owner for directories created by the role
        # Type: string
        jellyfin_role_paths_owner:
        ```

        ```yaml { .sb-show-on-checked }
        # Owner for directories created by the role
        # Type: string
        jellyfin2_paths_owner:
        ```

    ??? variable string "`jellyfin_role_paths_permissions`{ .sb-show-on-unchecked }`jellyfin2_paths_permissions`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Permissions for directories created by the role
        # Type: string
        jellyfin_role_paths_permissions:
        ```

        ```yaml { .sb-show-on-checked }
        # Permissions for directories created by the role
        # Type: string
        jellyfin2_paths_permissions:
        ```
    ...
    ??? variable list "`jellyfin_role_themepark_addons`{ .sb-show-on-unchecked }`jellyfin2_themepark_addons`{ .sb-show-on-checked }"
    ...
    ??? variable string "`jellyfin_role_web_api_http_port`{ .sb-show-on-unchecked }`jellyfin2_web_api_http_port`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string (quoted number)
        jellyfin_role_web_api_http_port:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string (quoted number)
        jellyfin2_web_api_http_port:
        ```

    ??? variable string "`jellyfin_role_web_api_http_scheme`{ .sb-show-on-unchecked }`jellyfin2_web_api_http_scheme`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string ("http"/"https")
        jellyfin_role_web_api_http_scheme:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string ("http"/"https")
        jellyfin2_web_api_http_scheme:
        ```

    ??? variable dict "`jellyfin_role_web_api_http_serverstransport`{ .sb-show-on-unchecked }`jellyfin2_web_api_http_serverstransport`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: dict/omit
        jellyfin_role_web_api_http_serverstransport:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: dict/omit
        jellyfin2_web_api_http_serverstransport:
        ```

    ??? variable string "`jellyfin_role_web_api_port`{ .sb-show-on-unchecked }`jellyfin2_web_api_port`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string (quoted number)
        jellyfin_role_web_api_port:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string (quoted number)
        jellyfin2_web_api_port:
        ```

    ??? variable string "`jellyfin_role_web_api_scheme`{ .sb-show-on-unchecked }`jellyfin2_web_api_scheme`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string ("http"/"https")
        jellyfin_role_web_api_scheme:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string ("http"/"https")
        jellyfin2_web_api_scheme:
        ```

    ??? variable dict "`jellyfin_role_web_api_serverstransport`{ .sb-show-on-unchecked }`jellyfin2_web_api_serverstransport`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: dict/omit
        jellyfin_role_web_api_serverstransport:
        ```
