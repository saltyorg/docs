...
=== "Traefik"
    ...
    ??? variable string "`nextcloud_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        nextcloud_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`nextcloud_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        nextcloud_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`nextcloud_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        nextcloud_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`nextcloud_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        nextcloud_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`nextcloud_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        nextcloud_role_docker_dev_dri_disabled: false
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`nextcloud_role_docker_networks_alias_custom`"

        ```yaml
        # Type: list
        nextcloud_role_docker_networks_alias_custom:
        ```
    ...
    ??? variable list "`nextcloud_role_paths_folders_list_custom`"
    ...
    ??? variable string "`nextcloud_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        nextcloud_role_paths_group:
        ```

    ??? variable string "`nextcloud_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        nextcloud_role_paths_owner:
        ```

    ??? variable string "`nextcloud_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        nextcloud_role_paths_permissions:
        ```

    ??? variable bool "`nextcloud_role_paths_recursive`"

        ```yaml
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        nextcloud_role_paths_recursive:
        ```
