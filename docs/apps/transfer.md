...
=== "Web"
    ...
    ??? variable string "`transfer_role_web_url`"
        ...
        ```yaml
        # Type: string
        transfer_role_web_url: "{{ lookup('role_web', role='transfer', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`transfer_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        transfer_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`transfer_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        transfer_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`transfer_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        transfer_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`transfer_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        transfer_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`transfer_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        transfer_role_docker_dev_dri_disabled: false
        ```
