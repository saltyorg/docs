...
=== "Global Override Options"
    ...
    ??? variable bool "`arr_db_role_traefik_middleware_http_api_insecure`"

        ```yaml
        # Type: bool (true/false)
        arr_db_role_traefik_middleware_http_api_insecure:
        ```

    ??? variable bool "`arr_db_role_traefik_middleware_http_insecure`"

        ```yaml
        # Type: bool (true/false)
        arr_db_role_traefik_middleware_http_insecure:
        ```
