...
1. In `rclone config`, create an 'sftp' remote to your Feederbox called `feeder` (Here is an [asciicast](https://asciinema.org/a/184084?t=0&speed=1&size=medium&cols=75&rows=25) video walking through the process).  THe gerneral process of creating an rclone remote is discussed [here](../../reference/guides/rclone-remote).
