...
def generate_issue_body(saltbox_missing: List[str], sandbox_missing: List[str], total_missing: int,
    ...
    body += "---\n\n"
    body += "### Example Inventory Sections\n\n"
    body += "See these documentation pages for examples of properly formatted inventory sections:\n\n"
    body += "- [Plex](docs/apps/plex.md#inventory)\n"
    body += "- [ruTorrent](docs/apps/rutorrent.md#inventory)\n\n"
