...
=== "Traefik"
    ...
    ??? variable string "`wikijs_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        wikijs_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`wikijs_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        wikijs_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`wikijs_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        wikijs_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`wikijs_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        wikijs_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`wikijs_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        wikijs_role_docker_dev_dri_disabled: false
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`wikijs_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        wikijs_role_paths_folders_list_custom:
        ```

    ??? variable string "`wikijs_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        wikijs_role_paths_group:
        ```

    ??? variable string "`wikijs_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        wikijs_role_paths_owner:
        ```

    ??? variable string "`wikijs_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        wikijs_role_paths_permissions:
        ```

    ??? variable bool "`wikijs_role_paths_recursive`"

        ```yaml
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        wikijs_role_paths_recursive:
        ```
