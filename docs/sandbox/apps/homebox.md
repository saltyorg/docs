...
=== "Web"
    ...
    ??? variable string "`homebox_role_web_url`"
        ...
        ```yaml
        # Type: string
        homebox_role_web_url: "{{ lookup('role_web', role='homebox', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`homebox_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        homebox_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`homebox_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        homebox_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`homebox_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        homebox_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`homebox_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        homebox_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`homebox_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        homebox_role_docker_dev_dri_disabled: false
        ```
