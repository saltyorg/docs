...
[:fontawesome-solid-book-open:**Manual**](https://wiki.bazarr.media){ .md-button .md-button--stretch }
...
1.  **This role supports multiple instances via `bazarr_instances`.**
    ...
    !!! example "Example override"
        ...
        === "Role-scoped"
            ...
            :material-arrow-right-bottom-bold: Applies to all instances of bazarr
        ...
        === "Instance-scoped"
            ...
            :material-arrow-right-bottom-bold: Applies to the instance named bazarr2
...
=== "Web"
    ...
    ??? variable string "`bazarr_role_web_url`{ .sb-show-on-unchecked }`bazarr2_web_url`{ .sb-show-on-checked }"
        ...
        ```yaml { .sb-show-on-unchecked }
        # Type: string
        bazarr_role_web_url: "{{ lookup('role_web', role='bazarr', scheme='https') }}"
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        bazarr2_web_url: "{{ lookup('role_web', role='bazarr', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`bazarr_role_traefik_middleware_default_api`{ .sb-show-on-unchecked }`bazarr2_traefik_middleware_default_api`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string
        bazarr_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        bazarr2_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`bazarr_role_traefik_middleware_custom_api`{ .sb-show-on-unchecked }`bazarr2_traefik_middleware_custom_api`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string
        bazarr_role_traefik_middleware_custom_api: ""
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        bazarr2_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`bazarr_role_docker_gpu_enabled`{ .sb-show-on-unchecked }`bazarr2_docker_gpu_enabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        bazarr_role_docker_gpu_enabled: false
        ```
        ...
        # This setting does not install or enable GPU support on the server.
        # Type: bool (true/false)
        bazarr2_docker_gpu_enabled: false
        ```

    ??? variable bool "`bazarr_role_docker_nvidia_disabled`{ .sb-show-on-unchecked }`bazarr2_docker_nvidia_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        bazarr_role_docker_nvidia_disabled: false
        ```
        ...
        # Automatic /dev/dri access may remain.
        # Type: bool (true/false)
        bazarr2_docker_nvidia_disabled: false
        ```

    ??? variable bool "`bazarr_role_docker_dev_dri_disabled`{ .sb-show-on-unchecked }`bazarr2_docker_dev_dri_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        bazarr_role_docker_dev_dri_disabled: false
        ```
        ...
        # NVIDIA-specific access may remain.
        # Type: bool (true/false)
        bazarr2_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`bazarr_role_docker_hosts_use_common`{ .sb-show-on-unchecked }`bazarr2_docker_hosts_use_common`{ .sb-show-on-checked }"
    ...
    ??? variable bool "`bazarr_role_docker_volumes_global`{ .sb-show-on-unchecked }`bazarr2_docker_volumes_global`{ .sb-show-on-checked }"
    ...
    ??? variable int "`bazarr_role_docker_create_timeout`{ .sb-show-on-unchecked }`bazarr2_docker_create_timeout`{ .sb-show-on-checked }"
    ...
    ??? variable bool "`bazarr_role_docker_labels_use_common`{ .sb-show-on-unchecked }`bazarr2_docker_labels_use_common`{ .sb-show-on-checked }"
...
=== "Global Override Options"
    ...
    ??? variable list "`bazarr_role_docker_networks_alias_custom`{ .sb-show-on-unchecked }`bazarr2_docker_networks_alias_custom`{ .sb-show-on-checked }"
    ...
    ??? variable list "`bazarr_role_paths_folders_list_custom`{ .sb-show-on-unchecked }`bazarr2_paths_folders_list_custom`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Extra directories to create
        # Type: list
        bazarr_role_paths_folders_list_custom:
        ```

        ```yaml { .sb-show-on-checked }
        # Extra directories to create
        # Type: list
        bazarr2_paths_folders_list_custom:
        ```

    ??? variable string "`bazarr_role_paths_group`{ .sb-show-on-unchecked }`bazarr2_paths_group`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Group for directories created by the role
        # Type: string
        bazarr_role_paths_group:
        ```
    ...
    ??? variable string "`bazarr_role_paths_owner`{ .sb-show-on-unchecked }`bazarr2_paths_owner`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Owner for directories created by the role
        # Type: string
        bazarr_role_paths_owner:
        ```
    ...
    ??? variable string "`bazarr_role_paths_permissions`{ .sb-show-on-unchecked }`bazarr2_paths_permissions`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Permissions for directories created by the role
        # Type: string
        bazarr_role_paths_permissions:
        ```

        ```yaml { .sb-show-on-checked }
        # Permissions for directories created by the role
        # Type: string
        bazarr2_paths_permissions:
        ```

    ??? variable bool "`bazarr_role_paths_recursive`{ .sb-show-on-unchecked }`bazarr2_paths_recursive`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        bazarr_role_paths_recursive:
        ```

        ```yaml { .sb-show-on-checked }
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        bazarr2_paths_recursive:
        ```

    ??? variable string "`bazarr_role_traefik_api_middleware_http`{ .sb-show-on-unchecked }`bazarr2_traefik_api_middleware_http`{ .sb-show-on-checked }"
    ...
    ??? variable string "`bazarr_role_traefik_middleware_http`{ .sb-show-on-unchecked }`bazarr2_traefik_middleware_http`{ .sb-show-on-checked }"
    ...
    ??? variable string "`bazarr_role_traefik_priority`{ .sb-show-on-unchecked }`bazarr2_traefik_priority`{ .sb-show-on-checked }"
    ...
    ??? variable string "`bazarr_role_web_api_http_port`{ .sb-show-on-unchecked }`bazarr2_web_api_http_port`{ .sb-show-on-checked }"
    ...
    ??? variable string "`bazarr_role_web_api_http_scheme`{ .sb-show-on-unchecked }`bazarr2_web_api_http_scheme`{ .sb-show-on-checked }"
    ...
    ??? variable dict "`bazarr_role_web_api_http_serverstransport`{ .sb-show-on-unchecked }`bazarr2_web_api_http_serverstransport`{ .sb-show-on-checked }"
    ...
    ??? variable string "`bazarr_role_web_api_port`{ .sb-show-on-unchecked }`bazarr2_web_api_port`{ .sb-show-on-checked }"
    ...
    ??? variable string "`bazarr_role_web_api_scheme`{ .sb-show-on-unchecked }`bazarr2_web_api_scheme`{ .sb-show-on-checked }"
    ...
    ??? variable dict "`bazarr_role_web_api_serverstransport`{ .sb-show-on-unchecked }`bazarr2_web_api_serverstransport`{ .sb-show-on-checked }"
    ...
    ??? variable string "`bazarr_role_web_http_port`{ .sb-show-on-unchecked }`bazarr2_web_http_port`{ .sb-show-on-checked }"
    ...
    ??? variable string "`bazarr_role_web_http_scheme`{ .sb-show-on-unchecked }`bazarr2_web_http_scheme`{ .sb-show-on-checked }"
