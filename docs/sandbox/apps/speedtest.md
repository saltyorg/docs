...
=== "Web"
    ...
    ??? variable string "`speedtest_role_web_url`"
        ...
        ```yaml
        # Type: string
        speedtest_role_web_url: "{{ lookup('role_web', role='speedtest', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`speedtest_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        speedtest_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`speedtest_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        speedtest_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`speedtest_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        speedtest_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`speedtest_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        speedtest_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`speedtest_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        speedtest_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable string "`speedtest_role_docker_stop_signal`"

        ```yaml
        # Type: string
        speedtest_role_docker_stop_signal:
        ```
    ...
    ??? variable list "`speedtest_role_docker_entrypoint`"
    ...
    ??? variable dict "`speedtest_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`speedtest_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        speedtest_role_paths_folders_list_custom:
        ```

    ??? variable string "`speedtest_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        speedtest_role_paths_group:
        ```

    ??? variable string "`speedtest_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        speedtest_role_paths_owner:
        ```

    ??? variable string "`speedtest_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        speedtest_role_paths_permissions:
        ```

    ??? variable bool "`speedtest_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        speedtest_role_paths_recursive:
        ```

    ??? variable list "`speedtest_role_themepark_addons`"
    ...
    ??? variable string "`speedtest_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        speedtest_role_web_api_http_port:
        ```

    ??? variable string "`speedtest_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        speedtest_role_web_api_http_scheme:
        ```

    ??? variable dict "`speedtest_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        speedtest_role_web_api_http_serverstransport:
        ```

    ??? variable string "`speedtest_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        speedtest_role_web_api_port:
        ```

    ??? variable string "`speedtest_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        speedtest_role_web_api_scheme:
        ```

    ??? variable dict "`speedtest_role_web_api_serverstransport`"
