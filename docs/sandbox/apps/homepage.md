...
saltbox_automation:
  app_links:
    - name: Manual
      ...
      purpose: manual
    - name: Releases
      url: https://github.com/gethomepage/homepage/pkgs/container/homepage
      type: releases
      purpose: release
    - name: Community
      url:
...
[:fontawesome-solid-book-open:**Manual**](https://gethomepage.dev/latest/configs){ .md-button .md-button--stretch }

[:fontawesome-solid-newspaper:**Releases**](https://github.com/gethomepage/homepage/pkgs/container/homepage){ .md-button .md-button--stretch }
...
=== "Web"
    ...
    ??? variable string "`homepage_role_web_url`"
        ...
        ```yaml
        # Type: string
        homepage_role_web_url: "{{ lookup('role_web', role='homepage', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`homepage_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        homepage_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`homepage_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        homepage_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`homepage_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        homepage_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`homepage_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        homepage_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`homepage_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        homepage_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`homepage_role_docker_force_kill`"
    ...
    ??? variable string "`homepage_role_docker_stop_signal`"

        ```yaml
        # Type: string
        homepage_role_docker_stop_signal:
        ```
    ...
    ??? variable list "`homepage_role_docker_entrypoint`"
    ...
    ??? variable dict "`homepage_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`homepage_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        homepage_role_paths_folders_list_custom:
        ```

    ??? variable string "`homepage_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        homepage_role_paths_group:
        ```

    ??? variable string "`homepage_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        homepage_role_paths_owner:
        ```

    ??? variable string "`homepage_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        homepage_role_paths_permissions:
        ```

    ??? variable bool "`homepage_role_paths_recursive`"

        ```yaml
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        homepage_role_paths_recursive:
        ```

    ??? variable list "`homepage_role_themepark_addons`"
    ...
    ??? variable string "`homepage_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        homepage_role_web_api_http_port:
        ```

    ??? variable string "`homepage_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        homepage_role_web_api_http_scheme:
        ```

    ??? variable dict "`homepage_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        homepage_role_web_api_http_serverstransport:
        ```

    ??? variable string "`homepage_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        homepage_role_web_api_port:
        ```

    ??? variable string "`homepage_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        homepage_role_web_api_scheme:
        ```

    ??? variable dict "`homepage_role_web_api_serverstransport`"
