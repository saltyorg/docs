...
=== "Docker+"
    ...
    ??? variable bool "`autoheal_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        autoheal_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`autoheal_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        autoheal_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`autoheal_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        autoheal_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`autoheal_role_docker_force_kill`"
    ...
    ??? variable list "`autoheal_role_docker_entrypoint`"
    ...
    ??? variable dict "`autoheal_role_docker_sysctls`"
