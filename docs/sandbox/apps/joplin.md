...
=== "Traefik"
    ...
    ??? variable string "`joplin_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        joplin_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`joplin_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        joplin_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`joplin_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        joplin_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`joplin_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        joplin_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`joplin_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        joplin_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable string "`joplin_role_docker_stop_signal`"

        ```yaml
        # Type: string
        joplin_role_docker_stop_signal:
        ```
...
=== "Global Override Options"
    ...
    ??? variable string "`joplin_role_web_api_http_port`"
    ...
    ??? variable string "`joplin_role_web_api_http_scheme`"
    ...
    ??? variable dict "`joplin_role_web_api_http_serverstransport`"
    ...
    ??? variable string "`joplin_role_web_api_port`"
    ...
    ??? variable string "`joplin_role_web_api_scheme`"
    ...
    ??? variable dict "`joplin_role_web_api_serverstransport`"
