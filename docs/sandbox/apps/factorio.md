...
=== "Docker+"
    ...
    ??? variable bool "`factorio_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        factorio_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`factorio_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        factorio_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`factorio_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        factorio_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`factorio_role_docker_force_kill`"
    ...
    ??? variable list "`factorio_role_docker_entrypoint`"
    ...
    ??? variable dict "`factorio_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`factorio_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        factorio_role_paths_folders_list_custom:
        ```

    ??? variable string "`factorio_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        factorio_role_paths_group:
        ```

    ??? variable string "`factorio_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        factorio_role_paths_owner:
        ```

    ??? variable string "`factorio_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        factorio_role_paths_permissions:
        ```

    ??? variable bool "`factorio_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        factorio_role_paths_recursive:
        ```
