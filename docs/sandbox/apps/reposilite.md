...
=== "Web"
    ...
    ??? variable string "`reposilite_role_web_url`"
        ...
        ```yaml
        # Type: string
        reposilite_role_web_url: "{{ lookup('role_web', role='reposilite', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`reposilite_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        reposilite_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`reposilite_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        reposilite_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`reposilite_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        reposilite_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`reposilite_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        reposilite_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`reposilite_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        reposilite_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable string "`reposilite_role_docker_stop_signal`"

        ```yaml
        # Type: string
        reposilite_role_docker_stop_signal:
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`reposilite_role_docker_networks_alias_custom`"

        ```yaml
        # Type: list
        reposilite_role_docker_networks_alias_custom:
        ```
    ...
    ??? variable list "`reposilite_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        reposilite_role_paths_folders_list_custom:
        ```

    ??? variable string "`reposilite_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        reposilite_role_paths_group:
        ```

    ??? variable string "`reposilite_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        reposilite_role_paths_owner:
        ```

    ??? variable string "`reposilite_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        reposilite_role_paths_permissions:
        ```
    ...
    ??? variable dict "`reposilite_role_web_http_serverstransport`"
    ...
    ??? variable dict "`reposilite_role_web_serverstransport`"
