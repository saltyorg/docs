...
=== "Global Override Options"
    ...
    ??? variable dict/omit "`apprise_role_traefik_api_endpoint`"
    ...
    ??? variable dict/omit "`apprise_role_web_http_serverstransport`"
    ...
    ??? variable dict/omit "`apprise_role_web_serverstransport`"
