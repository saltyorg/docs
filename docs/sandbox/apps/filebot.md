...
saltbox_automation:
  app_links:
    - name: Manual
      ...
      purpose: manual
    - name: Releases
      url: https://hub.docker.com/r/jlesage/filebot/tags
      type: docker
      purpose: release
    - name: Community
      url:
...
[:fontawesome-solid-book-open:**Manual**](https://www.filebot.net){ .md-button .md-button--stretch }
...
=== "Web"
    ...
    ??? variable string "`filebot_role_web_url`"
        ...
        ```yaml
        # Type: string
        filebot_role_web_url: "{{ lookup('role_web', role='filebot', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`filebot_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        filebot_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`filebot_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        filebot_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`filebot_role_docker_force_kill`"
    ...
    ??? variable string "`filebot_role_docker_stop_signal`"

        ```yaml
        # Type: string
        filebot_role_docker_stop_signal:
        ```
    ...
    ??? variable list "`filebot_role_docker_entrypoint`"
    ...
    ??? variable dict "`filebot_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`filebot_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        filebot_role_paths_folders_list_custom:
        ```

    ??? variable string "`filebot_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        filebot_role_paths_group:
        ```

    ??? variable string "`filebot_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        filebot_role_paths_owner:
        ```

    ??? variable string "`filebot_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        filebot_role_paths_permissions:
        ```

    ??? variable bool "`filebot_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        filebot_role_paths_recursive:
        ```

    ??? variable list "`filebot_role_themepark_addons`"
    ...
    ??? variable string "`filebot_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        filebot_role_web_api_http_port:
        ```

    ??? variable string "`filebot_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        filebot_role_web_api_http_scheme:
        ```

    ??? variable dict "`filebot_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        filebot_role_web_api_http_serverstransport:
        ```

    ??? variable string "`filebot_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        filebot_role_web_api_port:
        ```

    ??? variable string "`filebot_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        filebot_role_web_api_scheme:
        ```

    ??? variable dict "`filebot_role_web_api_serverstransport`"
