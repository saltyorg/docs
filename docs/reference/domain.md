...
=== "Non-Wildcard DNS"
   ...
   **Notes:**
   ...
   - For Cloudflare users.
      ...
      Note: if you provide a Cloudflare email and API Key in your settings, the Saltbox installer will set this up for you automatically.  See the tab to the right for details on getting this API Key.
...
=== "Automatic Cloudflare DNS"
   ...
   **Notes:**
   ...
   4. run the saltbox install, during which all the reqwuired subdomains will be created at Cloudflare for you
