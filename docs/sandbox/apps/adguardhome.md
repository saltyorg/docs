...
=== "Web"
    ...
    ??? variable string "`adguardhome_role_web_url`"
        ...
        ```yaml
        # Type: string
        adguardhome_role_web_url: "{{ lookup('role_web', role='adguardhome', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`adguardhome_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        adguardhome_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`adguardhome_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        adguardhome_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`adguardhome_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        adguardhome_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`adguardhome_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        adguardhome_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`adguardhome_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        adguardhome_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable string "`adguardhome_role_docker_stop_signal`"

        ```yaml
        # Type: string
        adguardhome_role_docker_stop_signal:
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`adguardhome_role_docker_networks_alias_custom`"

        ```yaml
        # Type: list
        adguardhome_role_docker_networks_alias_custom:
        ```
    ...
    ??? variable list "`adguardhome_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        adguardhome_role_paths_folders_list_custom:
        ```

    ??? variable string "`adguardhome_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        adguardhome_role_paths_group:
        ```

    ??? variable string "`adguardhome_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        adguardhome_role_paths_owner:
        ```

    ??? variable string "`adguardhome_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        adguardhome_role_paths_permissions:
        ```

    ??? variable bool "`adguardhome_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        adguardhome_role_paths_recursive:
        ```
    ...
    ??? variable string "`adguardhome_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        adguardhome_role_web_api_http_port:
        ```

    ??? variable string "`adguardhome_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        adguardhome_role_web_api_http_scheme:
        ```

    ??? variable dict "`adguardhome_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        adguardhome_role_web_api_http_serverstransport:
        ```

    ??? variable string "`adguardhome_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        adguardhome_role_web_api_port:
        ```

    ??? variable string "`adguardhome_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        adguardhome_role_web_api_scheme:
        ```

    ??? variable dict "`adguardhome_role_web_api_serverstransport`"

        ```yaml
        # Type: dict/omit
        adguardhome_role_web_api_serverstransport:
        ```
