...
saltbox_automation:
  app_links:
    - name: Manual
      ...
      type: documentation
    - name: Releases
      url: https://hub.docker.com/r/uping/embystat/tags
      type: docker
    - name: Community
      url:
      type: community
  project_description:
    name: EmbyStat
    summary: |-
      a personal web server that can calculate all kinds of statistics from your (local) Emby or Jellyfin server. Just install this on your server and let him calculate all kinds of fun stuff.
    link: https://github.com/mregni/EmbyStat/
---
...
[:fontawesome-solid-book-open:**Manual**](https://github.com/mregni/EmbyStat/wiki){ .md-button .md-button--stretch }
...
=== "Docker+"
    ...
    ??? variable string "`embystat_role_docker_stop_signal`"

        ```yaml
        # Type: string
        embystat_role_docker_stop_signal:
        ```
    ...
    ??? variable string "`embystat_role_docker_dev_dri`"

        ```yaml
        # Type: string
        embystat_role_docker_dev_dri:
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`embystat_role_docker_networks_alias_custom`"

        ```yaml
        # Type: list
        embystat_role_docker_networks_alias_custom:
        ```
