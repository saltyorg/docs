...
[:material-bookshelf:**Manual**](https://docs.puddletag.net/docs.html){ .md-button .md-button--stretch }
...
=== "Global Override Options"
    ...
    ??? variable dict/omit "`puddletag_role_traefik_api_endpoint`"
    ...
    ??? variable dict/omit "`puddletag_role_web_http_serverstransport`"
    ...
    ??? variable dict/omit "`puddletag_role_web_serverstransport`"
