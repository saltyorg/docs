...
=== "Docker+"
    ...
    ??? variable string "`gluetun_role_docker_nvidia`{ .sb-show-on-unchecked }`gluetun2_docker_nvidia`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string
        gluetun_role_docker_nvidia:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        gluetun2_docker_nvidia:
        ```
