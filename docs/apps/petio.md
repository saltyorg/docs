...
=== "Web"
    ...
    ??? variable string "`petio_role_web_url`"
        ...
        ```yaml
        # Type: string
        petio_role_web_url: "{{ lookup('role_web', role='petio', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`petio_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        petio_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`petio_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        petio_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker"
    ...
    ??? variable list "`petio_role_docker_volumes_default`"
        ...
        petio_role_docker_volumes_default:
          - "{{ lookup('role_var', '_paths_location', role='petio') }}:/app/api/config"
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`petio_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        petio_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`petio_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        petio_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`petio_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        petio_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`petio_role_docker_force_kill`"
    ...
    ??? variable string "`petio_role_docker_stop_signal`"

        ```yaml
        # Type: string
        petio_role_docker_stop_signal:
        ```
    ...
    ??? variable list "`petio_role_docker_entrypoint`"
    ...
    ??? variable dict "`petio_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`petio_role_docker_networks_alias_custom`"

        ```yaml
        # Type: list
        petio_role_docker_networks_alias_custom:
        ```
    ...
    ??? variable list "`petio_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        petio_role_paths_folders_list_custom:
        ```

    ??? variable string "`petio_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        petio_role_paths_group:
        ```

    ??? variable string "`petio_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        petio_role_paths_owner:
        ```

    ??? variable string "`petio_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        petio_role_paths_permissions:
        ```

    ??? variable bool "`petio_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        petio_role_paths_recursive:
        ```

    ??? variable list "`petio_role_themepark_addons`"
