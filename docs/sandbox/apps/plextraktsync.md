...
=== "Global Override Options"
    ...
    ??? variable list "`plextraktsync_role_paths_folders_list_custom`{ .sb-show-on-unchecked }`plextraktsync2_paths_folders_list_custom`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Extra directories to create
        # Type: list
        plextraktsync_role_paths_folders_list_custom:
        ```

        ```yaml { .sb-show-on-checked }
        # Extra directories to create
        # Type: list
        plextraktsync2_paths_folders_list_custom:
        ```

    ??? variable string "`plextraktsync_role_paths_group`{ .sb-show-on-unchecked }`plextraktsync2_paths_group`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Group for directories created by the role
        # Type: string
        plextraktsync_role_paths_group:
        ```

        ```yaml { .sb-show-on-checked }
        # Group for directories created by the role
        # Type: string
        plextraktsync2_paths_group:
        ```

    ??? variable string "`plextraktsync_role_paths_owner`{ .sb-show-on-unchecked }`plextraktsync2_paths_owner`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Owner for directories created by the role
        # Type: string
        plextraktsync_role_paths_owner:
        ```

        ```yaml { .sb-show-on-checked }
        # Owner for directories created by the role
        # Type: string
        plextraktsync2_paths_owner:
        ```

    ??? variable string "`plextraktsync_role_paths_permissions`{ .sb-show-on-unchecked }`plextraktsync2_paths_permissions`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Permissions for directories created by the role
        # Type: string
        plextraktsync_role_paths_permissions:
        ```

        ```yaml { .sb-show-on-checked }
        # Permissions for directories created by the role
        # Type: string
        plextraktsync2_paths_permissions:
        ```
