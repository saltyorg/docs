...
=== "Web"
    ...
    ??? variable string "`grimmory_role_web_url`"
        ...
        ```yaml
        # Type: string
        grimmory_role_web_url: "{{ lookup('role_web', role='grimmory', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`grimmory_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        grimmory_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`grimmory_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        grimmory_role_traefik_middleware_custom_api: ""
        ```
    ...
    ??? variable bool "`grimmory_role_traefik_api_enabled`"

        ```yaml
        # Type: bool (true/false)
        grimmory_role_traefik_api_enabled: false
        ```

    ??? variable string "`grimmory_role_traefik_api_endpoint`"
...
=== "Docker+"
    ...
    ??? variable bool "`grimmory_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        grimmory_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`grimmory_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        grimmory_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`grimmory_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        grimmory_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`grimmory_role_docker_force_kill`"
    ...
    ??? variable list "`grimmory_role_docker_entrypoint`"
    ...
    ??? variable dict "`grimmory_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`grimmory_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        grimmory_role_paths_folders_list_custom:
        ```

    ??? variable string "`grimmory_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        grimmory_role_paths_group:
        ```

    ??? variable string "`grimmory_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        grimmory_role_paths_owner:
        ```

    ??? variable string "`grimmory_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        grimmory_role_paths_permissions:
        ```

    ??? variable bool "`grimmory_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        grimmory_role_paths_recursive:
        ```

    ??? variable list "`grimmory_role_themepark_addons`"
