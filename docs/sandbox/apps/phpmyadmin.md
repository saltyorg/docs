...
=== "Docker+"
    ...
    ??? variable bool "`phpmyadmin_role_docker_force_kill`"
    ...
    ??? variable list "`phpmyadmin_role_docker_entrypoint`"
    ...
    ??? variable dict "`phpmyadmin_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`phpmyadmin_role_themepark_addons`"
