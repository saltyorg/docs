    ...
    ??? variable dict "`jellystat_role_postgres_docker_healthcheck`"
        ...
        jellystat_role_postgres_docker_healthcheck:
          test:
            ...
            - "pg_isready"
            - "-d"
            - "{{ lookup('role_var', '_postgres_docker_env_db', role='jellystat') }}"
            - "-U"
            - "{{ lookup('role_var', '_postgres_user', role='jellystat', default=lookup('role_var', '_docker_env_user', role='postgres'), default_if_empty=true) }}"
          start_period: 20s
          interval: 30s
          retries: 5
          timeout: 5s
...
=== "Web"
    ...
    ??? variable string "`jellystat_role_web_url`"
        ...
        ```yaml
        # Type: string
        jellystat_role_web_url: "{{ lookup('role_web', role='jellystat', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`jellystat_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        jellystat_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`jellystat_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        jellystat_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker"
    ...
    ??? variable dict "`jellystat_role_docker_envs_default`"
        ...
        jellystat_role_docker_envs_default:
          POSTGRES_USER: "{{ lookup('role_var', '_postgres_user', role='jellystat', default=lookup('role_var', '_docker_env_user', role='postgres'), default_if_empty=true) }}"
          POSTGRES_PASSWORD: "{{ lookup('role_var', '_postgres_password', role='jellystat', default=lookup('role_var', '_docker_env_password', role='postgres'), default_if_empty=true) }}"
...
=== "Docker+"
    ...
    ??? variable bool "`jellystat_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        jellystat_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`jellystat_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        jellystat_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`jellystat_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        jellystat_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`jellystat_role_docker_force_kill`"
    ...
    ??? variable list "`jellystat_role_docker_entrypoint`"
    ...
    ??? variable dict "`jellystat_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`jellystat_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        jellystat_role_paths_folders_list_custom:
        ```

    ??? variable string "`jellystat_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        jellystat_role_paths_group:
        ```

    ??? variable string "`jellystat_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        jellystat_role_paths_owner:
        ```

    ??? variable string "`jellystat_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        jellystat_role_paths_permissions:
        ```

    ??? variable bool "`jellystat_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        jellystat_role_paths_recursive:
        ```

    ??? variable list "`jellystat_role_themepark_addons`"
