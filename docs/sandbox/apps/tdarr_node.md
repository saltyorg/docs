...
=== "Docker"
    ...
    ??? variable bool "`tdarr_node_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        tdarr_node_role_docker_gpu_enabled: true
        ```

    ??? variable bool "`tdarr_node_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        tdarr_node_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`tdarr_node_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        tdarr_node_role_docker_dev_dri_disabled: false
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`tdarr_node_role_docker_force_kill`"
    ...
    ??? variable list "`tdarr_node_role_docker_entrypoint`"
    ...
    ??? variable dict "`tdarr_node_role_docker_sysctls`"
