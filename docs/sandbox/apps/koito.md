...
saltbox_automation:
  app_links:
    - name: Manual
      ...
      purpose: manual
    - name: Releases
      url: https://hub.docker.com/r/gabehf/koito/tags
      type: github
      purpose: release
    - name: Community
      url:
...
[:fontawesome-brands-github:**Releases**](https://hub.docker.com/r/gabehf/koito/tags){ .md-button .md-button--stretch }
...
=== "Traefik"
    ...
    ??? variable string "`koito_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        koito_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`koito_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        koito_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`koito_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        koito_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`koito_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        koito_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`koito_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        koito_role_docker_dev_dri_disabled: false
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`koito_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        koito_role_paths_folders_list_custom:
        ```

    ??? variable string "`koito_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        koito_role_paths_group:
        ```

    ??? variable string "`koito_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        koito_role_paths_owner:
        ```

    ??? variable string "`koito_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        koito_role_paths_permissions:
        ```

    ??? variable bool "`koito_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        koito_role_paths_recursive:
        ```
