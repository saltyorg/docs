...
=== "Web"
    ...
    ??? variable string "`code_server_role_web_url`"
        ...
        ```yaml
        # Type: string
        code_server_role_web_url: "{{ lookup('role_web', role='code_server', scheme='https') }}"
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`code_server_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        code_server_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`code_server_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        code_server_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`code_server_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        code_server_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable string "`code_server_role_docker_stop_signal`"

        ```yaml
        # Type: string
        code_server_role_docker_stop_signal:
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`code_server_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        code_server_role_paths_folders_list_custom:
        ```

    ??? variable string "`code_server_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        code_server_role_paths_group:
        ```

    ??? variable string "`code_server_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        code_server_role_paths_owner:
        ```

    ??? variable string "`code_server_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        code_server_role_paths_permissions:
        ```

    ??? variable bool "`code_server_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        code_server_role_paths_recursive:
        ```
    ...
    ??? variable string "`code_server_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        code_server_role_web_api_http_port:
        ```

    ??? variable string "`code_server_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        code_server_role_web_api_http_scheme:
        ```

    ??? variable dict "`code_server_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        code_server_role_web_api_http_serverstransport:
        ```

    ??? variable string "`code_server_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        code_server_role_web_api_port:
        ```

    ??? variable string "`code_server_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        code_server_role_web_api_scheme:
        ```

    ??? variable dict "`code_server_role_web_api_serverstransport`"
