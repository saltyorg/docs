...
saltbox_automation:
  app_links:
    - name: Manual
      ...
      purpose: manual
    - name: Releases
      url: https://github.com/we-promise/sure/pkgs/container/sure
      type: github
      purpose: release
    - name: Community
      url:
...
[:fontawesome-brands-github:**Releases**](https://github.com/we-promise/sure/pkgs/container/sure){ .md-button .md-button--stretch }
...
=== "Traefik"
    ...
    ??? variable string "`sure_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        sure_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`sure_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        sure_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`sure_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        sure_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`sure_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        sure_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`sure_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        sure_role_docker_dev_dri_disabled: false
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`sure_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        sure_role_paths_folders_list_custom:
        ```

    ??? variable string "`sure_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        sure_role_paths_group:
        ```

    ??? variable string "`sure_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        sure_role_paths_owner:
        ```

    ??? variable string "`sure_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        sure_role_paths_permissions:
        ```

    ??? variable bool "`sure_role_paths_recursive`"

        ```yaml
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        sure_role_paths_recursive:
        ```
