...
=== "Web"
    ...
    ??? variable string "`radarr_role_web_url`{ .sb-show-on-unchecked }`radarr2_web_url`{ .sb-show-on-checked }"
        ...
        ```yaml { .sb-show-on-unchecked }
        # Type: string
        radarr_role_web_url: "{{ lookup('role_web', role='radarr', scheme='https') }}"
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        radarr2_web_url: "{{ lookup('role_web', role='radarr', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`radarr_role_traefik_middleware_default_api`{ .sb-show-on-unchecked }`radarr2_traefik_middleware_default_api`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string
        radarr_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        radarr2_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`radarr_role_traefik_middleware_custom_api`{ .sb-show-on-unchecked }`radarr2_traefik_middleware_custom_api`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string
        radarr_role_traefik_middleware_custom_api: ""
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        radarr2_traefik_middleware_custom_api: ""
        ```
...
=== "Docker"
    ...
    ??? variable list "`radarr_role_docker_volumes_default`{ .sb-show-on-unchecked }`radarr2_docker_volumes_default`{ .sb-show-on-checked }"
        ...
        radarr_role_docker_volumes_default:
          - "{{ lookup('role_var', '_paths_location', role='radarr') }}:/config"
...
=== "Docker+"
    ...
    ??? variable bool "`radarr_role_docker_gpu_enabled`{ .sb-show-on-unchecked }`radarr2_docker_gpu_enabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        radarr_role_docker_gpu_enabled: false
        ```
        ...
        # This setting does not install or enable GPU support on the server.
        # Type: bool (true/false)
        radarr2_docker_gpu_enabled: false
        ```

    ??? variable bool "`radarr_role_docker_nvidia_disabled`{ .sb-show-on-unchecked }`radarr2_docker_nvidia_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        radarr_role_docker_nvidia_disabled: false
        ```
        ...
        # Automatic /dev/dri access may remain.
        # Type: bool (true/false)
        radarr2_docker_nvidia_disabled: false
        ```

    ??? variable bool "`radarr_role_docker_dev_dri_disabled`{ .sb-show-on-unchecked }`radarr2_docker_dev_dri_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        radarr_role_docker_dev_dri_disabled: false
        ```
        ...
        # NVIDIA-specific access may remain.
        # Type: bool (true/false)
        radarr2_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`radarr_role_docker_force_kill`{ .sb-show-on-unchecked }`radarr2_docker_force_kill`{ .sb-show-on-checked }"
    ...
    ??? variable string "`radarr_role_docker_stop_signal`{ .sb-show-on-unchecked }`radarr2_docker_stop_signal`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string
        radarr_role_docker_stop_signal:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        radarr2_docker_stop_signal:
        ```
    ...
    ??? variable list "`radarr_role_docker_entrypoint`{ .sb-show-on-unchecked }`radarr2_docker_entrypoint`{ .sb-show-on-checked }"
    ...
    ??? variable dict "`radarr_role_docker_sysctls`{ .sb-show-on-unchecked }`radarr2_docker_sysctls`{ .sb-show-on-checked }"
...
=== "Global Override Options"
    ...
    ??? variable list "`radarr_role_paths_folders_list_custom`{ .sb-show-on-unchecked }`radarr2_paths_folders_list_custom`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Extra directories to create
        # Type: list
        radarr_role_paths_folders_list_custom:
        ```

        ```yaml { .sb-show-on-checked }
        # Extra directories to create
        # Type: list
        radarr2_paths_folders_list_custom:
        ```

    ??? variable string "`radarr_role_paths_group`{ .sb-show-on-unchecked }`radarr2_paths_group`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Group for directories created by the role
        # Type: string
        radarr_role_paths_group:
        ```
    ...
    ??? variable string "`radarr_role_paths_owner`{ .sb-show-on-unchecked }`radarr2_paths_owner`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Owner for directories created by the role
        # Type: string
        radarr_role_paths_owner:
        ```
    ...
    ??? variable string "`radarr_role_paths_permissions`{ .sb-show-on-unchecked }`radarr2_paths_permissions`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Permissions for directories created by the role
        # Type: string
        radarr_role_paths_permissions:
        ```

        ```yaml { .sb-show-on-checked }
        # Permissions for directories created by the role
        # Type: string
        radarr2_paths_permissions:
        ```

    ??? variable bool "`radarr_role_paths_recursive`{ .sb-show-on-unchecked }`radarr2_paths_recursive`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        radarr_role_paths_recursive:
        ```

        ```yaml { .sb-show-on-checked }
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        radarr2_paths_recursive:
        ```
