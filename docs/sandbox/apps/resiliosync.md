...
=== "Web"
    ...
    ??? variable string "`resiliosync_role_web_url`"
        ...
        ```yaml
        # Type: string
        resiliosync_role_web_url: "{{ lookup('role_web', role='resiliosync', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`resiliosync_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        resiliosync_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`resiliosync_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        resiliosync_role_traefik_middleware_custom_api: ""
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`resiliosync_role_docker_networks_alias_custom`"

        ```yaml
        # Type: list
        resiliosync_role_docker_networks_alias_custom:
        ```
    ...
    ??? variable list "`resiliosync_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        resiliosync_role_paths_folders_list_custom:
        ```

    ??? variable string "`resiliosync_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        resiliosync_role_paths_group:
        ```

    ??? variable string "`resiliosync_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        resiliosync_role_paths_owner:
        ```

    ??? variable string "`resiliosync_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        resiliosync_role_paths_permissions:
        ```

    ??? variable bool "`resiliosync_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        resiliosync_role_paths_recursive:
        ```
    ...
    ??? variable string "`resiliosync_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        resiliosync_role_web_api_http_port:
        ```

    ??? variable string "`resiliosync_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        resiliosync_role_web_api_http_scheme:
        ```

    ??? variable dict "`resiliosync_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        resiliosync_role_web_api_http_serverstransport:
        ```

    ??? variable string "`resiliosync_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        resiliosync_role_web_api_port:
        ```

    ??? variable string "`resiliosync_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        resiliosync_role_web_api_scheme:
        ```

    ??? variable dict "`resiliosync_role_web_api_serverstransport`"

        ```yaml
        # Type: dict/omit
        resiliosync_role_web_api_serverstransport:
        ```
