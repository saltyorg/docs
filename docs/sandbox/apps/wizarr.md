...
=== "Docker+"
    ...
    ??? variable string "`wizarr_role_docker_force_kill`{ .sb-show-on-unchecked }`wizarr2_docker_force_kill`{ .sb-show-on-checked }"
    ...
    ??? variable string "`wizarr_role_docker_entrypoint`{ .sb-show-on-unchecked }`wizarr2_docker_entrypoint`{ .sb-show-on-checked }"
    ...
    ??? variable list "`wizarr_role_docker_sysctls`{ .sb-show-on-unchecked }`wizarr2_docker_sysctls`{ .sb-show-on-checked }"
...
=== "Global Override Options"
    ...
    ??? variable string "`wizarr_role_themepark_addons`{ .sb-show-on-unchecked }`wizarr2_themepark_addons`{ .sb-show-on-checked }"
