...
=== "Web"
    ...
    ??? variable string "`gitea_role_web_url`"
        ...
        ```yaml
        # Type: string
        gitea_role_web_url: "{{ lookup('role_web', role='gitea', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`gitea_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        gitea_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`gitea_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        gitea_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`gitea_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        gitea_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`gitea_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        gitea_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`gitea_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        gitea_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable string "`gitea_role_docker_stop_signal`"

        ```yaml
        # Type: string
        gitea_role_docker_stop_signal:
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`gitea_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        gitea_role_paths_folders_list_custom:
        ```

    ??? variable string "`gitea_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        gitea_role_paths_group:
        ```

    ??? variable string "`gitea_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        gitea_role_paths_owner:
        ```

    ??? variable string "`gitea_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        gitea_role_paths_permissions:
        ```
    ...
    ??? variable string "`gitea_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        gitea_role_web_api_http_port:
        ```

    ??? variable string "`gitea_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        gitea_role_web_api_http_scheme:
        ```

    ??? variable dict "`gitea_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        gitea_role_web_api_http_serverstransport:
        ```

    ??? variable string "`gitea_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        gitea_role_web_api_port:
        ```

    ??? variable string "`gitea_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        gitea_role_web_api_scheme:
        ```

    ??? variable dict "`gitea_role_web_api_serverstransport`"
