...
=== "Settings"
    ...
    ??? variable string "`unifi_network_application_mongodb_role_docker_image_tag`"

        ```yaml
        # Type: string
        unifi_network_application_mongodb_role_docker_image_tag: "8.0"
        ```
...
=== "Web"
    ...
    ??? variable string "`unifi_network_application_role_web_url`"
        ...
        ```yaml
        # Type: string
        unifi_network_application_role_web_url: "{{ lookup('role_web', role='unifi_network_application', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`unifi_network_application_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        unifi_network_application_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`unifi_network_application_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        unifi_network_application_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker"
    ...
    ??? variable list "`unifi_network_application_role_docker_volumes_default`"
        ...
        unifi_network_application_role_docker_volumes_default:
          - "{{ lookup('role_var', '_paths_location', role='unifi_network_application') }}:/config"
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`unifi_network_application_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        unifi_network_application_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`unifi_network_application_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        unifi_network_application_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`unifi_network_application_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        unifi_network_application_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`unifi_network_application_role_docker_force_kill`"
    ...
    ??? variable list "`unifi_network_application_role_docker_entrypoint`"
    ...
    ??? variable dict "`unifi_network_application_role_docker_sysctls`"
