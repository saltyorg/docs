...
=== "Global Override Options"
    ...
    ??? variable string "`plex_utills_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        plex_utills_role_web_api_http_port:
        ```

    ??? variable string "`plex_utills_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        plex_utills_role_web_api_http_scheme:
        ```

    ??? variable dict "`plex_utills_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        plex_utills_role_web_api_http_serverstransport:
        ```

    ??? variable string "`plex_utills_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        plex_utills_role_web_api_port:
        ```

    ??? variable string "`plex_utills_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        plex_utills_role_web_api_scheme:
        ```

    ??? variable dict "`plex_utills_role_web_api_serverstransport`"
