...
- To access Yourspotify, visit <https://spotify.iYOUR_DOMAIN_NAMEi>
...
=== "Docker+"
    ...
    ??? variable string "`your_spotify_role_docker_devices_default`"

        ```yaml
        # Type: string
        your_spotify_role_docker_devices_default:
        ```
