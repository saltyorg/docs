...
=== "Web"
    ...
    ??? variable string "`prowlarr_role_web_url`"
        ...
        ```yaml
        # Type: string
        prowlarr_role_web_url: "{{ lookup('role_web', role='prowlarr', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`prowlarr_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        prowlarr_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`prowlarr_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        prowlarr_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`prowlarr_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        prowlarr_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`prowlarr_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        prowlarr_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`prowlarr_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        prowlarr_role_docker_dev_dri_disabled: false
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`prowlarr_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        prowlarr_role_paths_folders_list_custom:
        ```

    ??? variable string "`prowlarr_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        prowlarr_role_paths_group:
        ```

    ??? variable string "`prowlarr_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        prowlarr_role_paths_owner:
        ```

    ??? variable string "`prowlarr_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        prowlarr_role_paths_permissions:
        ```

    ??? variable bool "`prowlarr_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        prowlarr_role_paths_recursive:
        ```
    ...
    ??? variable string "`prowlarr_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        prowlarr_role_web_api_http_port:
        ```

    ??? variable string "`prowlarr_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        prowlarr_role_web_api_http_scheme:
        ```

    ??? variable dict "`prowlarr_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        prowlarr_role_web_api_http_serverstransport:
        ```

    ??? variable string "`prowlarr_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        prowlarr_role_web_api_port:
        ```

    ??? variable string "`prowlarr_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        prowlarr_role_web_api_scheme:
        ```

    ??? variable dict "`prowlarr_role_web_api_serverstransport`"
