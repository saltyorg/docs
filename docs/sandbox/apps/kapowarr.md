...
saltbox_automation:
  app_links:
    - name: Manual
      ...
      purpose: manual
    - name: Releases
      url: https://hub.docker.com/r/mrcas/kapowarr/tags
      type: github
      purpose: release
    - name: Community
      url:
...
[:fontawesome-brands-github:**Releases**](https://hub.docker.com/r/mrcas/kapowarr/tags){ .md-button .md-button--stretch }
...
=== "Web"
    ...
    ??? variable string "`kapowarr_role_web_url`"
        ...
        ```yaml
        # Type: string
        kapowarr_role_web_url: "{{ lookup('role_web', role='kapowarr', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`kapowarr_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        kapowarr_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`kapowarr_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        kapowarr_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`kapowarr_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        kapowarr_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`kapowarr_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        kapowarr_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`kapowarr_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        kapowarr_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`kapowarr_role_docker_force_kill`"
    ...
    ??? variable list "`kapowarr_role_docker_entrypoint`"
    ...
    ??? variable dict "`kapowarr_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`kapowarr_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        kapowarr_role_paths_folders_list_custom:
        ```

    ??? variable string "`kapowarr_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        kapowarr_role_paths_group:
        ```

    ??? variable string "`kapowarr_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        kapowarr_role_paths_owner:
        ```

    ??? variable string "`kapowarr_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        kapowarr_role_paths_permissions:
        ```

    ??? variable bool "`kapowarr_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        kapowarr_role_paths_recursive:
        ```

    ??? variable list "`kapowarr_role_themepark_addons`"
