...
=== "Web"
    ...
    ??? variable string "`firefox_role_web_url`"
        ...
        ```yaml
        # Type: string
        firefox_role_web_url: "{{ lookup('role_web', role='firefox', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`firefox_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        firefox_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`firefox_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        firefox_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker"
    ...
    ??? variable bool "`firefox_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        firefox_role_docker_gpu_enabled: true
        ```

    ??? variable bool "`firefox_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        firefox_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`firefox_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        firefox_role_docker_dev_dri_disabled: false
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`firefox_role_docker_force_kill`"
    ...
    ??? variable list "`firefox_role_docker_entrypoint`"
    ...
    ??? variable dict "`firefox_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`firefox_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        firefox_role_paths_folders_list_custom:
        ```

    ??? variable string "`firefox_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        firefox_role_paths_group:
        ```

    ??? variable string "`firefox_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        firefox_role_paths_owner:
        ```

    ??? variable string "`firefox_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        firefox_role_paths_permissions:
        ```

    ??? variable bool "`firefox_role_paths_recursive`"

        ```yaml
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        firefox_role_paths_recursive:
        ```

    ??? variable list "`firefox_role_themepark_addons`"
    ...
    ??? variable string "`firefox_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        firefox_role_web_api_http_port:
        ```

    ??? variable string "`firefox_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        firefox_role_web_api_http_scheme:
        ```

    ??? variable dict "`firefox_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        firefox_role_web_api_http_serverstransport:
        ```

    ??? variable string "`firefox_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        firefox_role_web_api_port:
        ```

    ??? variable string "`firefox_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        firefox_role_web_api_scheme:
        ```

    ??? variable dict "`firefox_role_web_api_serverstransport`"
    ...
    ??? variable dict "`firefox_role_web_http_serverstransport`"
    ...
    ??? variable dict "`firefox_role_web_serverstransport`"
