...
=== "Web"
    ...
    ??? variable string "`tdarr_role_web_url`"
        ...
        ```yaml
        # Type: string
        tdarr_role_web_url: "{{ lookup('role_web', role='tdarr', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`tdarr_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        tdarr_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`tdarr_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        tdarr_role_traefik_middleware_custom_api: ""
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`tdarr_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        tdarr_role_paths_folders_list_custom:
        ```

    ??? variable string "`tdarr_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        tdarr_role_paths_group:
        ```

    ??? variable string "`tdarr_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        tdarr_role_paths_owner:
        ```

    ??? variable string "`tdarr_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        tdarr_role_paths_permissions:
        ```

    ??? variable bool "`tdarr_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        tdarr_role_paths_recursive:
        ```
    ...
    ??? variable string "`tdarr_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        tdarr_role_web_api_http_port:
        ```

    ??? variable string "`tdarr_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        tdarr_role_web_api_http_scheme:
        ```

    ??? variable dict "`tdarr_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        tdarr_role_web_api_http_serverstransport:
        ```

    ??? variable string "`tdarr_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        tdarr_role_web_api_port:
        ```

    ??? variable string "`tdarr_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        tdarr_role_web_api_scheme:
        ```

    ??? variable dict "`tdarr_role_web_api_serverstransport`"
