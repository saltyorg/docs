...
=== "Docker+"
    ...
    ??? variable string "`fireflyiii_role_docker_devices_default`"

        ```yaml
        # Type: string
        fireflyiii_role_docker_devices_default:
        ```
...
=== "Global Override Options"
    ...
    ??? variable string "`fireflyiii_role_docker_image_repo`"
        ...
        ```yaml
        # Type: string
        fireflyiii_role_docker_image_repo:
        ```
    ...
    ??? variable string "`fireflyiii_role_docker_image_tag`"
        ...
        ```yaml
        # Type: string
        fireflyiii_role_docker_image_tag:
        ```
    ...
    ??? variable string "`fireflyiii_role_paths_location`"
        ...
        ```yaml
        # Type: string
        fireflyiii_role_paths_location:
        ```
    ...
    ??? variable dict "`fireflyiii_role_traefik_api_endpoint`"

        ```yaml
        # Type: dict/omit
        fireflyiii_role_traefik_api_endpoint:
        ```
    ...
    ??? variable string "`fireflyiii_role_traefik_certresolver`"
        ...
        ```yaml
        # Type: string
        fireflyiii_role_traefik_certresolver:
        ```
