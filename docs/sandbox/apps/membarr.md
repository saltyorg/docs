...
=== "Docker+"
    ...
    ??? variable bool "`membarr_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        membarr_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`membarr_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        membarr_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`membarr_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        membarr_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable string "`membarr_role_docker_stop_signal`"

        ```yaml
        # Type: string
        membarr_role_docker_stop_signal:
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`membarr_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        membarr_role_paths_folders_list_custom:
        ```

    ??? variable string "`membarr_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        membarr_role_paths_group:
        ```

    ??? variable string "`membarr_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        membarr_role_paths_owner:
        ```

    ??? variable string "`membarr_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        membarr_role_paths_permissions:
        ```
