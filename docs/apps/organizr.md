...
=== "Web"
    ...
    ??? variable string "`organizr_role_web_url`"
        ...
        ```yaml
        # Type: string
        organizr_role_web_url: "{{ lookup('role_web', role='organizr', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`organizr_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        organizr_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`organizr_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        organizr_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`organizr_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        organizr_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`organizr_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        organizr_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`organizr_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        organizr_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable string "`organizr_role_docker_stop_signal`"

        ```yaml
        # Type: string
        organizr_role_docker_stop_signal:
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`organizr_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        organizr_role_paths_folders_list_custom:
        ```

    ??? variable string "`organizr_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        organizr_role_paths_group:
        ```

    ??? variable string "`organizr_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        organizr_role_paths_owner:
        ```

    ??? variable string "`organizr_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        organizr_role_paths_permissions:
        ```

    ??? variable bool "`organizr_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        organizr_role_paths_recursive:
        ```
    ...
    ??? variable string "`organizr_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        organizr_role_web_api_http_port:
        ```

    ??? variable string "`organizr_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        organizr_role_web_api_http_scheme:
        ```

    ??? variable dict "`organizr_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        organizr_role_web_api_http_serverstransport:
        ```

    ??? variable string "`organizr_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        organizr_role_web_api_port:
        ```

    ??? variable string "`organizr_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        organizr_role_web_api_scheme:
        ```

    ??? variable dict "`organizr_role_web_api_serverstransport`"
