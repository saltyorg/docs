...
=== "Web"
    ...
    ??? variable string "`openobserve_role_web_url`"
        ...
        ```yaml
        # Type: string
        openobserve_role_web_url: "{{ lookup('role_web', role='openobserve', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`openobserve_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        openobserve_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`openobserve_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        openobserve_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`openobserve_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        openobserve_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`openobserve_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        openobserve_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`openobserve_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        openobserve_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`openobserve_role_docker_force_kill`"
    ...
    ??? variable list "`openobserve_role_docker_entrypoint`"
    ...
    ??? variable dict "`openobserve_role_docker_sysctls`"
