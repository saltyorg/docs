...
=== "Global Override Options"
    ...
    ??? variable bool "`gotenberg_role_dns_enabled`"
    ...
    ??? variable bool "`gotenberg_role_traefik_crowdsec_enabled`"
    ...
    ??? variable bool "`gotenberg_role_traefik_error_pages_enabled`"
    ...
    ??? variable bool "`gotenberg_role_traefik_gzip_enabled`"
    ...
    ??? variable bool "`gotenberg_role_traefik_tailscale_enabled`"
    ...
    ??? variable bool "`gotenberg_role_traefik_wildcard_enabled`"
    ...
    ??? variable list "`gotenberg_role_web_fqdn_override`"
    ...
    ??? variable string "`gotenberg_role_web_host_override`"
    ...
    ??? variable string "`gotenberg_role_web_scheme`"
