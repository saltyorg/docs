...
1.  **This role supports multiple instances via `qui_instances`.**
    ...
    !!! example "Example override"
        ...
        === "Role-scoped"
            ...
            :material-arrow-right-bottom-bold: Applies to all instances of qui
        ...
        === "Instance-scoped"
            ...
            :material-arrow-right-bottom-bold: Applies to the instance named qui2
...
=== "Web"
    ...
    ??? variable string "`qui_role_web_url`{ .sb-show-on-unchecked }`qui2_web_url`{ .sb-show-on-checked }"
        ...
        ```yaml { .sb-show-on-unchecked }
        # Type: string
        qui_role_web_url: "{{ lookup('role_web', role='qui', scheme='https') }}"
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        qui2_web_url: "{{ lookup('role_web', role='qui', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`qui_role_traefik_middleware_default_api`{ .sb-show-on-unchecked }`qui2_traefik_middleware_default_api`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string
        qui_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        qui2_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`qui_role_traefik_middleware_custom_api`{ .sb-show-on-unchecked }`qui2_traefik_middleware_custom_api`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string
        qui_role_traefik_middleware_custom_api: ""
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        qui2_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`qui_role_docker_gpu_enabled`{ .sb-show-on-unchecked }`qui2_docker_gpu_enabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        qui_role_docker_gpu_enabled: false
        ```
        ...
        # This setting does not install or enable GPU support on the server.
        # Type: bool (true/false)
        qui2_docker_gpu_enabled: false
        ```

    ??? variable bool "`qui_role_docker_nvidia_disabled`{ .sb-show-on-unchecked }`qui2_docker_nvidia_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        qui_role_docker_nvidia_disabled: false
        ```
        ...
        # Automatic /dev/dri access may remain.
        # Type: bool (true/false)
        qui2_docker_nvidia_disabled: false
        ```

    ??? variable bool "`qui_role_docker_dev_dri_disabled`{ .sb-show-on-unchecked }`qui2_docker_dev_dri_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        qui_role_docker_dev_dri_disabled: false
        ```
        ...
        # NVIDIA-specific access may remain.
        # Type: bool (true/false)
        qui2_docker_dev_dri_disabled: false
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`qui_role_paths_folders_list_custom`{ .sb-show-on-unchecked }`qui2_paths_folders_list_custom`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Extra directories to create
        # Type: list
        qui_role_paths_folders_list_custom:
        ```

        ```yaml { .sb-show-on-checked }
        # Extra directories to create
        # Type: list
        qui2_paths_folders_list_custom:
        ```

    ??? variable string "`qui_role_paths_group`{ .sb-show-on-unchecked }`qui2_paths_group`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Group for directories created by the role
        # Type: string
        qui_role_paths_group:
        ```
    ...
    ??? variable string "`qui_role_paths_owner`{ .sb-show-on-unchecked }`qui2_paths_owner`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Owner for directories created by the role
        # Type: string
        qui_role_paths_owner:
        ```
    ...
    ??? variable string "`qui_role_paths_permissions`{ .sb-show-on-unchecked }`qui2_paths_permissions`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Permissions for directories created by the role
        # Type: string
        qui_role_paths_permissions:
        ```

        ```yaml { .sb-show-on-checked }
        # Permissions for directories created by the role
        # Type: string
        qui2_paths_permissions:
        ```

    ??? variable bool "`qui_role_paths_recursive`{ .sb-show-on-unchecked }`qui2_paths_recursive`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        qui_role_paths_recursive:
        ```

        ```yaml { .sb-show-on-checked }
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        qui2_paths_recursive:
        ```
    ...
    ??? variable string "`qui_role_web_api_http_port`{ .sb-show-on-unchecked }`qui2_web_api_http_port`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string (quoted number)
        qui_role_web_api_http_port:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string (quoted number)
        qui2_web_api_http_port:
        ```

    ??? variable string "`qui_role_web_api_http_scheme`{ .sb-show-on-unchecked }`qui2_web_api_http_scheme`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string ("http"/"https")
        qui_role_web_api_http_scheme:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string ("http"/"https")
        qui2_web_api_http_scheme:
        ```

    ??? variable dict "`qui_role_web_api_http_serverstransport`{ .sb-show-on-unchecked }`qui2_web_api_http_serverstransport`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: dict/omit
        qui_role_web_api_http_serverstransport:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: dict/omit
        qui2_web_api_http_serverstransport:
        ```

    ??? variable string "`qui_role_web_api_port`{ .sb-show-on-unchecked }`qui2_web_api_port`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string (quoted number)
        qui_role_web_api_port:
        ```
    ...
    ??? variable string "`qui_role_web_api_scheme`{ .sb-show-on-unchecked }`qui2_web_api_scheme`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string ("http"/"https")
        qui_role_web_api_scheme:
        ```
    ...
    ??? variable dict "`qui_role_web_api_serverstransport`{ .sb-show-on-unchecked }`qui2_web_api_serverstransport`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: dict/omit
        qui_role_web_api_serverstransport:
        ```
