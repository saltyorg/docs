...
=== "Web"
    ...
    ??? variable string "`photoprism_role_web_url`"
        ...
        ```yaml
        # Type: string
        photoprism_role_web_url: "{{ lookup('role_web', role='photoprism', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`photoprism_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        photoprism_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`photoprism_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        photoprism_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker"
    ...
    ??? variable bool "`photoprism_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        photoprism_role_docker_gpu_enabled: true
        ```

    ??? variable bool "`photoprism_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        photoprism_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`photoprism_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        photoprism_role_docker_dev_dri_disabled: false
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`photoprism_role_docker_force_kill`"
    ...
    ??? variable list "`photoprism_role_docker_entrypoint`"
    ...
    ??? variable dict "`photoprism_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`photoprism_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        photoprism_role_paths_folders_list_custom:
        ```

    ??? variable string "`photoprism_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        photoprism_role_paths_group:
        ```

    ??? variable string "`photoprism_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        photoprism_role_paths_owner:
        ```

    ??? variable string "`photoprism_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        photoprism_role_paths_permissions:
        ```

    ??? variable bool "`photoprism_role_paths_recursive`"

        ```yaml
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        photoprism_role_paths_recursive:
        ```

    ??? variable list "`photoprism_role_themepark_addons`"
    ...
    ??? variable string "`photoprism_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        photoprism_role_web_api_http_port:
        ```

    ??? variable string "`photoprism_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        photoprism_role_web_api_http_scheme:
        ```

    ??? variable dict "`photoprism_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        photoprism_role_web_api_http_serverstransport:
        ```

    ??? variable string "`photoprism_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        photoprism_role_web_api_port:
        ```

    ??? variable string "`photoprism_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        photoprism_role_web_api_scheme:
        ```

    ??? variable dict "`photoprism_role_web_api_serverstransport`"
