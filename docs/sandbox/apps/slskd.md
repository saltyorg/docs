...
=== "Web"
    ...
    ??? variable string "`slskd_role_web_url`"
        ...
        ```yaml
        # Type: string
        slskd_role_web_url: "{{ lookup('role_web', role='slskd', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`slskd_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        slskd_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`slskd_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        slskd_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`slskd_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        slskd_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`slskd_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        slskd_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`slskd_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        slskd_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`slskd_role_docker_force_kill`"
    ...
    ??? variable list "`slskd_role_docker_entrypoint`"
    ...
    ??? variable dict "`slskd_role_docker_sysctls`"
