...
=== "Web"
    ...
    ??? variable string "`olivetin_role_web_url`"
        ...
        ```yaml
        # Type: string
        olivetin_role_web_url: "{{ lookup('role_web', role='olivetin', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`olivetin_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        olivetin_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`olivetin_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        olivetin_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`olivetin_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        olivetin_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`olivetin_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        olivetin_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`olivetin_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        olivetin_role_docker_dev_dri_disabled: false
        ```
...
=== "Global Override Options"
    ...
    ??? variable string "`olivetin_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        olivetin_role_web_api_http_port:
        ```

    ??? variable string "`olivetin_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        olivetin_role_web_api_http_scheme:
        ```

    ??? variable dict "`olivetin_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        olivetin_role_web_api_http_serverstransport:
        ```

    ??? variable string "`olivetin_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        olivetin_role_web_api_port:
        ```

    ??? variable string "`olivetin_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        olivetin_role_web_api_scheme:
        ```

    ??? variable dict "`olivetin_role_web_api_serverstransport`"
