...
1.  **This role supports multiple instances via `wizarr_instances`.**
    ...
    !!! example "Example override"
        ...
        === "Role-scoped"
            ...
            :material-arrow-right-bottom-bold: Applies to all instances of wizarr
        ...
        === "Instance-scoped"
            ...
            :material-arrow-right-bottom-bold: Applies to the instance named wizarr2
...
=== "Web"
    ...
    ??? variable string "`wizarr_role_web_url`{ .sb-show-on-unchecked }`wizarr2_web_url`{ .sb-show-on-checked }"
        ...
        ```yaml { .sb-show-on-unchecked }
        # Type: string
        wizarr_role_web_url: "{{ lookup('role_web', role='wizarr', scheme='https') }}"
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        wizarr2_web_url: "{{ lookup('role_web', role='wizarr', scheme='https') }}"
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`wizarr_role_docker_gpu_enabled`{ .sb-show-on-unchecked }`wizarr2_docker_gpu_enabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        wizarr_role_docker_gpu_enabled: false
        ```
        ...
        # This setting does not install or enable GPU support on the server.
        # Type: bool (true/false)
        wizarr2_docker_gpu_enabled: false
        ```

    ??? variable bool "`wizarr_role_docker_nvidia_disabled`{ .sb-show-on-unchecked }`wizarr2_docker_nvidia_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        wizarr_role_docker_nvidia_disabled: false
        ```
        ...
        # Automatic /dev/dri access may remain.
        # Type: bool (true/false)
        wizarr2_docker_nvidia_disabled: false
        ```

    ??? variable bool "`wizarr_role_docker_dev_dri_disabled`{ .sb-show-on-unchecked }`wizarr2_docker_dev_dri_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        wizarr_role_docker_dev_dri_disabled: false
        ```
        ...
        # NVIDIA-specific access may remain.
        # Type: bool (true/false)
        wizarr2_docker_dev_dri_disabled: false
        ```

    <h5>Resource Limits</h5>

    ??? variable int "`wizarr_role_docker_blkio_weight`{ .sb-show-on-unchecked }`wizarr2_docker_blkio_weight`{ .sb-show-on-checked }"
    ...
    ??? variable int "`wizarr_role_docker_cpu_period`{ .sb-show-on-unchecked }`wizarr2_docker_cpu_period`{ .sb-show-on-checked }"
    ...
    ??? variable int "`wizarr_role_docker_cpu_quota`{ .sb-show-on-unchecked }`wizarr2_docker_cpu_quota`{ .sb-show-on-checked }"
    ...
    ??? variable int "`wizarr_role_docker_cpu_shares`{ .sb-show-on-unchecked }`wizarr2_docker_cpu_shares`{ .sb-show-on-checked }"
    ...
    ??? variable string "`wizarr_role_docker_cpus`{ .sb-show-on-unchecked }`wizarr2_docker_cpus`{ .sb-show-on-checked }"
    ...
    ??? variable string "`wizarr_role_docker_cpuset_cpus`{ .sb-show-on-unchecked }`wizarr2_docker_cpuset_cpus`{ .sb-show-on-checked }"
    ...
    ??? variable string "`wizarr_role_docker_cpuset_mems`{ .sb-show-on-unchecked }`wizarr2_docker_cpuset_mems`{ .sb-show-on-checked }"
    ...
    ??? variable string "`wizarr_role_docker_kernel_memory`{ .sb-show-on-unchecked }`wizarr2_docker_kernel_memory`{ .sb-show-on-checked }"
    ...
    ??? variable string "`wizarr_role_docker_memory`{ .sb-show-on-unchecked }`wizarr2_docker_memory`{ .sb-show-on-checked }"
    ...
    ??? variable string "`wizarr_role_docker_memory_reservation`{ .sb-show-on-unchecked }`wizarr2_docker_memory_reservation`{ .sb-show-on-checked }"
    ...
    ??? variable string "`wizarr_role_docker_memory_swap`{ .sb-show-on-unchecked }`wizarr2_docker_memory_swap`{ .sb-show-on-checked }"
    ...
    ??? variable int "`wizarr_role_docker_memory_swappiness`{ .sb-show-on-unchecked }`wizarr2_docker_memory_swappiness`{ .sb-show-on-checked }"
    ...
    ??? variable string "`wizarr_role_docker_shm_size`{ .sb-show-on-unchecked }`wizarr2_docker_shm_size`{ .sb-show-on-checked }"
    ...
    ??? variable list "`wizarr_role_docker_cap_drop`{ .sb-show-on-unchecked }`wizarr2_docker_cap_drop`{ .sb-show-on-checked }"
    ...
    ??? variable string "`wizarr_role_docker_cgroupns_mode`{ .sb-show-on-unchecked }`wizarr2_docker_cgroupns_mode`{ .sb-show-on-checked }"
    ...
    ??? variable list "`wizarr_role_docker_device_cgroup_rules`{ .sb-show-on-unchecked }`wizarr2_docker_device_cgroup_rules`{ .sb-show-on-checked }"
    ...
    ??? variable list "`wizarr_role_docker_device_read_bps`{ .sb-show-on-unchecked }`wizarr2_docker_device_read_bps`{ .sb-show-on-checked }"
    ...
    ??? variable list "`wizarr_role_docker_device_read_iops`{ .sb-show-on-unchecked }`wizarr2_docker_device_read_iops`{ .sb-show-on-checked }"
    ...
    ??? variable list "`wizarr_role_docker_device_requests`{ .sb-show-on-unchecked }`wizarr2_docker_device_requests`{ .sb-show-on-checked }"
    ...
    ??? variable list "`wizarr_role_docker_device_write_bps`{ .sb-show-on-unchecked }`wizarr2_docker_device_write_bps`{ .sb-show-on-checked }"
    ...
    ??? variable list "`wizarr_role_docker_device_write_iops`{ .sb-show-on-unchecked }`wizarr2_docker_device_write_iops`{ .sb-show-on-checked }"
    ...
    ??? variable list "`wizarr_role_docker_devices`{ .sb-show-on-unchecked }`wizarr2_docker_devices`{ .sb-show-on-checked }"
    ...
    ??? variable list "`wizarr_role_docker_groups`{ .sb-show-on-unchecked }`wizarr2_docker_groups`{ .sb-show-on-checked }"
    ...
    ??? variable bool "`wizarr_role_docker_privileged`{ .sb-show-on-unchecked }`wizarr2_docker_privileged`{ .sb-show-on-checked }"
    ...
    ??? variable list "`wizarr_role_docker_security_opts`{ .sb-show-on-unchecked }`wizarr2_docker_security_opts`{ .sb-show-on-checked }"
    ...
    ??? variable string "`wizarr_role_docker_user`{ .sb-show-on-unchecked }`wizarr2_docker_user`{ .sb-show-on-checked }"
    ...
    ??? variable string "`wizarr_role_docker_userns_mode`{ .sb-show-on-unchecked }`wizarr2_docker_userns_mode`{ .sb-show-on-checked }"
    ...
    ??? variable list "`wizarr_role_docker_dns_opts`{ .sb-show-on-unchecked }`wizarr2_docker_dns_opts`{ .sb-show-on-checked }"
    ...
    ??? variable list "`wizarr_role_docker_dns_search_domains`{ .sb-show-on-unchecked }`wizarr2_docker_dns_search_domains`{ .sb-show-on-checked }"
    ...
    ??? variable list "`wizarr_role_docker_dns_servers`{ .sb-show-on-unchecked }`wizarr2_docker_dns_servers`{ .sb-show-on-checked }"
    ...
    ??? variable string "`wizarr_role_docker_domainname`{ .sb-show-on-unchecked }`wizarr2_docker_domainname`{ .sb-show-on-checked }"
    ...
    ??? variable list "`wizarr_role_docker_exposed_ports`{ .sb-show-on-unchecked }`wizarr2_docker_exposed_ports`{ .sb-show-on-checked }"
    ...
    ??? variable dict "`wizarr_role_docker_hosts`{ .sb-show-on-unchecked }`wizarr2_docker_hosts`{ .sb-show-on-checked }"
    ...
    ??? variable bool "`wizarr_role_docker_hosts_use_common`{ .sb-show-on-unchecked }`wizarr2_docker_hosts_use_common`{ .sb-show-on-checked }"
    ...
    ??? variable string "`wizarr_role_docker_ipc_mode`{ .sb-show-on-unchecked }`wizarr2_docker_ipc_mode`{ .sb-show-on-checked }"
    ...
    ??? variable list "`wizarr_role_docker_links`{ .sb-show-on-unchecked }`wizarr2_docker_links`{ .sb-show-on-checked }"
    ...
    ??? variable string "`wizarr_role_docker_network_mode`{ .sb-show-on-unchecked }`wizarr2_docker_network_mode`{ .sb-show-on-checked }"
    ...
    ??? variable string "`wizarr_role_docker_pid_mode`{ .sb-show-on-unchecked }`wizarr2_docker_pid_mode`{ .sb-show-on-checked }"
    ...
    ??? variable list "`wizarr_role_docker_ports`{ .sb-show-on-unchecked }`wizarr2_docker_ports`{ .sb-show-on-checked }"
    ...
    ??? variable string "`wizarr_role_docker_uts`{ .sb-show-on-unchecked }`wizarr2_docker_uts`{ .sb-show-on-checked }"
    ...
    ??? variable bool "`wizarr_role_docker_keep_volumes`{ .sb-show-on-unchecked }`wizarr2_docker_keep_volumes`{ .sb-show-on-checked }"
    ...
    ??? variable list "`wizarr_role_docker_mounts`{ .sb-show-on-unchecked }`wizarr2_docker_mounts`{ .sb-show-on-checked }"
    ...
    ??? variable dict "`wizarr_role_docker_storage_opts`{ .sb-show-on-unchecked }`wizarr2_docker_storage_opts`{ .sb-show-on-checked }"
    ...
    ??? variable list "`wizarr_role_docker_tmpfs`{ .sb-show-on-unchecked }`wizarr2_docker_tmpfs`{ .sb-show-on-checked }"
    ...
    ??? variable string "`wizarr_role_docker_volume_driver`{ .sb-show-on-unchecked }`wizarr2_docker_volume_driver`{ .sb-show-on-checked }"
    ...
    ??? variable list "`wizarr_role_docker_volumes_from`{ .sb-show-on-unchecked }`wizarr2_docker_volumes_from`{ .sb-show-on-checked }"
    ...
    ??? variable bool "`wizarr_role_docker_volumes_global`{ .sb-show-on-unchecked }`wizarr2_docker_volumes_global`{ .sb-show-on-checked }"
    ...
    ??? variable string "`wizarr_role_docker_working_dir`{ .sb-show-on-unchecked }`wizarr2_docker_working_dir`{ .sb-show-on-checked }"
    ...
    ??? variable bool "`wizarr_role_docker_auto_remove`{ .sb-show-on-unchecked }`wizarr2_docker_auto_remove`{ .sb-show-on-checked }"
    ...
    ??? variable bool "`wizarr_role_docker_cleanup`{ .sb-show-on-unchecked }`wizarr2_docker_cleanup`{ .sb-show-on-checked }"
    ...
    ??? variable bool "`wizarr_role_docker_force_kill`{ .sb-show-on-unchecked }`wizarr2_docker_force_kill`{ .sb-show-on-checked }"
    ...
    ??? variable dict "`wizarr_role_docker_healthcheck`{ .sb-show-on-unchecked }`wizarr2_docker_healthcheck`{ .sb-show-on-checked }"
    ...
    ??? variable int "`wizarr_role_docker_healthy_wait_timeout`{ .sb-show-on-unchecked }`wizarr2_docker_healthy_wait_timeout`{ .sb-show-on-checked }"
    ...
    ??? variable bool "`wizarr_role_docker_init`{ .sb-show-on-unchecked }`wizarr2_docker_init`{ .sb-show-on-checked }"
    ...
    ??? variable string "`wizarr_role_docker_kill_signal`{ .sb-show-on-unchecked }`wizarr2_docker_kill_signal`{ .sb-show-on-checked }"
    ...
    ??? variable string "`wizarr_role_docker_log_driver`{ .sb-show-on-unchecked }`wizarr2_docker_log_driver`{ .sb-show-on-checked }"
    ...
    ??? variable dict "`wizarr_role_docker_log_options`{ .sb-show-on-unchecked }`wizarr2_docker_log_options`{ .sb-show-on-checked }"
    ...
    ??? variable bool "`wizarr_role_docker_oom_killer`{ .sb-show-on-unchecked }`wizarr2_docker_oom_killer`{ .sb-show-on-checked }"
    ...
    ??? variable int "`wizarr_role_docker_oom_score_adj`{ .sb-show-on-unchecked }`wizarr2_docker_oom_score_adj`{ .sb-show-on-checked }"
    ...
    ??? variable bool "`wizarr_role_docker_output_logs`{ .sb-show-on-unchecked }`wizarr2_docker_output_logs`{ .sb-show-on-checked }"
    ...
    ??? variable bool "`wizarr_role_docker_paused`{ .sb-show-on-unchecked }`wizarr2_docker_paused`{ .sb-show-on-checked }"
    ...
    ??? variable bool "`wizarr_role_docker_recreate`{ .sb-show-on-unchecked }`wizarr2_docker_recreate`{ .sb-show-on-checked }"
    ...
    ??? variable int "`wizarr_role_docker_restart_retries`{ .sb-show-on-unchecked }`wizarr2_docker_restart_retries`{ .sb-show-on-checked }"
    ...
    ??? variable list "`wizarr_role_docker_capabilities`{ .sb-show-on-unchecked }`wizarr2_docker_capabilities`{ .sb-show-on-checked }"
    ...
    ??? variable string "`wizarr_role_docker_cgroup_parent`{ .sb-show-on-unchecked }`wizarr2_docker_cgroup_parent`{ .sb-show-on-checked }"
    ...
    ??? variable list "`wizarr_role_docker_commands`{ .sb-show-on-unchecked }`wizarr2_docker_commands`{ .sb-show-on-checked }"
    ...
    ??? variable int "`wizarr_role_docker_create_timeout`{ .sb-show-on-unchecked }`wizarr2_docker_create_timeout`{ .sb-show-on-checked }"
    ...
    ??? variable list "`wizarr_role_docker_entrypoint`{ .sb-show-on-unchecked }`wizarr2_docker_entrypoint`{ .sb-show-on-checked }"
    ...
    ??? variable string "`wizarr_role_docker_env_file`{ .sb-show-on-unchecked }`wizarr2_docker_env_file`{ .sb-show-on-checked }"
    ...
    ??? variable dict "`wizarr_role_docker_labels`{ .sb-show-on-unchecked }`wizarr2_docker_labels`{ .sb-show-on-checked }"
    ...
    ??? variable bool "`wizarr_role_docker_labels_use_common`{ .sb-show-on-unchecked }`wizarr2_docker_labels_use_common`{ .sb-show-on-checked }"
    ...
    ??? variable bool "`wizarr_role_docker_read_only`{ .sb-show-on-unchecked }`wizarr2_docker_read_only`{ .sb-show-on-checked }"
    ...
    ??? variable string "`wizarr_role_docker_runtime`{ .sb-show-on-unchecked }`wizarr2_docker_runtime`{ .sb-show-on-checked }"
    ...
    ??? variable dict "`wizarr_role_docker_sysctls`{ .sb-show-on-unchecked }`wizarr2_docker_sysctls`{ .sb-show-on-checked }"
    ...
    ??? variable list "`wizarr_role_docker_ulimits`{ .sb-show-on-unchecked }`wizarr2_docker_ulimits`{ .sb-show-on-checked }"
...
=== "Global Override Options"
    ...
    ??? variable list "`wizarr_role_docker_networks_alias_custom`{ .sb-show-on-unchecked }`wizarr2_docker_networks_alias_custom`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: list
        wizarr_role_docker_networks_alias_custom:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: list
        wizarr2_docker_networks_alias_custom:
        ```
    ...
    ??? variable list "`wizarr_role_paths_folders_list_custom`{ .sb-show-on-unchecked }`wizarr2_paths_folders_list_custom`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Extra directories to create
        # Type: list
        wizarr_role_paths_folders_list_custom:
        ```

        ```yaml { .sb-show-on-checked }
        # Extra directories to create
        # Type: list
        wizarr2_paths_folders_list_custom:
        ```

    ??? variable string "`wizarr_role_paths_group`{ .sb-show-on-unchecked }`wizarr2_paths_group`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Group for directories created by the role
        # Type: string
        wizarr_role_paths_group:
        ```
    ...
    ??? variable string "`wizarr_role_paths_owner`{ .sb-show-on-unchecked }`wizarr2_paths_owner`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Owner for directories created by the role
        # Type: string
        wizarr_role_paths_owner:
        ```
    ...
    ??? variable string "`wizarr_role_paths_permissions`{ .sb-show-on-unchecked }`wizarr2_paths_permissions`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Permissions for directories created by the role
        # Type: string
        wizarr_role_paths_permissions:
        ```

        ```yaml { .sb-show-on-checked }
        # Permissions for directories created by the role
        # Type: string
        wizarr2_paths_permissions:
        ```

    ??? variable bool "`wizarr_role_paths_recursive`{ .sb-show-on-unchecked }`wizarr2_paths_recursive`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        wizarr_role_paths_recursive:
        ```

        ```yaml { .sb-show-on-checked }
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        wizarr2_paths_recursive:
        ```

    ??? variable list "`wizarr_role_themepark_addons`{ .sb-show-on-unchecked }`wizarr2_themepark_addons`{ .sb-show-on-checked }"
    ...
    ??? variable string "`wizarr_role_themepark_app`{ .sb-show-on-unchecked }`wizarr2_themepark_app`{ .sb-show-on-checked }"
    ...
    ??? variable string "`wizarr_role_themepark_theme`{ .sb-show-on-unchecked }`wizarr2_themepark_theme`{ .sb-show-on-checked }"
    ...
    ??? variable string "`wizarr_role_traefik_middleware_http`{ .sb-show-on-unchecked }`wizarr2_traefik_middleware_http`{ .sb-show-on-checked }"
    ...
    ??? variable string "`wizarr_role_traefik_priority`{ .sb-show-on-unchecked }`wizarr2_traefik_priority`{ .sb-show-on-checked }"
    ...
    ??? variable string "`wizarr_role_web_api_http_port`{ .sb-show-on-unchecked }`wizarr2_web_api_http_port`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string (quoted number)
        wizarr_role_web_api_http_port:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string (quoted number)
        wizarr2_web_api_http_port:
        ```

    ??? variable string "`wizarr_role_web_api_http_scheme`{ .sb-show-on-unchecked }`wizarr2_web_api_http_scheme`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string ("http"/"https")
        wizarr_role_web_api_http_scheme:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string ("http"/"https")
        wizarr2_web_api_http_scheme:
        ```

    ??? variable dict "`wizarr_role_web_api_http_serverstransport`{ .sb-show-on-unchecked }`wizarr2_web_api_http_serverstransport`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: dict/omit
        wizarr_role_web_api_http_serverstransport:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: dict/omit
        wizarr2_web_api_http_serverstransport:
        ```

    ??? variable string "`wizarr_role_web_api_port`{ .sb-show-on-unchecked }`wizarr2_web_api_port`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string (quoted number)
        wizarr_role_web_api_port:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string (quoted number)
        wizarr2_web_api_port:
        ```

    ??? variable string "`wizarr_role_web_api_scheme`{ .sb-show-on-unchecked }`wizarr2_web_api_scheme`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string ("http"/"https")
        wizarr_role_web_api_scheme:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string ("http"/"https")
        wizarr2_web_api_scheme:
        ```

    ??? variable dict "`wizarr_role_web_api_serverstransport`{ .sb-show-on-unchecked }`wizarr2_web_api_serverstransport`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: dict/omit
        wizarr_role_web_api_serverstransport:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: dict/omit
        wizarr2_web_api_serverstransport:
        ```
    ...
    ??? variable string "`wizarr_role_web_http_port`{ .sb-show-on-unchecked }`wizarr2_web_http_port`{ .sb-show-on-checked }"
    ...
    ??? variable string "`wizarr_role_web_http_scheme`{ .sb-show-on-unchecked }`wizarr2_web_http_scheme`{ .sb-show-on-checked }"
