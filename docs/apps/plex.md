...
=== "Web"
    ...
    ??? variable string "`plex_role_web_url`{ .sb-show-on-unchecked }`plex2_web_url`{ .sb-show-on-checked }"
        ...
        ```yaml { .sb-show-on-unchecked }
        # Type: string
        plex_role_web_url: "{{ lookup('role_web', role='plex', scheme='https') }}"
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        plex2_web_url: "{{ lookup('role_web', role='plex', scheme='https') }}"
        ```
    ...
    ??? variable string "`plex_role_web_insecure_url`{ .sb-show-on-unchecked }`plex2_web_insecure_url`{ .sb-show-on-checked }"
        ...
        ```yaml { .sb-show-on-unchecked }
        # Type: string
        plex_role_web_insecure_url: "{{ lookup('role_web', role='plex', scheme='http') }}"
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        plex2_web_insecure_url: "{{ lookup('role_web', role='plex', scheme='http') }}"
        ```
...
=== "Docker"
    ...
    ??? variable bool "`plex_role_docker_gpu_enabled`{ .sb-show-on-unchecked }`plex2_docker_gpu_enabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        plex_role_docker_gpu_enabled: true
        ```
        ...
        # This setting does not install or enable GPU support on the server.
        # Type: bool (true/false)
        plex2_docker_gpu_enabled: true
        ```

    ??? variable bool "`plex_role_docker_nvidia_disabled`{ .sb-show-on-unchecked }`plex2_docker_nvidia_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        plex_role_docker_nvidia_disabled: false
        ```
        ...
        # Automatic /dev/dri access may remain.
        # Type: bool (true/false)
        plex2_docker_nvidia_disabled: false
        ```

    ??? variable bool "`plex_role_docker_dev_dri_disabled`{ .sb-show-on-unchecked }`plex2_docker_dev_dri_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        plex_role_docker_dev_dri_disabled: false
        ```
        ...
        # NVIDIA-specific access may remain.
        # Type: bool (true/false)
        plex2_docker_dev_dri_disabled: false
        ```
...
=== "Global Override Options"
    ...
    ??? variable string "`plex_role_web_api_http_port`{ .sb-show-on-unchecked }`plex2_web_api_http_port`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string (quoted number)
        plex_role_web_api_http_port:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string (quoted number)
        plex2_web_api_http_port:
        ```

    ??? variable string "`plex_role_web_api_http_scheme`{ .sb-show-on-unchecked }`plex2_web_api_http_scheme`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string ("http"/"https")
        plex_role_web_api_http_scheme:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string ("http"/"https")
        plex2_web_api_http_scheme:
        ```

    ??? variable dict "`plex_role_web_api_http_serverstransport`{ .sb-show-on-unchecked }`plex2_web_api_http_serverstransport`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: dict/omit
        plex_role_web_api_http_serverstransport:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: dict/omit
        plex2_web_api_http_serverstransport:
        ```

    ??? variable string "`plex_role_web_api_port`{ .sb-show-on-unchecked }`plex2_web_api_port`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string (quoted number)
        plex_role_web_api_port:
        ```
    ...
    ??? variable string "`plex_role_web_api_scheme`{ .sb-show-on-unchecked }`plex2_web_api_scheme`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string ("http"/"https")
        plex_role_web_api_scheme:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string ("http"/"https")
        plex2_web_api_scheme:
        ```

    ??? variable dict "`plex_role_web_api_serverstransport`{ .sb-show-on-unchecked }`plex2_web_api_serverstransport`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: dict/omit
        plex_role_web_api_serverstransport:
        ```
