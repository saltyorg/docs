...
!!! info
    ...
    ```yaml { .sb-show-on-unchecked title="Applies to all instances of jellyfin:" }
    jellyfin_role_web_subdomain: "custom"
    ```

    ```yaml { .sb-show-on-checked title="Applies to a specific instance (e.g., `jellyfin2`):" }
...
=== "Paths"
    ...
    ??? variable string "`jellyfin_role_paths_folder`{ .sb-show-on-unchecked }`jellyfin2_paths_folder`{ .sb-show-on-checked }"
    ...
    ??? variable string "`jellyfin_role_paths_location`{ .sb-show-on-unchecked }`jellyfin2_paths_location`{ .sb-show-on-checked }"
    ...
    ??? variable string "`jellyfin_role_paths_transcodes_location`{ .sb-show-on-unchecked }`jellyfin2_paths_transcodes_location`{ .sb-show-on-checked }"
    ...
    ??? variable string "`jellyfin_role_paths_dlna_location`{ .sb-show-on-unchecked }`jellyfin2_paths_dlna_location`{ .sb-show-on-checked }"
    ...
    ??? variable string "`jellyfin_role_paths_sys_xml_location`{ .sb-show-on-unchecked }`jellyfin2_paths_sys_xml_location`{ .sb-show-on-checked }"
    ...
    ??? variable string "`jellyfin_role_paths_net_xml_location`{ .sb-show-on-unchecked }`jellyfin2_paths_net_xml_location`{ .sb-show-on-checked }"
    ...
    ??? variable string "`jellyfin_role_paths_xml_location_old`{ .sb-show-on-unchecked }`jellyfin2_paths_xml_location_old`{ .sb-show-on-checked }"
