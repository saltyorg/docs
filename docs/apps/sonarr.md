...
1.  **This role supports multiple instances via `sonarr_instances`.**
    ...
    !!! example "Example override"
        ...
        === "Role-scoped"
            ...
            :material-arrow-right-bottom-bold: Applies to all instances of sonarr
        ...
        === "Instance-scoped"
            ...
            :material-arrow-right-bottom-bold: Applies to the instance named sonarr2
...
=== "Settings"
    ...
    ??? variable list "`sonarr_role_allowed_hosts_public_custom`{ .sb-show-on-unchecked }`sonarr2_allowed_hosts_public_custom`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Adds public hosts accepted by Sonarr. This is required when using a raw
        ...
        # Type: list
        sonarr_role_allowed_hosts_public_custom: []
        ```
        ...
        # with "*.". Do not include schemes, paths, or ports.
        # Type: list
        sonarr2_allowed_hosts_public_custom: []
        ```

    ??? variable list "`sonarr_role_allowed_hosts_custom`{ .sb-show-on-unchecked }`sonarr2_allowed_hosts_custom`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Adds extra hosts accepted by Sonarr, such as additional Docker or host-DNS
        ...
        # Type: list
        sonarr_role_allowed_hosts_custom: []
        ```
        ...
        # beginning with "*.". Do not include schemes, paths, or ports.
        # Type: list
        sonarr2_allowed_hosts_custom: []
        ```

    ??? variable list "`sonarr_role_trusted_networks_custom`{ .sb-show-on-unchecked }`sonarr2_trusted_networks_custom`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Adds reverse-proxy peers that Sonarr trusts to supply forwarded headers.
        # Valid values are IPv4 or IPv6 addresses and CIDRs. Do not use hostnames or
        # client networks.
        # Type: list
        sonarr_role_trusted_networks_custom: []
        ```
        ...
        # client networks.
        # Type: list
        sonarr2_trusted_networks_custom: []
        ```
...
=== "Web"
    ...
    ??? variable string "`sonarr_role_web_url`{ .sb-show-on-unchecked }`sonarr2_web_url`{ .sb-show-on-checked }"
        ...
        ```yaml { .sb-show-on-unchecked }
        # Type: string
        sonarr_role_web_url: "{{ lookup('role_web', role='sonarr', scheme='https') }}"
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        sonarr2_web_url: "{{ lookup('role_web', role='sonarr', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`sonarr_role_traefik_middleware_default_api`{ .sb-show-on-unchecked }`sonarr2_traefik_middleware_default_api`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string
        sonarr_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        sonarr2_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`sonarr_role_traefik_middleware_custom_api`{ .sb-show-on-unchecked }`sonarr2_traefik_middleware_custom_api`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string
        sonarr_role_traefik_middleware_custom_api: ""
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        sonarr2_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`sonarr_role_docker_gpu_enabled`{ .sb-show-on-unchecked }`sonarr2_docker_gpu_enabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        sonarr_role_docker_gpu_enabled: false
        ```
        ...
        # This setting does not install or enable GPU support on the server.
        # Type: bool (true/false)
        sonarr2_docker_gpu_enabled: false
        ```

    ??? variable bool "`sonarr_role_docker_nvidia_disabled`{ .sb-show-on-unchecked }`sonarr2_docker_nvidia_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        sonarr_role_docker_nvidia_disabled: false
        ```
        ...
        # Automatic /dev/dri access may remain.
        # Type: bool (true/false)
        sonarr2_docker_nvidia_disabled: false
        ```

    ??? variable bool "`sonarr_role_docker_dev_dri_disabled`{ .sb-show-on-unchecked }`sonarr2_docker_dev_dri_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        sonarr_role_docker_dev_dri_disabled: false
        ```
        ...
        # NVIDIA-specific access may remain.
        # Type: bool (true/false)
        sonarr2_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable string "`sonarr_role_docker_stop_signal`{ .sb-show-on-unchecked }`sonarr2_docker_stop_signal`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string
        sonarr_role_docker_stop_signal:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        sonarr2_docker_stop_signal:
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`sonarr_role_paths_folders_list_custom`{ .sb-show-on-unchecked }`sonarr2_paths_folders_list_custom`{ .sb-show-on-checked }"
        ...
        # Extra directories to create
        # Type: list
        sonarr2_paths_folders_list_custom:
        ```

    ??? variable string "`sonarr_role_paths_group`{ .sb-show-on-unchecked }`sonarr2_paths_group`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Group for directories created by the role
        # Type: string
        sonarr_role_paths_group:
        ```
    ...
    ??? variable string "`sonarr_role_paths_owner`{ .sb-show-on-unchecked }`sonarr2_paths_owner`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Owner for directories created by the role
        # Type: string
        sonarr_role_paths_owner:
        ```
    ...
    ??? variable string "`sonarr_role_paths_permissions`{ .sb-show-on-unchecked }`sonarr2_paths_permissions`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Permissions for directories created by the role
        # Type: string
        sonarr_role_paths_permissions:
        ```

        ```yaml { .sb-show-on-checked }
        # Permissions for directories created by the role
        # Type: string
        sonarr2_paths_permissions:
        ```

    ??? variable bool "`sonarr_role_paths_recursive`{ .sb-show-on-unchecked }`sonarr2_paths_recursive`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        sonarr_role_paths_recursive:
        ```

        ```yaml { .sb-show-on-checked }
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        sonarr2_paths_recursive:
        ```
    ...
    ??? variable string "`sonarr_role_web_api_http_port`{ .sb-show-on-unchecked }`sonarr2_web_api_http_port`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string (quoted number)
        sonarr_role_web_api_http_port:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string (quoted number)
        sonarr2_web_api_http_port:
        ```

    ??? variable string "`sonarr_role_web_api_http_scheme`{ .sb-show-on-unchecked }`sonarr2_web_api_http_scheme`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string ("http"/"https")
        sonarr_role_web_api_http_scheme:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string ("http"/"https")
        sonarr2_web_api_http_scheme:
        ```

    ??? variable dict "`sonarr_role_web_api_http_serverstransport`{ .sb-show-on-unchecked }`sonarr2_web_api_http_serverstransport`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: dict/omit
        sonarr_role_web_api_http_serverstransport:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: dict/omit
        sonarr2_web_api_http_serverstransport:
        ```

    ??? variable string "`sonarr_role_web_api_port`{ .sb-show-on-unchecked }`sonarr2_web_api_port`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string (quoted number)
        sonarr_role_web_api_port:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string (quoted number)
        sonarr2_web_api_port:
        ```

    ??? variable string "`sonarr_role_web_api_scheme`{ .sb-show-on-unchecked }`sonarr2_web_api_scheme`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string ("http"/"https")
        sonarr_role_web_api_scheme:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string ("http"/"https")
        sonarr2_web_api_scheme:
        ```

    ??? variable dict "`sonarr_role_web_api_serverstransport`{ .sb-show-on-unchecked }`sonarr2_web_api_serverstransport`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: dict/omit
        sonarr_role_web_api_serverstransport:
        ```
