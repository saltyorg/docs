...
=== "Web"
    ...
    ??? variable string "`grafana_role_web_url`"
        ...
        ```yaml
        # Type: string
        grafana_role_web_url: "{{ lookup('role_web', role='grafana', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`grafana_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        grafana_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`grafana_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        grafana_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker"
    ...
    ??? variable list "`grafana_role_docker_volumes_default`"
        ...
        grafana_role_docker_volumes_default:
          - "{{ lookup('role_var', '_paths_location', role='grafana') }}:/var/lib/grafana"
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`grafana_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        grafana_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`grafana_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        grafana_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`grafana_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        grafana_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable bool "`grafana_role_docker_force_kill`"
    ...
    ??? variable list "`grafana_role_docker_entrypoint`"
    ...
    ??? variable dict "`grafana_role_docker_sysctls`"
...
=== "Global Override Options"
    ...
    ??? variable list "`grafana_role_docker_networks_alias_custom`"

        ```yaml
        # Type: list
        grafana_role_docker_networks_alias_custom:
        ```
    ...
    ??? variable list "`grafana_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        grafana_role_paths_folders_list_custom:
        ```

    ??? variable string "`grafana_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        grafana_role_paths_group:
        ```

    ??? variable string "`grafana_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        grafana_role_paths_owner:
        ```

    ??? variable string "`grafana_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        grafana_role_paths_permissions:
        ```

    ??? variable bool "`grafana_role_paths_recursive`"

        ```yaml
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        grafana_role_paths_recursive:
        ```

    ??? variable list "`grafana_role_themepark_addons`"
    ...
    ??? variable string "`grafana_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        grafana_role_web_api_http_port:
        ```

    ??? variable string "`grafana_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        grafana_role_web_api_http_scheme:
        ```

    ??? variable dict "`grafana_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        grafana_role_web_api_http_serverstransport:
        ```

    ??? variable string "`grafana_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        grafana_role_web_api_port:
        ```

    ??? variable string "`grafana_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        grafana_role_web_api_scheme:
        ```

    ??? variable dict "`grafana_role_web_api_serverstransport`"

        ```yaml
        # Type: dict/omit
        grafana_role_web_api_serverstransport:
        ```
