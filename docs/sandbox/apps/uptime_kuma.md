...
=== "Web"
    ...
    ??? variable string "`uptime_kuma_role_web_url`"
        ...
        ```yaml
        # Type: string
        uptime_kuma_role_web_url: "{{ lookup('role_web', role='uptime_kuma', scheme='https') }}"
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`uptime_kuma_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        uptime_kuma_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`uptime_kuma_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        uptime_kuma_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`uptime_kuma_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        uptime_kuma_role_docker_dev_dri_disabled: false
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`uptime_kuma_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        uptime_kuma_role_paths_folders_list_custom:
        ```

    ??? variable string "`uptime_kuma_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        uptime_kuma_role_paths_group:
        ```

    ??? variable string "`uptime_kuma_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        uptime_kuma_role_paths_owner:
        ```

    ??? variable string "`uptime_kuma_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        uptime_kuma_role_paths_permissions:
        ```
    ...
    ??? variable bool "`uptime_kuma_role_paths_recursive`"
        ...
        # Type: bool (true/false)
        uptime_kuma_role_paths_recursive:
        ```
