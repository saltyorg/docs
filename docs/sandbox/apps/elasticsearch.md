...
=== "Docker+"
    ...
    ??? variable bool "`elasticsearch_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        elasticsearch_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`elasticsearch_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        elasticsearch_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`elasticsearch_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        elasticsearch_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable string "`elasticsearch_role_docker_stop_signal`"

        ```yaml
        # Type: string
        elasticsearch_role_docker_stop_signal:
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`elasticsearch_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        elasticsearch_role_paths_folders_list_custom:
        ```

    ??? variable string "`elasticsearch_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        elasticsearch_role_paths_group:
        ```

    ??? variable string "`elasticsearch_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        elasticsearch_role_paths_owner:
        ```

    ??? variable string "`elasticsearch_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        elasticsearch_role_paths_permissions:
        ```
    ...
    ??? variable bool "`elasticsearch_role_paths_recursive`"
        ...
        # Type: bool (true/false)
        elasticsearch_role_paths_recursive:
        ```
