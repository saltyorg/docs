...
=== "Web"
    ...
    ??? variable string "`filebrowser_role_web_url`"
        ...
        ```yaml
        # Type: string
        filebrowser_role_web_url: "{{ lookup('role_web', role='filebrowser', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`filebrowser_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        filebrowser_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`filebrowser_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        filebrowser_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`filebrowser_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        filebrowser_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`filebrowser_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        filebrowser_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`filebrowser_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        filebrowser_role_docker_dev_dri_disabled: false
        ```

    <h5>Resource Limits</h5>

    ??? variable int "`filebrowser_role_docker_blkio_weight`"
    ...
    ??? variable int "`filebrowser_role_docker_cpu_period`"
    ...
    ??? variable int "`filebrowser_role_docker_cpu_quota`"
    ...
    ??? variable int "`filebrowser_role_docker_cpu_shares`"
    ...
    ??? variable string "`filebrowser_role_docker_cpus`"
    ...
    ??? variable string "`filebrowser_role_docker_cpuset_cpus`"
    ...
    ??? variable string "`filebrowser_role_docker_cpuset_mems`"
    ...
    ??? variable string "`filebrowser_role_docker_kernel_memory`"
    ...
    ??? variable string "`filebrowser_role_docker_memory`"
    ...
    ??? variable string "`filebrowser_role_docker_memory_reservation`"
    ...
    ??? variable string "`filebrowser_role_docker_memory_swap`"
    ...
    ??? variable int "`filebrowser_role_docker_memory_swappiness`"
    ...
    ??? variable string "`filebrowser_role_docker_shm_size`"
    ...
    ??? variable list "`filebrowser_role_docker_cap_drop`"
    ...
    ??? variable string "`filebrowser_role_docker_cgroupns_mode`"
    ...
    ??? variable list "`filebrowser_role_docker_device_cgroup_rules`"
    ...
    ??? variable list "`filebrowser_role_docker_device_read_bps`"
    ...
    ??? variable list "`filebrowser_role_docker_device_read_iops`"
    ...
    ??? variable list "`filebrowser_role_docker_device_requests`"
    ...
    ??? variable list "`filebrowser_role_docker_device_write_bps`"
    ...
    ??? variable list "`filebrowser_role_docker_device_write_iops`"
    ...
    ??? variable list "`filebrowser_role_docker_devices`"
    ...
    ??? variable list "`filebrowser_role_docker_groups`"
    ...
    ??? variable bool "`filebrowser_role_docker_privileged`"
    ...
    ??? variable list "`filebrowser_role_docker_security_opts`"
    ...
    ??? variable string "`filebrowser_role_docker_userns_mode`"
    ...
    ??? variable list "`filebrowser_role_docker_dns_opts`"
    ...
    ??? variable list "`filebrowser_role_docker_dns_search_domains`"
    ...
    ??? variable list "`filebrowser_role_docker_dns_servers`"
    ...
    ??? variable string "`filebrowser_role_docker_domainname`"
    ...
    ??? variable list "`filebrowser_role_docker_exposed_ports`"
    ...
    ??? variable dict "`filebrowser_role_docker_hosts`"
    ...
    ??? variable bool "`filebrowser_role_docker_hosts_use_common`"
    ...
    ??? variable string "`filebrowser_role_docker_ipc_mode`"
    ...
    ??? variable list "`filebrowser_role_docker_links`"
    ...
    ??? variable string "`filebrowser_role_docker_network_mode`"
    ...
    ??? variable string "`filebrowser_role_docker_pid_mode`"
    ...
    ??? variable list "`filebrowser_role_docker_ports`"
    ...
    ??? variable string "`filebrowser_role_docker_uts`"
    ...
    ??? variable bool "`filebrowser_role_docker_keep_volumes`"
    ...
    ??? variable list "`filebrowser_role_docker_mounts`"
    ...
    ??? variable dict "`filebrowser_role_docker_storage_opts`"
    ...
    ??? variable list "`filebrowser_role_docker_tmpfs`"
    ...
    ??? variable string "`filebrowser_role_docker_volume_driver`"
    ...
    ??? variable list "`filebrowser_role_docker_volumes_from`"
    ...
    ??? variable bool "`filebrowser_role_docker_volumes_global`"
    ...
    ??? variable string "`filebrowser_role_docker_working_dir`"
    ...
    ??? variable bool "`filebrowser_role_docker_auto_remove`"
    ...
    ??? variable bool "`filebrowser_role_docker_cleanup`"
    ...
    ??? variable bool "`filebrowser_role_docker_force_kill`"
    ...
    ??? variable dict "`filebrowser_role_docker_healthcheck`"
    ...
    ??? variable int "`filebrowser_role_docker_healthy_wait_timeout`"
    ...
    ??? variable bool "`filebrowser_role_docker_init`"
    ...
    ??? variable string "`filebrowser_role_docker_kill_signal`"
    ...
    ??? variable string "`filebrowser_role_docker_log_driver`"
    ...
    ??? variable dict "`filebrowser_role_docker_log_options`"
    ...
    ??? variable bool "`filebrowser_role_docker_oom_killer`"
    ...
    ??? variable int "`filebrowser_role_docker_oom_score_adj`"
    ...
    ??? variable bool "`filebrowser_role_docker_output_logs`"
    ...
    ??? variable bool "`filebrowser_role_docker_paused`"
    ...
    ??? variable bool "`filebrowser_role_docker_recreate`"
    ...
    ??? variable int "`filebrowser_role_docker_restart_retries`"
    ...
    ??? variable string "`filebrowser_role_docker_stop_signal`"

        ```yaml
        # Type: string
        filebrowser_role_docker_stop_signal:
        ```

    ??? variable int "`filebrowser_role_docker_stop_timeout`"
    ...
    ??? variable list "`filebrowser_role_docker_capabilities`"
    ...
    ??? variable string "`filebrowser_role_docker_cgroup_parent`"
    ...
    ??? variable list "`filebrowser_role_docker_commands`"
    ...
    ??? variable int "`filebrowser_role_docker_create_timeout`"
    ...
    ??? variable list "`filebrowser_role_docker_entrypoint`"
    ...
    ??? variable string "`filebrowser_role_docker_env_file`"
    ...
    ??? variable dict "`filebrowser_role_docker_labels`"
    ...
    ??? variable bool "`filebrowser_role_docker_labels_use_common`"
    ...
    ??? variable string "`filebrowser_role_docker_runtime`"
    ...
    ??? variable dict "`filebrowser_role_docker_sysctls`"
    ...
    ??? variable list "`filebrowser_role_docker_ulimits`"
...
=== "Global Override Options"
    ...
    ??? variable list "`filebrowser_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        filebrowser_role_paths_folders_list_custom:
        ```

    ??? variable string "`filebrowser_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        filebrowser_role_paths_group:
        ```

    ??? variable string "`filebrowser_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        filebrowser_role_paths_owner:
        ```

    ??? variable string "`filebrowser_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        filebrowser_role_paths_permissions:
        ```

    ??? variable bool "`filebrowser_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        filebrowser_role_paths_recursive:
        ```

    ??? variable list "`filebrowser_role_themepark_addons`"
    ...
    ??? variable string "`filebrowser_role_themepark_app`"
    ...
    ??? variable string "`filebrowser_role_themepark_theme`"
    ...
    ??? variable string "`filebrowser_role_traefik_api_middleware_http`"
    ...
    ??? variable string "`filebrowser_role_traefik_middleware_http`"
    ...
    ??? variable string "`filebrowser_role_traefik_priority`"
    ...
    ??? variable string "`filebrowser_role_web_http_port`"
    ...
    ??? variable string "`filebrowser_role_web_http_scheme`"
