...
- To access AirDC++, visit <https://airdcpp.iYOUR_DOMAIN_NAMEi>
...
=== "Global Override Options"
    ...
    ??? variable dict/omit "`airdcpp_role_traefik_api_endpoint`"
    ...
    ??? variable dict/omit "`airdcpp_role_web_http_serverstransport`"
    ...
    ??? variable dict/omit "`airdcpp_role_web_serverstransport`"
