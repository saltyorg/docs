...
=== "Docker+"
    ...
    ??? variable bool "`crafty_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        crafty_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`crafty_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        crafty_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`crafty_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        crafty_role_docker_dev_dri_disabled: false
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`crafty_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        crafty_role_paths_folders_list_custom:
        ```
    ...
    ??? variable string "`crafty_role_paths_group`"
        ...
        # Type: string
        crafty_role_paths_group:
        ```

    ??? variable string "`crafty_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        crafty_role_paths_owner:
        ```

    ??? variable string "`crafty_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        crafty_role_paths_permissions:
        ```

    ??? variable bool "`crafty_role_paths_recursive`"

        ```yaml
        # Apply ownership and permissions recursively
        # Type: bool (true/false)
        crafty_role_paths_recursive:
        ```
    ...
    ??? variable string "`crafty_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        crafty_role_web_api_http_port:
        ```

    ??? variable string "`crafty_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        crafty_role_web_api_http_scheme:
        ```

    ??? variable dict "`crafty_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        crafty_role_web_api_http_serverstransport:
        ```

    ??? variable string "`crafty_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        crafty_role_web_api_port:
        ```

    ??? variable string "`crafty_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        crafty_role_web_api_scheme:
        ```

    ??? variable dict "`crafty_role_web_api_serverstransport`"
    ...
    ??? variable dict "`crafty_role_web_http_serverstransport`"
