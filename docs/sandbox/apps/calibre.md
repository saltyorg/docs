...
=== "Docker+"
    ...
    ??? variable bool "`calibre_role_docker_gpu_enabled`{ .sb-show-on-unchecked }`calibre2_docker_gpu_enabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        calibre_role_docker_gpu_enabled: false
        ```
        ...
        # This setting does not install or enable GPU support on the server.
        # Type: bool (true/false)
        calibre2_docker_gpu_enabled: false
        ```

    ??? variable bool "`calibre_role_docker_nvidia_disabled`{ .sb-show-on-unchecked }`calibre2_docker_nvidia_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        calibre_role_docker_nvidia_disabled: false
        ```
        ...
        # Automatic /dev/dri access may remain.
        # Type: bool (true/false)
        calibre2_docker_nvidia_disabled: false
        ```

    ??? variable bool "`calibre_role_docker_dev_dri_disabled`{ .sb-show-on-unchecked }`calibre2_docker_dev_dri_disabled`{ .sb-show-on-checked }"
        ...
        # Type: bool (true/false)
        calibre_role_docker_dev_dri_disabled: false
        ```
        ...
        # NVIDIA-specific access may remain.
        # Type: bool (true/false)
        calibre2_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable string "`calibre_role_docker_stop_signal`{ .sb-show-on-unchecked }`calibre2_docker_stop_signal`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Type: string
        calibre_role_docker_stop_signal:
        ```

        ```yaml { .sb-show-on-checked }
        # Type: string
        calibre2_docker_stop_signal:
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`calibre_role_paths_folders_list_custom`{ .sb-show-on-unchecked }`calibre2_paths_folders_list_custom`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Extra directories to create
        # Type: list
        calibre_role_paths_folders_list_custom:
        ```

        ```yaml { .sb-show-on-checked }
        # Extra directories to create
        # Type: list
        calibre2_paths_folders_list_custom:
        ```

    ??? variable string "`calibre_role_paths_group`{ .sb-show-on-unchecked }`calibre2_paths_group`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Group for directories created by the role
        # Type: string
        calibre_role_paths_group:
        ```

        ```yaml { .sb-show-on-checked }
        # Group for directories created by the role
        # Type: string
        calibre2_paths_group:
        ```

    ??? variable string "`calibre_role_paths_owner`{ .sb-show-on-unchecked }`calibre2_paths_owner`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Owner for directories created by the role
        # Type: string
        calibre_role_paths_owner:
        ```

        ```yaml { .sb-show-on-checked }
        # Owner for directories created by the role
        # Type: string
        calibre2_paths_owner:
        ```

    ??? variable string "`calibre_role_paths_permissions`{ .sb-show-on-unchecked }`calibre2_paths_permissions`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Permissions for directories created by the role
        # Type: string
        calibre_role_paths_permissions:
        ```

        ```yaml { .sb-show-on-checked }
        # Permissions for directories created by the role
        # Type: string
        calibre2_paths_permissions:
        ```

    ??? variable bool "`calibre_role_paths_recursive`{ .sb-show-on-unchecked }`calibre2_paths_recursive`{ .sb-show-on-checked }"

        ```yaml { .sb-show-on-unchecked }
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        calibre_role_paths_recursive:
        ```

        ```yaml { .sb-show-on-checked }
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        calibre2_paths_recursive:
        ```
