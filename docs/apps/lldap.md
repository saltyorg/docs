...
=== "Web"
    ...
    ??? variable string "`lldap_role_web_url`"
        ...
        ```yaml
        # Type: string
        lldap_role_web_url: "{{ lookup('role_web', role='lldap', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`lldap_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        lldap_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`lldap_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        lldap_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`lldap_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        lldap_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`lldap_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        lldap_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`lldap_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        lldap_role_docker_dev_dri_disabled: false
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`lldap_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        lldap_role_paths_folders_list_custom:
        ```

    ??? variable string "`lldap_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        lldap_role_paths_group:
        ```

    ??? variable string "`lldap_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        lldap_role_paths_owner:
        ```

    ??? variable string "`lldap_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        lldap_role_paths_permissions:
        ```

    ??? variable bool "`lldap_role_paths_recursive`"

        ```yaml
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        lldap_role_paths_recursive:
        ```
    ...
    ??? variable string "`lldap_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        lldap_role_web_api_http_port:
        ```

    ??? variable string "`lldap_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        lldap_role_web_api_http_scheme:
        ```

    ??? variable dict "`lldap_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        lldap_role_web_api_http_serverstransport:
        ```

    ??? variable string "`lldap_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        lldap_role_web_api_port:
        ```

    ??? variable string "`lldap_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        lldap_role_web_api_scheme:
        ```

    ??? variable dict "`lldap_role_web_api_serverstransport`"
