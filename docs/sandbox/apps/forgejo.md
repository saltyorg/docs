...
=== "Web"
    ...
    ??? variable string "`forgejo_role_web_url`"
        ...
        ```yaml
        # Type: string
        forgejo_role_web_url: "{{ lookup('role_web', role='forgejo', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`forgejo_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        forgejo_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`forgejo_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        forgejo_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`forgejo_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        forgejo_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`forgejo_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        forgejo_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`forgejo_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        forgejo_role_docker_dev_dri_disabled: false
        ```
    ...
    ??? variable string "`forgejo_role_docker_stop_signal`"

        ```yaml
        # Type: string
        forgejo_role_docker_stop_signal:
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`forgejo_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        forgejo_role_paths_folders_list_custom:
        ```

    ??? variable string "`forgejo_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        forgejo_role_paths_group:
        ```

    ??? variable string "`forgejo_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        forgejo_role_paths_owner:
        ```

    ??? variable string "`forgejo_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        forgejo_role_paths_permissions:
        ```
    ...
    ??? variable string "`forgejo_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        forgejo_role_web_api_http_port:
        ```

    ??? variable string "`forgejo_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        forgejo_role_web_api_http_scheme:
        ```

    ??? variable dict "`forgejo_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        forgejo_role_web_api_http_serverstransport:
        ```

    ??? variable string "`forgejo_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        forgejo_role_web_api_port:
        ```

    ??? variable string "`forgejo_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        forgejo_role_web_api_scheme:
        ```

    ??? variable dict "`forgejo_role_web_api_serverstransport`"
