...
=== "Web"
    ...
    ??? variable string "`freshrss_role_web_url`"
        ...
        ```yaml
        # Type: string
        freshrss_role_web_url: "{{ lookup('role_web', role='freshrss', scheme='https') }}"
        ```
...
=== "Traefik"
    ...
    ??? variable string "`freshrss_role_traefik_middleware_default_api`"

        ```yaml
        # Type: string
        freshrss_role_traefik_middleware_default_api: "{{ traefik_default_middleware_api }}"
        ```

    ??? variable string "`freshrss_role_traefik_middleware_custom_api`"

        ```yaml
        # Type: string
        freshrss_role_traefik_middleware_custom_api: ""
        ```
...
=== "Docker+"
    ...
    ??? variable bool "`freshrss_role_docker_gpu_enabled`"
        ...
        # Type: bool (true/false)
        freshrss_role_docker_gpu_enabled: false
        ```

    ??? variable bool "`freshrss_role_docker_nvidia_disabled`"
        ...
        # Type: bool (true/false)
        freshrss_role_docker_nvidia_disabled: false
        ```

    ??? variable bool "`freshrss_role_docker_dev_dri_disabled`"
        ...
        # Type: bool (true/false)
        freshrss_role_docker_dev_dri_disabled: false
        ```
...
=== "Global Override Options"
    ...
    ??? variable list "`freshrss_role_docker_networks_alias_custom`"

        ```yaml
        # Type: list
        freshrss_role_docker_networks_alias_custom:
        ```
    ...
    ??? variable list "`freshrss_role_paths_folders_list_custom`"

        ```yaml
        # Extra directories to create
        # Type: list
        freshrss_role_paths_folders_list_custom:
        ```

    ??? variable string "`freshrss_role_paths_group`"

        ```yaml
        # Group for directories created by the role
        # Type: string
        freshrss_role_paths_group:
        ```

    ??? variable string "`freshrss_role_paths_owner`"

        ```yaml
        # Owner for directories created by the role
        # Type: string
        freshrss_role_paths_owner:
        ```

    ??? variable string "`freshrss_role_paths_permissions`"

        ```yaml
        # Permissions for directories created by the role
        # Type: string
        freshrss_role_paths_permissions:
        ```

    ??? variable bool "`freshrss_role_paths_recursive`"

        ```yaml
        # Apply owner and group recursively without changing child modes
        # Type: bool (true/false)
        freshrss_role_paths_recursive:
        ```
    ...
    ??? variable string "`freshrss_role_web_api_http_port`"

        ```yaml
        # Type: string (quoted number)
        freshrss_role_web_api_http_port:
        ```

    ??? variable string "`freshrss_role_web_api_http_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        freshrss_role_web_api_http_scheme:
        ```

    ??? variable dict "`freshrss_role_web_api_http_serverstransport`"

        ```yaml
        # Type: dict/omit
        freshrss_role_web_api_http_serverstransport:
        ```

    ??? variable string "`freshrss_role_web_api_port`"

        ```yaml
        # Type: string (quoted number)
        freshrss_role_web_api_port:
        ```

    ??? variable string "`freshrss_role_web_api_scheme`"

        ```yaml
        # Type: string ("http"/"https")
        freshrss_role_web_api_scheme:
        ```

    ??? variable dict "`freshrss_role_web_api_serverstransport`"

        ```yaml
        # Type: dict/omit
        freshrss_role_web_api_serverstransport:
        ```
